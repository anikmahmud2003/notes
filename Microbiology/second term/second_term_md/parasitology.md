...
## P1: Define parasite. Classify parasites. *****

> **📌 Hint:** Protozoa & metazoa (cestodes, trematodes, nematodes)

### ✅ Answer

**Parasite:** an organism which lives in or on another living organism (the **host**), derives nourishment and shelter from it ("parasitos" = eating at the same table), and in doing so always causes some degree of harm to the host.
**Classification of parasites (according to cellularity):**
| Group | Cellularity | Classes | Examples |
|---|---|---|---|
| **Protozoa** | Unicellular (eukaryote) | — | E. histolytica, Plasmodium spp., Giardia lamblia |
| **Metazoa / Helminths / Worms** | Multicellular (eukaryote) | Platyhelminths → Cestodes (tapeworms) | Taenia solium, T. saginata, E. granulosus |
| **Metazoa / Helminths / Worms** | Multicellular (eukaryote) | Platyhelminths → Trematodes (flukes); Nemathelminths → Nematodes | S. haematobium (fluke); Ascaris lumbricoides (nematode) |

### ❓ Cross Questions (from additional)

**Q: পাঁচটি রাজ্য কি কি?**
→ Five-kingdom system অনুযায়ী রাজ্যগুলো হলো — Monera (Bacteria), Protista (Protozoa), Fungi, Plantae এবং Animalia।

**Q: পরজীবীরা কত ধরনের হয়?**
...
## P2: Mention 03 important differences between protozoa and metazoa. ****

> **📌 Hint:** protozoa: unicellular, morphologically and functionally complete, single cell like unit, one cell does all the function

### ✅ Answer

| Point | Protozoa | Metazoa / Helminths |
|---|---|---|
| Kingdom | Protista | Animalia |
| Number of cell | Unicellular (eukaryotic) | Multicellular (eukaryotic) |
| Morphological form | Cyst and trophozoite | Ovum/egg, larva and adult worm |
| Single cell like unit | **Yes** — one cell performs all functions (digestion, excretion, respiration, reproduction) | No — different cells do different functions |
| Visibility | Microscopic | Mainly macroscopic (eggs & larvae microscopic) |
| Reproduction | Sexual and asexual | Mainly sexual |
| Example | E. histolytica, Plasmodium spp. | T. solium, A. lumbricoides |

### ❓ Cross Questions (from additional)

**Q: Protozoa কোন kingdom-এ পড়ে আর Metazoa কোন kingdom-এ?**
→ Protozoa kingdom Protista-র অন্তর্গত, আর Metazoa kingdom Animalia-র অন্তর্গত।

**Q: Protozoa এবং Metazoa-র গতির পার্থক্য কি?**
→ Protozoa pseudopodia, flagella, cilia বা gliding motility দিয়ে চলে; আর Metazoa-র মাংসপেশি (muscles) থাকে।

**Q: Metazoa-র তিনটি germ layer কি কি?**
...
## P3: Define host. Classify host with example. ******

> **📌 Hint:** definitive host (sexual cycle/adult stage), intermediate host (asexual cycle/larval stage), paratenic, accidental host

### ✅ Answer

**Host:** an organism which harbors the parasite and provides nourishment and shelter to it.
**Classification of host:**
| Type | Definition | Example |
|---|---|---|
| **Definitive host** | Harbors the **adult / sexual stage** of the parasite (sexual cycle) | Anopheles mosquito in malaria; man in T. saginata |
| **Intermediate host** | Harbors the **larval / asexual stage** (asexual cycle) | Man in malaria; cattle in T. saginata |
| **Paratenic (carrier/transport) host** | Parasite remains viable but does not develop further | Man as paratenic host of Angiostrongylus cantonensis |
| **Accidental host** | Parasite infects an unusual host | Man is accidental host of Echinococcus granulosus |

### ❓ Cross Questions (from additional)

**Q: মানুষ কোন কোন parasite-র definitive host?**
...
**Q: মানুষ কোন কোন parasite-র intermediate host?**
→ মানুষ Plasmodium, Toxoplasma, E. granulosus-এর intermediate host।

**Q: T. solium-এর ক্ষেত্রে মানুষ কোন ধরনের host?**
...
## P4: What do you mean by definitive host & intermediate host? *****

> **📌 Hint:** definitive host: sexual cycle or adult stage; intermediate host: asexual cycle or larval stage

### ✅ Answer

**Definitive host:** the host which harbors the **adult stage or sexual stage** of the parasite (i.e. the sexual cycle of the parasite is completed).
**Intermediate host:** the host which harbors the **larval stage or asexual stage** of the parasite (asexual cycle is completed).
| Point | Definitive host | Intermediate host |
|---|---|---|
| Stage of parasite | Adult stage | Larval stage |
| Cycle | Sexual cycle | Asexual cycle |
| Example (malaria) | Female Anopheles mosquito | Man |
| Example (T. saginata) | Man | Cattle |

### ❓ Cross Questions (from additional)

**Q: D. latum-এর জীবনচক্রে কতগুলো host লাগে?**
...
## P5: Mention one parasite where man acts as both intermediate and definitive host. **

> **📌 Hint:** T. solium

### ✅ Answer

**Taenia solium (pork tapeworm)** — man acts as both definitive and intermediate host. In man adult worm lives in small intestine (intestinal taeniasis, man = definitive host), but if man ingests the **eggs** (faecal contamination or autoinfection), the larva (cysticercus cellulosae) develops in tissues like brain, muscle and eye (cysticercosis) — here man behaves as the (accidental) intermediate host.

### ❓ Cross Questions (from additional)

**Q: Cysticercosis কীভাবে হয়?**
→ Cysticercosis হয় যখন man contaminated egg গ্রহণ করে বা autoinfection-এর মাধ্যমে — undercooked pork খাওয়ার মাধ্যমে নয়।

**Q: Neurocysticercosis কেন important?**
...
**Q: T. saginata কি মানুষে cysticercosis করতে পারে?**
→ না, T. saginata man-এ cysticercosis করতে পারে না — এর eggs শুধু cattle-কে infect করে।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

এই question-এর exact answer হলো **T. solium** — pork tapeworm।
...
## P6: Mention three (03) parasites where man is definitive host. ***

> **📌 Hint:** most of the intestinal nematodes, W. bancrofti, E. histolytica, G. lamblia, T. vaginalis, Leishmania, T. saginata, D. latum

### ✅ Answer

Parasites where **man is the definitive host** (adult/sexual stage in man):
...
**Q: Intestinal nematodes-এর ক্ষেত্রে man কীধরনের host?**
→ Intestinal nematodes-এর ক্ষেত্রে man একমাত্র definitive host — এদের কোনো intermediate host লাগে না।

**Q: Plasmodium, Toxoplasma, E. granulosus-এর ক্ষেত্রে man কীধরনের host?**
...
Example দিতে হবে — **E. histolytica** (amoebiasis), **Giardia lamblia** (giardiasis), **Trichomonas vaginalis**, **W. bancrofti**, **T. saginata**, **D. latum**, আর বেশিরভাগ intestinal nematodes (Ascaris, Enterobius, Trichuris, hookworm)।
...
## P7: Mention three (03) parasites where man is intermediate host. ***

> **📌 Hint:** Plasmodium, Toxoplasma, E. granulosus

### ✅ Answer

Parasites where **man is the intermediate host** (larval/asexual stage in man):
...
**Q: T. solium-এর cysticercosis-এ man কীধরনের host?**
→ T. solium-এর cysticercosis-এ man accidental (dead-end) intermediate host।

**Q: E. granulosus-এর optimum intermediate host কে?**
...
## P8: Mention three (03) conditions when two intermediate host is required. **

> **📌 Hint:** D. latum: Copepods and fish; F. buski: aquatic plant/পানি ফল and snail; G. hominis & F. hepatica: aquatic plant & snail

### ✅ Answer

Parasites requiring **two intermediate hosts**:
...
**Q: বেশিরভাগ trematodes-এর first intermediate host কে?**
→ বেশিরভাগ trematodes (F. buski, F. hepatica, P. westermani)-এর first intermediate host হলো snail।

**Q: P. westermani এবং C. sinensis-এর intermediate host কি কি?**
...
## P9: What do you mean by dead end intermediate host with example? *

> **📌 Hint:** in hydatid cyst and cysticercosis caused by T. solium: man is dead end intermediate host: because rare access to eat human flesh

### ✅ Answer

**Dead-end intermediate host:** a host in which the larva develops, but the parasite's life cycle **cannot be completed** because the definitive host has **no (or very rare) access** to eat that host's flesh (or the infected tissue never reaches the definitive host). The cycle simply stops there — it becomes a "dead end."
**Examples:**
...
## P10: What do you mean by accidental host with example? **

> **📌 Hint:** E. granulosus: man accidental host

### ✅ Answer

**Accidental host:** a host which is **not the natural host** of a parasite, but becomes infected occasionally (by chance). The parasite usually infects an unusual host and often cannot complete its normal life cycle there.
**Example:** man is the accidental host for **Echinococcus granulosus** (dog tapeworm). The natural cycle is dog → sheep; but man incidentally ingests the eggs (from dog feces) and develops hydatid cyst.
...
**Q: Aberrant parasite আর accidental host-এর মধ্যে পার্থক্য কি?**
...
## P11: What are the host parasite relationship? ***

> **📌 Hint:** symbiosis, mutualism, commensalism, parasitism (+ amensalism, parasitoid)

### ✅ Answer

Host–parasite relationships are different types of **symbiosis** (a close relationship between two species in which at least one species is benefited):
| Relationship | Outcome | Example |
|---|---|---|
| **Mutualism** | Both species are benefited | Lactobacilli in gut (ferment sugar, help digestion) & human |
| **Commensalism** | One species benefited, other not affected | Normal flora on skin & human |
| **Parasitism** | One species (parasite) benefited, the other (host) is harmed | All pathogenic organisms (E. histolytica & human) |
| **Amensalism** | One organism harmed, other not affected | — |
| **Parasitoid** | A parasite (insect) that kills its host | — |
...
**Q: Symbiosis-কে কি strict sense-এ mutualism বলা হয়?**
...
## P12: What do you mean by symbiosis, commensalism, parasitism, mutualism? ****

> **📌 Hint:** close relationship of two species where at least one is benefited
...
**Q: Candida albicans আর man-এর মধ্যে কীধরনের relationship?**
→ Candida albicans আর man-এর মধ্যে commensalism-এর উদাহরণ হিসেবে দেওয়া হয়েছে।

**Q: Parasitoid আর parasitism-এর মধ্যে পার্থক্য কি?**
...
এক line-এ বলে দাও — দুই species-এর close relationship যেখানে minimum একজন benefit পায়, সেই relationship-এর নাম **symbiosis**। এর ৩টা basic type।
...
## P13: What do you mean by biological vector and mechanical vector?

> **📌 Hint:** biological vector: transmission + biological activity, in mechanical vector: only transmission

### ✅ Answer

**Vector:** an organism, typically an arthropod or insect, that transmits infection from one host to another.
| Point | Biological vector | Mechanical vector |
|---|---|---|
| Multiplication of parasite | **Yes** — parasite multiplies inside the vector | No |
| Developmental change of parasite | **Yes** — developmental changes occur (e.g., sporogony in mosquito) | No |
| Role | Transmission + biological activity | Only transmission (passive carrying) |
| Example | Female Anopheles → Plasmodium; sandfly → Leishmania; Culex → W. bancrofti | Housefly → E. histolytica, Giardia (carries cysts on feces/legs to food) |
Note: A vector transmits infective agents but does not itself get infected (unlike a carrier, which also becomes infected).

### ❓ Cross Questions (from additional)

**Q: বিভিন্ন vector-এর উদাহরণ দিন।**
...
**Q: Carrier আর vector-এর মধ্যে পার্থক্য কি?**
...
**Biological vector**-তে parasite তার ভিতর multiply করে আর develop হয় — যেমন female Anopheles-এর ভিতর Plasmodium-এর sporogony (sexual cycle) হয়। Sandfly-তে Leishmania, Culex-এ W. bancrofti develops হয় — এরা সব biological vector।
**Mechanical vector**-তে parasite নিজের ভিতরে কিছু করে না — শুধু parasite টা তার পায়ে বা body-তে লেগে এক জায়গা থেকে আরেক জায়গায় যায়। যেমন housefly-এর পায়ে E. histolytica cyst লেগে contaminated food-এ যায়।
...
## P14: List the 05 different route of transmission of parasites with 02 examples of each. *****

> **📌 Hint:** feco-oral (most common), vector-borne, sexual, vertical, autoinfection, blood transfusion

### ✅ Answer

| Route | Examples |
|---|---|
| **1. Feco-oral route** (most common) — ingestion of food/water/vegetables polluted with infected feces | E. histolytica (cyst), Ascaris lumbricoides (egg), Giardia lamblia |
| **2. Vector-borne / arthropod bite** | Plasmodium (Anopheles bite), Leishmania (sandfly bite), W. bancrofti (Culex bite) |
| **3. Sexual contact** | Trichomonas vaginalis |
| **4. Vertical transmission** (mother to fetus) | Toxoplasma gondii (transplacental) |
| **5. Autoinfection** | Enterobius vermicularis, Strongyloides stercoralis, Hymenolepis nana |
| 6. Blood transfusion | Plasmodium, Leishmania, Trypanosoma |

### ❓ Cross Questions (from additional)

**Q: Autoinfection কত ধরনের?**
→ Autoinfection দুই ধরনের — external (contaminated hand দিয়ে) এবং internal (reverse peristalsis দিয়ে)।

**Q: Skin penetration দিয়ে infection হয় এমন parasite কি কি?**
...
## P15: List the sources of different types of parasitic infection. ******

> **📌 Hint:** mostly as route of transmission (soil/water, food, man-to-man, animal zoonoses, vector)

### ✅ Answer

| Source | Details & examples |
|---|---|
| **1. Contaminated soil** | Soil polluted with human excreta containing eggs of hookworm, Ascaris, Trichuris (eggs mature in soil) |
| **2. Contaminated water** | Water containing cysts of E. histolytica or Giardia lamblia; water with Cyclops harbouring Dracunculus larvae; cercariae of Schistosoma in water penetrating skin |
| **3. Food** | Raw/undercooked food or vegetables with infective stages — cysts of E. histolytica, metacercariae of F. buski on aquatic plants, eggs of E. granulosus |
| **4. Man (man-to-man)** | Directly transmitted from one infected man to another — amoebiasis, enterobiasis |
| **5. Animals (zoonoses)** | Infection directly or indirectly transmitted from infected animals to man — e.g., E. granulosus (dog), Toxoplasma (cat) |
| **6. Vector** | Arthropod/insect transmitting infection — mosquito (Plasmodium, W. bancrofti), sandfly (Kala-azar), housefly (mechanical) |
...
**Q: Contaminated soil-এ animal-এর feces থাকলেও কি infection হতে পারে?**
...
## P16: Name some parasites causing CNS infection. ****

> **📌 Hint:** P. falciparum, T. gondii, free living amoeba
...
**Q: Naegleria fowleri কীভাবে মানুষে infection করে?**
...
## P17: Name three (03) vector borne parasitic diseases. *****

> **📌 Hint:** Leishmania, Plasmodium, W. bancrofti

### ✅ Answer

| # | Disease | Parasite | Vector |
|---|---|---|---|
| 1 | **Malaria** | Plasmodium spp. | Female Anopheles mosquito (biological) |
| 2 | **Leishmaniasis / Kala-azar** | Leishmania donovani | Sandfly (Phlebotomus argentipes) (biological) |
| 3 | **Filariasis** | Wuchereria bancrofti | Female Culex mosquito (biological) |

### ❓ Cross Questions (from additional)

**Q: আর কোন কোন vector-borne parasitic disease আছে?**
...
**Q: Sandfly আর mosquito দিয়ে কোন কোন parasite আসে?**
...
## P18: Name parasites that cause infection by skin penetration. ****

> **📌 Hint:** Hook worm, S.S (Strongyloides stercoralis)

### ✅ Answer

Parasites entering the host by **penetration of the skin** (by **filariform larva** L3):
- Ancylostoma duodenale (old world hookworm)
- Necator americanus (new world hookworm)
- Strongyloides stercoralis (small round worm)
Also: **Schistosoma spp.** cercariae pierce the skin from water (skin penetration route for trematodes).

### ❓ Cross Questions (from additional)

**Q: Skin penetration কখন ঘটে এবং কীভাবে লার্ভা ঢোকে?**
→ যখন মানুষ খালি পায়ে damp/moist soil-এ হাঁটে; larva hydrolytic enzymes নিঃসরণ করে যা skin-এ প্রবেশে সাহায্য করে।

**Q: S. stercoralis-এর skin re-entry কী ঘটায়?**
...
## P19: What are the parasites found in blood or peripheral blood film? *****

> **📌 Hint:** Leishmania: in monocyte or macrophage, Plasmodium: in RBC, W. bancrofti: in plasma

### ✅ Answer

| Parasite | Where in blood |
|---|---|
| **Plasmodium spp.** | Inside **RBC** (ring, trophozoite, schizont, gametocyte) |
| **Babesia microti** | Inside **RBC** (resembles P. falciparum ring, tetrad/"maltese cross" arrangement) |
| **Leishmania donovani** | Inside **monocyte or macrophage** (amastigote / LD body) |
| **Wuchereria bancrofti** | In **plasma** (microfilariae) |
| **Brugia malayi** | In plasma (microfilariae) |
| **Trypanosoma brucei / cruzi** | In plasma (trypomastigote) |
Mnemonics of md: In RBC → Plasmodium & Babesia; In WBC (monocyte/macrophage) → Leishmania; In plasma → Wuchereria (and Trypanosoma).

### ❓ Cross Questions (from additional)

**Q: P. falciparum-এ peripheral blood film-এ কোন stage দেখা যায়?**
→ P. falciparum-এ শুধু ring trophozoites এবং banana/crescentic gametocytes PBF-তে দেখা যায়।

**Q: Babesia-র tetrad arrangement কেমন দেখায়?**
...
## P20: What do you mean by autoinfection? ***

> **📌 Hint:** transmission by ownself

### ✅ Answer

**Autoinfection:** when the patient himself carries the organism (parasite) and is **self-reinfected without requiring any external source**.
**Two types:**
...
**Q: কোন কোন parasite-তে autoinfection দেখা যায়?**
...
**Q: Cross infection আর autoinfection-এর পার্থক্য কি?**
...
## P21: Mention some parasites causing autoinfection. *****

> **📌 Hint:** E. vermicularis, T. solium, H. nana, C. hominis, SS (Strongyloides stercoralis)

### ✅ Answer

Parasites causing **autoinfection** (self-reinfection without external source):
...
## P22: Name the parasite causing sexually transmitted disease. ****

> **📌 Hint:** T. vaginalis

### ✅ Answer

**Trichomonas vaginalis** — causes trichomoniasis, a sexually transmitted infection (STI). It is transmitted by sexual contact with the infective form, the **trophozoite**.
...
**Q: Vaginal discharge-এর তিনটি common infectious cause কি কি?**
→ তিনটি common cause — Gardnerella vaginalis (BV), Candida albicans (VVC), Trichomonas vaginalis (trichomoniasis)।

**Q: Trichomoniasis-এর বৈশিষ্ট্য কি?**
→ Frothy yellow-green discharge + pH >4.5 + wet mount-এ motile trophozoites।

**Q: Trichomonas infection-এ partner-এর চিকিৎসা করা প্রয়োজন কেন?**
→ কেননা partner-কে চিকিৎসা না করলে reinfection হয়।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

STD (sexually transmitted disease) ঘটানো protozoan হলো **Trichomonas vaginalis**।
Transmission sexual contact দিয়ে — infective form হলো **trophozoite**; এটার cyst নেই, শুধু trophozoite form-ই আছে।
...
## P23: Name the parasite causing congenital infection. *****

> **📌 Hint:** T. gondii

### ✅ Answer

**Toxoplasma gondii** — causes congenital toxoplasmosis by **transplacental transmission of tachyzoites** from an infected mother to the fetus.
...
**Q: Toxoplasma কোন group-এর অন্তর্গত?**
→ Toxoplasma TORCH group-এর T (Toxoplasma, Others, Rubella, CMV, HSV-2)।

**Q: Tachyzoites কী এবং কীভাবে transmission হয়?**
→ Tachyzoites হলো acute infection-এ rapidly multiplying form — এগুলো transplacentally transmitted হয়।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

Congenital infection মানে মা থেকে fetus-এর infection। Parasite-দের মধ্যে এটা করে **Toxoplasma gondii**।
Mechanism — transplacental transmission of **tachyzoites** (acute infection-এ rapidly multiplying form) infected mother থেকে fetus-এ।
...
## P24: Name some opportunistic parasites. ******

> **📌 Hint:** C. hominis, T. gondii, SS (S. stercoralis), Isospora

### ✅ Answer

**Opportunistic parasites** (cause disease especially in immunocompromised / AIDS patients):
...
**Q: HIV-এর সাথে কোন parasite infection সবচেয়ে বেশি জিজ্ঞেস হয়?**
...
## P25: Name three (03) parasites causing fever. ****

> **📌 Hint:** Leishmania, Plasmodium, E. histolytica: amoebic liver abscess
...
## P26: Mention five (05) anaemia causing parasites. *******

> **📌 Hint:** both Hook worm, fish tapeworm, Leishmania and Plasmodium

### ✅ Answer

| Parasite | Type of anaemia | Mechanism |
|---|---|---|
| **Plasmodium spp.** | Microcytic hypochromic or normocytic normochromic | RBC lysis (parasite induced + autoimmune + splenic removal) |
| **Leishmania donovani** | Normocytic normochromic | BM hypoplasia (crowding of macrophages), haemolysis, anti-red cell antibody |
...
| **Diphyllobothrium latum** (fish tapeworm) | Macrocytic / megaloblastic (pernicious) | Interferes with intrinsic factor → B12 malabsorption; also consumes B12 |

### ❓ Cross Questions (from additional)

**Q: Dimorphic anaemia কী?**
→ Dimorphic anaemia মানে দুই morphological form (microcytic + macrocytic) একসাথে — hookworm-এ দেখা যায়।

**Q: A. duodenale কেন N. americanus-এর চেয়ে বেশি anaemia করে?**
→ কারণ A. duodenale-র ৬টা teeth, বড় size, বেশি migratory, আর বেশি blood loss (0.2 ml/worm/day বনাম 0.03)।

**Q: Ancylostoma-র কতগুলো worm প্রতিদিন কতটা blood নেয়?**
...
## P27: Name 05 important parasites which contribute eosinophilia. ****

> **📌 Hint:** W. bancrofti, E. granulosus, T. solium, A. lumbricoides, A. duodenale, parasites causing tissue infection
...
**Q: Eosinophils কীভাবে parasite-কে আক্রমণ করে?**
...
**Q: Ascaris larval migration-এ Loeffler's syndrome কী?**
...
## P28: Define premunition. ***

> **📌 Hint:** Plasmodium and Schistosoma

### ✅ Answer

**Premunition** (concomitant immunity): a type of immunity in which there is **relative resistance to re-infection while the host still carries the existing parasites**. It does not eliminate the present infection, but partially protects the patient against a fresh (re-)infection.
...
## P29: Define protozoa. Mention important criteria of protozoa. *****

> **📌 Hint:** unicellular eukaryotic, morphologically & functionally complete single cell unit

### ✅ Answer

**Protozoa** (Greek: protos = first, zoon = animal): **unicellular eukaryotic** organisms, **morphologically and functionally complete**, which act as a single "cell-like unit". A single cell of protozoa performs all life functions.
**Important criteria of protozoa:**
...
**Q: Protozoa-র asexual reproduction কীভাবে হয়?**
...
**Q: Protozoa-র sexual reproduction কীভাবে হয়?**
→ Sexual reproduction — conjugation (Balantidium coli), gametogony/syngamy (Plasmodium sporogony)।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

Protozoa — Greek "protos" (first) আর "zoon" (animal)। এটা **unicellular eukaryotic** organism — মানে একটাই cell দিয়ে গঠিত, আর সেটা **morphologically এবং functionally complete** — একটা protozoan cell-ই whole organism।
Important criteria —
- Unicellular eukaryote, kingdom Protista
...
## P30: "Protozoa act as a single cell like unit"- explain. ****

> **📌 Hint:** single cell performs all functions — reproduction, digestion, respiration, excretion

### ✅ Answer

**Protozoa is morphologically and functionally complete:** a single cell of protozoa is **not just a part of an organism — it is the whole organism**. Unlike metazoa where different cells perform different functions, in protozoa:
...
**Q: Metazoa-র সাথে এই ধারণার পার্থক্য কী?**
...
**Q: Protozoa-র functional two forms কী?**
...
## P31: Classify protozoa according to organ of locomotion with examples. *******

> **📌 Hint:** pseudopods, flagella and cilia

### ✅ Answer

| Group / Class | Organ of locomotion | Examples |
|---|---|---|
| **Rhizopoda** (Sarcodina) | **Pseudopodia** (less movement) | Entamoeba histolytica, free-living amoeba (Acanthamoeba, Naegleria) |
| **Mastigophora** (Zoomastigophora) | **Flagella** (more movement) | Giardia lamblia/intestinalis, Leishmania donovani, Trichomonas vaginalis, Trypanosoma |
| **Ciliata** | **Cilia** (highest movement) | Balantidium coli |
| **Sporozoa** | **No organ of locomotion** (moves by gliding motility) | Plasmodium spp., Toxoplasma gondii, Cryptosporidium hominis |
Speed of movement: **Cilia > Flagella > Pseudopodia**.

### ❓ Cross Questions (from additional)

**Q: কোন sporozoa-র gliding motility সবচেয়ে বেশি?**
→ Toxoplasma gondii-র গ্লাইডিং highest (Plasmodium-এর চেয়ে বেশি)।

**Q: মানুষে pathogenic একমাত্র ciliated protozoan কোনটি?**
→ Balantidium coli — একমাত্র ciliated protozoan যা man-এ pathogenic।

**Q: Trypanosoma-র শ্রেণীবিভাগ কি?**
...
Movement-এর speed: **Cilia > Flagella > Pseudopodia**। Toxoplasma-র gliding motility highest (Plasmodium-এর চেয়ে বেশি)। Trypanosoma — T. cruzi (America), T. brucei (Africa)।

---

## P32: Mention the protozoa which has no organ of locomotion. ****

> **📌 Hint:** Sporozoa

### ✅ Answer

**Sporozoa** (Sporozoans) — the group of protozoa that has **no organ of locomotion** (no pseudopodia, flagella or cilia).
Examples: **Plasmodium**, **Toxoplasma gondii**, **Cryptosporidium hominis**, Isospora belli, Cyclospora cayetanensis, Sarcocystis, Babesia.
Despite having no locomotory organ, they **can move** — by **gliding motility** (highest gliding in Toxoplasma gondii, then Plasmodium).

### ❓ Cross Questions (from additional)

**Q: Sporozoa-র reproduction কেমন?**
→ Sporozoa obligate intracellular parasites; sexual (sporogony) এবং asexual (schizogony) — দুই cycle-ই করে।

**Q: Apicomplexa-এর subcutaneous classification কি?**
...
যারা protozoa-র মধ্যে চলাচলের কোনো organ নেই, তাদের নাম **Sporozoa**। Pseudopodia নেই, flagella নেই, cilia নেই।
...
## P33: Can sporozoa move? (Yes. They have no organ of locomotion but can move. Their movement is called "gliding". Highest gliding motility: Toxoplasma gondii > Plasmodium > other sporozoa.)

> **📌 Hint:** they have no organ of locomotion but can move by gliding motility; Toxoplasma gondii highest

### ✅ Answer

**Yes, sporozoa can move.** Although they have **no organ of locomotion** (no pseudopodia, flagella or cilia), they move by **gliding motility** — a smooth, gliding movement over the substrate (using actin-myosin motor of the apical complex).
Order of gliding motility: **Toxoplasma gondii > Plasmodium spp. > other sporozoa**.
The tachyzoite stage of Toxoplasma shows the highest gliding motility among the sporozoa.

### ❓ Cross Questions (from additional)

**Q: "Protozoa-র movement speed-এর order কী?**
→ Movement speed order — Cilia > Flagella > Pseudopodia > Gliding।

**Q: Sporozoa কোন phylum-এ পড়ে?**
→ Sporozoa phylum Apicomplexa-তে (apical complex host-cell invasion-এ সাহায্য করে)।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

Sporozoa কি নড়তে পারে? — "Yes, they can move, but not with pseudopodia/flagella/cilia। They move by **gliding motility**।"
...
Order মনে রাখো — **Toxoplasma gondii > Plasmodium spp. > other sporozoa**। Toxoplasma-র tachyzoite stage সবচেয়ে highest gliding।
...
## P34: Mention three (03) name of sporozoa. ***

> **📌 Hint:** Plasmodium, Toxoplasma, Cryptosporidium
...
**Q: Sporozoa-র সাধারণ বৈশিষ্ট্য কি?**
...
## P35: Enlist the flagellates. ****

> **📌 Hint:** Tissue: Leishmania and Trypanosoma; luminal: T. vaginalis, G. lamblia

### ✅ Answer

| Group | Site | Organisms |
|---|---|---|
| **1. Hemo-flagellates / Tissue flagellates** | Found in blood or tissue | **Leishmania** (L. donovani, L. tropica, L. braziliensis etc.), **Trypanosoma** (T. cruzi and T. brucei) |
| **2. Luminal flagellates** (intestinal, oral, genital) | Found in alimentary canal or genital tract | **Giardia lamblia** (small intestine), **Trichomonas vaginalis** (vagina & urethra), Trichomonas hominis (ileocaecal), Trichomonas tenax (mouth), Chilomastix mesnili (caecum), Enteromonas hominis, Retortamonas intestinalis (large intestine) |

### ❓ Cross Questions (from additional)

**Q: Hemo-flagellates-এর morphological forms কি কি?**
→ ৪টা form — amastigote (no flagella), promastigote (flagella), epimastigote, trypomastigote।

**Q: সব flagellates কোন subphylum-এ পড়ে?**
...
## P36: Classify protozoa according to habitat. ***

> **📌 Hint:** intestinal, blood/tissue, genital, intracellular location (table from notes)

### ✅ Answer

| Protozoa | Habitat | Disease |
|---|---|---|
...
| Plasmodium species | RBC (+ hepatocytes) | Malaria |
...
| Isospora belli | Intestine | Diarrhoea in AIDS |
...
## P37: Name five (05) protozoa with their host, mode of transmission, infective form and diseases. ********

> **📌 Hint:** host + mode of transmission + infective form + disease table (from notes)

### ✅ Answer

| Protozoa | Transmission | Infective form | Host | Disease |
|---|---|---|---|---|
| **Entamoeba histolytica** | Contaminated food & water, housefly (mechanical) | Mature quadrinucleated cyst | Man (definitive) | Amoebiasis (intestinal & extra-intestinal) |
| **Giardia lamblia / intestinalis** | Contaminated food & water, housefly | Mature (quadrinucleated) cyst | Man (definitive) | Giardiasis (steatorrhoea — fatty stool) |
| **Plasmodium spp.** | Female Anopheles mosquito bite | Sporozoite | Definitive: mosquito; Intermediate: man | Malaria |
| **Leishmania donovani** | Sandfly bite | Promastigote | Definitive: man; Intermediate: sandfly | Leishmaniasis / Kala-azar |
| **Trichomonas vaginalis** | Sexual route | Trophozoite (only form) | Man (definitive) | Trichomoniasis / vaginitis |
| **Toxoplasma gondii** | Cat feces, congenital, undercooked meat | Oocyst, bradyzoites, tachyzoites | Definitive: cats; Intermediate: man | Toxoplasmosis |
| **Cryptosporidium hominis** | Contaminated food & water (feco-oral) | Oocyst | Man (definitive) | Cryptosporidiosis / diarrhoea in HIV pt. |

### ❓ Cross Questions (from additional)

**Q: প্রতিটি parasite-র infective form কি?**
→ Cyst (amoeba/Giardia), sporozoite (Plasmodium), promastigote (Leishmania), trophozoite (Trichomonas), oocyst (Toxoplasma/Crypto)।

**Q: Leishmania-র কোন form sandfly দিয়ে inject হয়?**
...
## P38: Name three protozoa causing diarrhoea. ****

> **📌 Hint:** E. histolytica and G. intestinalis
...
## P39: Enlist 02 protozoa located intracellularly. **

> **📌 Hint:** Leishmania: in monocyte or macrophage; Plasmodium: in RBC
...
**Q: Parasite-র intracellular location-এর সুবিধা কি?**
→ Intracellular location parasite-কে host immune system থেকে রক্ষা করে।

**Q: Leishmania কীভাবে macrophage-এ multiply করে?**
...
এছাড়া **Babesia microti** RBC-তে, **Toxoplasma gondii** endothelial cells/macrophages-এর মতো tissue cells-এ থাকে।
...
## P40: What do you mean by encystation and excystation? ****

> **📌 Hint:** encystation: trophozoite to cyst; excystation: cyst to trophozoite

### ✅ Answer

**Encystation:** the process of transformation of **trophozoite → cyst**. It occurs inside the lumen of the infected individual's intestine. In E. histolytica it occurs in the **large intestine**.
**Excystation:** the process of transformation of **cyst → trophozoite**, occurring when the cyst enters a new host's alimentary canal. In E. histolytica, excystation occurs in the **terminal ileum and caecum** — a mature quadrinucleated cyst gives rise to **8 amoebulae** (by division).
Note: encystation and excystation may occur in **one and the same host**; a new host is needed only for continuation of the species.

### ❓ Cross Questions (from additional)

**Q: Cyst wall কেন gastric juice-এ survives করে?**
→ Cyst wall gastric juice-এ resistant — তাই stomach দিয়ে passage-এ survive করে।

**Q: Giardia-র ক্ষেত্রে infective form আর pathogenicity কিভাবে?**
→ Giardia-র infective form mature cyst; duodenum-এ excystation-এর পর trophozoite হয় আর pathogenicity ঘটে।

**Q: Cyst আর trophozoite-র বৈশিষ্ট্য কি?**
→ Cyst = non-motile, infective, resistant; trophozoite = motile, pathogenic, vegetative।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Encystation** মানে trophozoite → cyst রূপান্তর — এটা infected ব্যক্তির intestine-এর lumen-এর ভিতর হয় (E. histolytica-তে large intestine-এ)।
**Excystation** মানে cyst → trophozoite রূপান্তর — যখন cyst নতুন host-এর alimentary canal-এ ঢোকে। E. histolytica-তে excystation হয় terminal ileum এবং caecum-এ; mature quadrinucleated cyst divide হয়ে **৮টা amoebulae** দেয়।
...
## P41: State the important differences between amoebic and bacillary dysentery. **

> **📌 Hint:** clinical (onset, fever, toxicity, tenderness, tenesmus) + stool character + microscopic features

### ✅ Answer

| Point | Amoebic dysentery (E. histolytica) | Bacillary dysentery (Shigella) |
|---|---|---|
| **Clinical** | **Clinical** | **Clinical** |
| Onset | Slow | Acute |
| Fever | Absent (or low) | Present, high |
| Toxicity | Absent | Present |
| Abdominal tenderness | Localized | Generalized |
| Tenesmus | Absent | Present |
| **Stool (Macroscopic)** | **Stool (Macroscopic)** | **Stool (Macroscopic)** |
| Frequency | 6–8 times/day | More than 10/day |
| Amount | Relatively copious | Small |
| Odor | Offensive | Odorless |
| Colour | Dark red | Bright red |
| Nature | Blood and mucus mixed with faeces | Blood and mucus with no or little faeces |
| Reaction | Acidic | Alkaline |
| Consistency | Not adherent to container | Adherent to the bottom of the container |
| **Microscopy** | **Microscopy** | **Microscopy** |
| RBCs | In clumps, yellowish | Discrete or in rouleaux, bright red |
| Pus cells | Scanty | Numerous |
| Macrophages | Few | Several, some with ingested RBCs (mistaken as E. histolytica) |
| Eosinophils | Present | Rare |
| Parasite | Trophozoite with ingested RBCs | Nil |
| Motile bacteria | Present (normal flora) | Nil |
| Pyhnotic bodies | Very common | Nil |
...
## P42: Mention the morphological, infective and pathogenic form of E. histolytica. ****

> **📌 Hint:** mature quadrinucleated cyst: infective form; trophozoite: pathogenic form
...
**Infective form** — mature quadrinucleated cyst (gastric juice-এ survive করে, তাই infection দেয়)।
**Pathogenic form** — trophozoite (tissue destroy করে, flask ulcer বানায়)।
...
## P43: What are the lesion produced by E. histolytica? *****

> **📌 Hint:** intestinal: large intestine + extra-intestinal
...
**Intestinal amoebiasis** — large intestine-এ (colon/caecum) flask-shaped ulcers, mucosa-submucosa; amoeboma (granuloma) tumour mimic করতে পারে।
**Extra-intestinal amoebiasis** —
...
## P44: Mention the site of infection of E. histolytica. *****

> **📌 Hint:** intestinal: large intestine and extra-intestinal
...
Site জিজ্ঞেস করলে —
**Intestinal site** — **Large intestine** — mucosa এবং submucosa (caecum, colon, sigmoid, rectum)।
**Extra-intestinal site** — liver (portal vein দিয়ে), lung, brain, spleen, skin, vagina/penis।
...
## P45: Mention 05 site of extra-intestinal amoebiasis. *****

> **📌 Hint:** liver, lungs, brain, spleen, skin etc

### ✅ Answer

**05 sites of extra-intestinal amoebiasis:**
...
**Q: Trophozoites কীভাবে এই sites-এ পৌঁছায়?**
...
## P46: Mention the pathogenesis of amoebiasis? * (Only for written)

> **📌 Hint:** host + infective form + mode of transmission + life cycle sequence

### ✅ Answer

**Pathogenesis of amoebiasis (E. histolytica):**
...
## P47: Mention the criteria of ulcer in intestinal amoebiasis. ***

> **📌 Hint:** flask shape ulcer; why flask shape: after penetration move side to side
...
**Q: Acute amoebic dysentery আর chronic carrier-এর stool-এ কী পাওয়া যায়?**
→ Acute amoebic dysentery-র stool-এ mostly trophozoites; chronic carrier-এ cysts পাওয়া যায়।

**Q: Colonic ulcer-এর সংখ্যা কেমন?**
...
## P48: Write down important points about pus of amoebic liver abscess. ***

> **📌 Hint:** anchovy sauce pus; organism mainly found in periphery
...
**Q: Amoebic liver abscess-এ stool examination কেমন থাকে?**
→ Stool examination প্রায়ই negative (শুধু ~১৫% ক্ষেত্রে cysts পাওয়া যায়)।

**Q: Pus-এ parasite detection-এর best test কী?**
...
## P49: Write down the laboratory diagnosis of intestinal amoebiasis. ***

> **📌 Hint:** stool examination (saline & iodine wet mount), culture, immunological, PCR

### ✅ Answer

1. Specimen collection: stool; blood for serology.
2. Macroscopic examination of stool: foul smelling, dark red stool mixed with blood and mucus.
...
4. Culture: xenic (polyxenic) and axenic culture — not done routinely.
5. Immunological test: antigen detection (lectin antigen in stool by ELISA); antibody detection (anti-lectin antibody in blood by ELISA).
6. Molecular detection: PCR.
7. Isoenzyme (zymodeme) analysis.

### ❓ Cross Questions (from additional)

**Q: E. histolytica নিশ্চিত করতে কোন microscopic finding সাহায্য করে?**
→ Motile, active trophozoites with ingested RBCs E. histolytica নিশ্চিত করে (E. dispar নয়)।

**Q: Specimen-এর examination কতক্ষণে করা উচিত?**
...
1. Specimen — stool; blood (serology-র জন্য)।
2. Macroscopic — foul smelling, dark red stool, blood+mucus mixed।
3. Microscopic — saline + iodine (wet mount); acute amoebic dysentery-এ trophozoites (ingested RBC সহ); chronic carrier-এ cysts। Pus cells scanty, Charcot-Leyden crystals present, motile bacteria (normal flora)। Trichrome stain ভালো view দেয়।
4. Culture — xenic (polyxenic) ও axenic — routine নয়।
5. Immunological — antigen: lectin antigen in stool by ELISA; antibody: anti-lectin antibody in blood by ELISA।
6. Molecular — PCR।
7. Isoenzyme (zymodeme) analysis।
...
## P50: Write down the laboratory diagnosis of hepatic amoebiasis. *****

> **📌 Hint:** USG-guided aspiration from peripheral zone, anchovy-sauce pus microscopy, ELISA (lectin), PCR

### ✅ Answer

1. Specimen collection: USG-guided pus aspiration, stool, blood for serology.
2. Macroscopic examination of pus: anchovy-sauce pus — chocolate/brown, thick consistency.
3. Microscopic examination of pus (~25% sensitive):
  ...
  - Peripheral zone: healthy hepatocytes and trophozoites
4. Liver biopsy: trophozoites can be demonstrated.
5. Stool examination: cysts found in ~15% cases (50% sensitive).
6. Serological test: antigen detection (lectin antigen in pus by ELISA — 100% sensitive); antibody detection (anti-lectin antibody in blood by ELISA); PCR — 100% sensitive.

### ❓ Cross Questions (from additional)

**Q: হেপাটিক অ্যামিবিয়াসিসের পুসের মাইক্রোস্কোপিতে কেন পেরিফারাল জোন থেকে অ্যাসপিরেশন নিতে হয়?**
...
**Q: হেপাটিক অ্যামিবিয়াসিসকে pyogenic liver abscess থেকে কিভাবে differentiate করবেন?**
...
**Q: Anchovy-sauce পুস কেন বাদামি রঙের হয়?**
...
## P51: How will you prevent transmission of E. histolytica? ***

> **📌 Hint:** main-boiling and filtration
...
**Q: E. histolytica-র সিস্ট কি পরিবেশে survive করতে পারে?**
...
**Q: Why treat asymptomatic carrier?**
...
**Q: Housefly কিভাবে E. histolytica transmit করে?**
...
## P52: Enlist the free living amoeba with diseases produces by them. ***

> **📌 Hint:** Acanthamoeba, Naegleria fowleri, Balamuthia, Sappinia — with their diseases

### ✅ Answer

| # | Free-living amoeba | Disease |
|---|---|---|
| 1 | **Acanthamoeba spp.** (A. castellanii, A. hatchetti, A. polyphaga) | Granulomatous amoebic encephalitis (GAE); **amoebic keratitis** in contact lens users |
| 2 | **Naegleria fowleri** | **Primary amoebic meningoencephalitis (PAM)** |
| 3 | **Balamuthia mandrillaris** | Granulomatous amoebic encephalitis (GAE) |
| 4 | **Sappinia diploidea** | Amoebic encephalitis |
These amoebae live free in soil and water but can accidentally infect man (facultative parasites).

### ❓ Cross Questions (from additional)

**Q: Naegleria fowleri কিভাবে মানুষকে infect করে?**
...
**Q: Acanthamoeba keratitis কেন contact lens users-এ বেশি হয়?**
...
**Q: Free-living amoeba কে facultative parasite কেন বলি?**
...
## P53: Mention the mode of transmission & infective form of G. intestinalis. ***

> **📌 Hint:** feco-oral, mature cyst
...
**Q: Giardia কি single host parasite?**
...
## P54: Mention the site of infection of G. lamblia. ***

> **📌 Hint:** small intestine

### ✅ Answer

The site of infection of **Giardia lamblia (G. intestinalis)** is the **small intestine — mainly the duodenum** (upper part of small intestine).
...
**Q: Giardia-কে common bile duct block করে কি না — কেন এই প্রশ্ন গুরুত্বপূর্ণ?**
...
## P55: Mention the causative agent steatorrhea. ***

> **📌 Hint:** G. lamblia or intestinalis

### ✅ Answer

**Giardia lamblia / Giardia intestinalis / Lamblia intestinalis** — the protozoan that causes **steatorrhoea** (passage of excess fat in stool — pale, foul-smelling, frothy, bulky greasy stool).
...
## P56: Give the pathogenesis of steatorrhoea. *** (only for written)

> **📌 Hint:** organism attached to duodenum → no or little absorption area for protein, lipid and carbohydrate

### ✅ Answer

1. Infection occurs by ingestion of mature cyst in contaminated food/water (feco-oral).
2. Excystation occurs in the duodenum → trophozoites multiply (binary fission).
3. The trophozoites attach to the duodenal mucosa by their sucking disc (ventral concave surface).
4. Attached organisms cover the absorbing surface → no or little absorption area remains for protein, lipid and carbohydrate.
5. Result: malabsorption → steatorrhoea, protein-losing enteropathy and lactose intolerance.

### ❓ Cross Questions (from additional)

**Q: Written answer-এ life cycle-এর কোন কোন ধাপ উল্লেখ করতে হয়?**
...
**Q: Steatorrhoea-তে কোন কোন জিনিস absorb হয় না?**
...
## P57: Give the laboratory diagnosis of giardiasis. ***

> **📌 Hint:** saline and iodine preparation of stool + string test

### ✅ Answer

1. Specimen collection: stool, duodenal secretion.
2. Macroscopic examination of stool: offensive odour, pale colour, frothy, fatty (floats).
3. Microscopic examination (wet mount): saline and iodine preparation of stool — cyst and trophozoite may be seen.
4. String test / Enterotest: if microscopy is negative — a gelatin capsule on a string is swallowed until it reaches the duodenum; trophozoites adhere to the string and are visualized after withdrawal.
5. Culture: axenic culture media (not routinely done).
6. Immunological test: antigen detection in stool by ELISA; antibody detection in serum by ELISA.
7. Molecular detection: PCR.

### ❓ Cross Questions (from additional)

**Q: Giardiasis-এ কি repeat stool examination লাগতে পারে?**
...
## P58: Mention the morphological form & infective form of T. vaginalis. *******

> **📌 Hint:** only trophozoite

### ✅ Answer

**Trichomonas vaginalis has only one morphological form — the trophozoite. It has NO cyst stage.**
...
**Q: T. vaginalis-এর cyst না থাকার ফলে কী হয়?**
...
## P59: Mention the mode of transmission of T. vaginalis. ***

> **📌 Hint:** sexually by trophozoite

### ✅ Answer

**Mode of transmission:** **sexual route** — by the trophozoite, through sexual contact with an infected partner. It is a sexually transmitted infection (STI).
...
**Q: T. vaginalis-এ female ও male-এ কি symptoms হয়?**
...
**Q: Vaginal pH-এ কি পরিবর্তন হয় T. vaginalis-এ?**
...
## P60: Write down four (04) important points of T. vaginalis. ****

> **📌 Hint:** flagellates, causes STD, only trophozoite form, highly motile
...
**Q: T. vaginalis diagnosis-এ সবচেয়ে important কি?**
...
## P61: Mention the laboratory diagnosis of T. vaginalis. ****

> **📌 Hint:** jerky motility of trophozoite in wet mount preparation of vaginal swab
...
3. Culture: Diamond's medium — not routinely done (sensitivity >95%).
4. Immunological test: antigen detection by ELISA (vaginal secretion); antibody detection by ELISA (serum).
5. Molecular test: PCR.
6. Other tests: Whiff test (amine test with 10% KOH — strong fishy odour) often positive.

### ❓ Cross Questions (from additional)

**Q: Wet mount sensitivity কি কম?**
...
## P62: Mention the vectors and diseases of Trypanosoma species. ***

> **📌 Hint:** T. cruzi: Chagas' disease by kissing or reduviid bug; T. brucei: sleeping sickness by tsetse fly

### ✅ Answer

| Species | Disease | Vector | Area |
|---|---|---|---|
| **Trypanosoma cruzi** | **Chagas' disease** (American trypanosomiasis) | **Reduviid (kissing) bug** — bug bites on face (around mouth/eyes); infection by contamination of bite wound with bug feces | America |
| **Trypanosoma brucei** (gambiense & rhodesiense) | **African sleeping sickness** (African trypanosomiasis) | **Tsetse fly** bite | Africa |
...
**Q: Trypanosoma brucei-তে cyclical fever কেন হয়?**
...
## P63: List the diseases produced by different species of Leishmania. ******

> **📌 Hint:** visceral (Kala-azar), cutaneous (CL), mucocutaneous (MCL) — species wise

### ✅ Answer

| Clinical type | Subdivision | Organism |
|---|---|---|
| **Visceral leishmaniasis (VL) = Kala-azar = Dumdum fever** | Classical Kala-azar | L. donovani |
| **Visceral leishmaniasis (VL) = Kala-azar = Dumdum fever** | Infantile Kala-azar | L. donovani infantum |
| **Visceral leishmaniasis (VL) = Kala-azar = Dumdum fever** | South American Kala-azar | L. chagasi |
| **Visceral leishmaniasis (VL) = Kala-azar = Dumdum fever** | Sudanese (leishmanoid) | L. archibaldi |
| **Cutaneous leishmaniasis (CL)** | Old World CL (oriental sore) | L. tropica, L. major, L. aethiopica (DCL) |
| **Cutaneous leishmaniasis (CL)** | New World CL | L. mexicana (chiclero's ulcer), L. braziliensis (CL) |
| **Cutaneous leishmaniasis (CL)** | Diffuse CL (DCL) | L. aethiopica, L. mexicana |
| **Cutaneous leishmaniasis (CL)** | Uta | L. peruviana |
| **Cutaneous leishmaniasis (CL)** | Pian bois | L. guyanensis |
| **Mucocutaneous leishmaniasis (MCL)** | Espundia | L. braziliensis; L. panamensis |

### ❓ Cross Questions (from additional)

**Q: Kala-azar-এর vector কি?**
...
## P64: What do you mean by old world and new world leishmania? *****

> **📌 Hint:** Old: outside America continent; New: America continent
...
**Q: Old World-এ vector কি আর New World-এ vector কি?**
→ Old World-এ Phlebotomus sandfly। New World-এ Lutzomyia sandfly — এটা মনে রাখতে হয়, confusion হয়।

**Q: Hookworm-এও কি old/new world terminology আছে?**
...
## P65: Name some species of new world and old world. ***

> **📌 Hint:** Old: L. donovani, L. tropica, L. major; New: L. braziliensis, L. mexicana, L. chagasi
...
## P66: Mention the vector of Kala-azar. ****

> **📌 Hint:** Sandfly: Phlebotomus argentipes

### ✅ Answer

The vector of Kala-azar is the **female sandfly — Phlebotomus argentipes** (biological vector / intermediate host).
...
## P67: Mention the mode of transmission of Kala-azar. ****
...
**Q: Infective form ও pathogenic form কি?**
...
## P68: Why there is anaemia in kala-azar? *********

> **📌 Hint:** overcrowding of macrophages, relative hypoplasia of bone marrow
...
## P69: What are the complications of Kala-azar? *****

> **📌 Hint:** complications due to pancytopenia (reduced WBC: secondary infections high; bleeding due to thrombocytopenia)

### ✅ Answer

Kala-azar is a fatal disease if untreated. Complications arise mainly **due to pancytopenia**:
...
**Q: Kala-azar untreated থাকলে কি হয়?**
...
## P70: How will you diagnose a case of visceral leishmaniasis or Kala-azar? ********

> **📌 Hint:** best sample: splenic aspirates then buffy coat from blood, then bone marrow; microscopy after Leishman staining; culture: NNN media; immunology: rK39 test important

### ✅ Answer

1. Clinical suspicion: pyrexia >15 days, H/O travel to endemic area within 2 months, splenomegaly/weight loss/anaemia (any one).
...
3. Rapid screening test: rK39 ICT — most used (but not confirmatory).
4. Microscopy (gold standard): Leishman-stained smear → LD bodies (amastigote): blue cytoplasm, pink/violet or slight red nucleus, bright red kinetoplast (right angle to nucleus), within monocyte/macrophage. Giemsa/Wright also used (Giemsa better for visualization).
5. Culture: NNN (Novy, MacNeal, Nicole) medium at 22–26°C for 1–4 weeks → promastigotes; slow, not routinely done.
6. Immunological test: antigen detection (ELISA, RIA); antibody detection (ELISA, CFT, DAT).
7. Molecular test: PCR — confirmatory.
8. Other tests: CBC — pancytopenia (anaemia, leucopenia with relative monocytosis, thrombocytopenia); nonspecific — aldehyde test, antimony test.

### ❓ Cross Questions (from additional)

**Q: Best sample কি আর কেন?**
...
## P71: Why buffy coat preparation is chosen instead of splenic aspirates?

> **📌 Hint:** splenic aspirates: bleeding; buffy coat: sensitivity and specificity almost close to splenic aspirates
...
## P72: How will you recognize LD bodies in microscopy? ***

> **📌 Hint:** blue cytoplasm, red nucleus, bright red kinetoplast

### ✅ Answer

**LD body** (Leishman–Donovan body) = the amastigote form of Leishmania donovani seen inside monocytes/macrophages. After **Leishman staining**:
- Cytoplasm: blue
...
**Q: Amastigote-এ flagellum কি থাকে?**
...
## P73: What do you mean by rk39 rapid test? ***

> **📌 Hint:** recombinant kinetoplast 39 test is an ICT test
...
ভাইভায় — "rK39 ইজ র‍্যাপিড ICT স্ক্রিনিং টেস্ট ফর VL, নট কনফার্মেটরি।"

---

## P74: Mention the locations of different morphological form of L. donovani. *****

> **📌 Hint:** amastigote in human and promastigote in vector; amastigote in microscopy and promastigote in culture

### ✅ Answer

Leishmania donovani exists in **two morphological forms**:
| Location | Morphological form | Features |
|---|---|---|
| **In human** (tissue) | **Amastigote** (LD body) — non-motile | Inside monocyte/macrophage; found in spleen, liver, bone marrow; pathogenic form |
| **In vector (sandfly)** | **Promastigote** — motile (flagellate) | In the gut of sandfly; infective form |
| **In microscopy** (smear of human material) | **Amastigote** | Leishman-stained LD bodies |
| **In culture** (NNN medium) | **Promastigote** | Grows as flagellated promastigotes at 22–26°C |

### ❓ Cross Questions (from additional)

**Q: Amastigote আর promastigote-এর difference কি?**
...
**Q: Culture-এ কোন form পাওয়া যায়?**
...
## P75: Which morphological form of L. donovani is found in human and vector? *****

> **📌 Hint:** amastigote in human and promastigote in vector
...
**Q: Amastigote কিভাবে macrophage-এ থাকে?**
...
## P76: Which morphological form of L. donovani is found during microscopy and culture? *****

> **📌 Hint:** amastigote in microscopy and promastigote in culture
...
**Q: Culture-এ amastigote কেন থাকে না?**
...
**Q: Microscopy gold standard কেন?**
...
## P77: What do you mean by PKDL? How will you diagnose a case of PKDL? ****

> **📌 Hint:** Post Kala-azar Dermal Leishmaniasis; sample: SSS (slit skin smear) and biopsy from nodule

### ✅ Answer

**PKDL = Post Kala-azar Dermal Leishmaniasis (dermal leishmanoid).** About 1–2 years after complete (and sometimes partial) treatment of visceral leishmaniasis/Kala-azar, ~5–10% (the md says about 5%) patients develop PKDL — the visceral infection disappears but a **local skin infection persists**.
**Clinical features:**
...
**Diagnosis of PKDL:**
1. History of Kala-azar + residence in endemic region + clinical features (macule, patch, nodule)
2. Sample collection: SSS (slit skin smear) and biopsy from the nodule (skin biopsy); blood for serology
3. Screening: rK39 ICT (less sensitive in PKDL than in Kala-azar)
4. Microscopy: Leishman-stained smear → LD bodies (amastigote; blue cytoplasm, pink/red nucleus, bright red kinetoplast)
5. Molecular test: PCR — confirmatory
...
**Q: PKDL-কে leprosy থেকে কিভাবে differentiate করবেন?**
...
## P78: List the diseases produced by different species of Plasmodium. ******

> **📌 Hint:** P. vivax (benign tertian), P. falciparum (malignant tertian), P. malariae (benign quartan), P. ovale (ovale tertian), P. knowlesi (quotidian)

### ✅ Answer

| # | Plasmodium species | Type of malaria |
|---|---|---|
| 1 | **P. vivax** | **Benign tertian malaria** (fever every 48 hours) |
| 2 | **P. falciparum** | **Malignant tertian malaria** (fever every 48 hours, with complications) |
| 3 | **P. malariae** | **Benign quartan malaria** (fever every 72 hours) |
| 4 | **P. ovale** | **Ovale tertian malaria** |
| 5 | **P. knowlesi** | **Quotidian malaria** (fever every 24 hours) |
"Malaria" is from "mal" (bad) + "aria" (air) — from the ancient false belief of spread by polluted air.

### ❓ Cross Questions (from additional)

**Q: Tertian fever মানে কি?**
...
## P79: Name the malarial parasites common in Bangladesh. *****

> **📌 Hint:** hilly: P. falciparum, all: P. vivax
...
## P80: How malaria is transmitted? What is the infective form? ****

> **📌 Hint:** Vector: bite of female Anopheles mosquito; infective form: sporozoite
...
**Q: Transfusion malaria-তে infective form কি?**
...
**Q: Transfusion malaria-তে relapse কেন হয় না?**
...
## P81: Mention the host of malaria. ****

> **📌 Hint:** mosquito definitive host, man intermediate host
...
**Q: Definitive host আর intermediate host-এর difference কি?**
...
## P82: Name the stages of Plasmodium in human cycle. *****

> **📌 Hint:** pre-erythrocytic or hepatic or primary exo-erythrocytic schizogony; erythrocytic schizogony; gametogony; latent or secondary exo-erythrocytic schizogony (hepatic)

### ✅ Answer

**Stages of Plasmodium in the human (intermediate host) cycle:**
...
**Q: Pre-erythrocytic schizogony কি?**
...
## P83: What is recrudescence and relapse? *****

> **📌 Hint:** relapse due to reactivation of hypnozoites: P. vivax and P. ovale; recrudescence due to persistence in circulation at a subclinical level: P. falciparum and P. malariae

### ✅ Answer

| Point | Relapse | Recrudescence |
|---|---|---|
| Mechanism | Reactivation of **hypnozoites** persisting in the **liver** → fresh erythrocytic cycles | Persistence of the parasite at a **subclinical level in circulation/blood** (erythrocytic forms) |
| Species | **P. vivax** and **P. ovale** | **P. falciparum** and **P. malariae** |
| Time | P. vivax: up to 3 yrs; P. ovale: 1–3 yrs | P. falciparum: up to 1 yr; P. malariae: up to 40 yrs |
| Source | Liver (hypnozoite) | Blood (persisting erythrocytic parasites) |

### ❓ Cross Questions (from additional)

**Q: P. malariae-তে recrudescence কত বছরের মধ্যে হয়?**
→ P. malariae-তে recrudescence ৪০ বছর পরও হতে পারে! Parasite low-grade blood-এ persist করতে পারে বহু বছর।

**Q: Relapse কী কারণে হয়?**
...
## P84: How will you diagnose a case of malaria? ********

> **📌 Hint:** blood thick film and thin film preparation by Giemsa stain

### ✅ Answer

1. Specimen collection: peripheral blood; CSF if cerebral malaria suspected.
2. Microscopy (gold standard): Giemsa or Leishman stain. Two films:
...
3. Culture: not routine.
4. Immunological (antigen) test: ICT — detects HRP-2 (P. falciparum only), plasmodium aldolase (pan-malarial), pLDH (pan-malarial); ELISA.
5. Molecular test: PCR — confirmatory, detects low parasitaemia.
6. CBC: anaemia, thrombocytopenia.
Note: for P. falciparum only ring trophozoites and banana/crescentic gametocytes are seen; in P. vivax all stages are found.

### ❓ Cross Questions (from additional)

**Q: Thick film আর thin film-এর difference কি?**
...
## P85: How will you differentiate P. vivax and P. falciparum in peripheral blood? *****

> **📌 Hint:** P. vivax: all forms found; P. falciparum: only ring trophozoite and banana shaped gametocytes; RBC enlarged in P. vivax, normal in P. falciparum

### ✅ Answer

| Point | P. vivax | P. falciparum |
|---|---|---|
| Hypnozoites | Yes | No |
| RBC infected | Reticulocytes (immature) | Mature + immature RBCs (all ages) |
| Infected RBC size | **Enlarged** | **Normal** (size unaltered) |
| Stippling | Schuffner's dots | Maurer's dots |
| Stages in peripheral blood | **All stages** — ring, growing trophozoites, schizonts, gametocytes | **Only ring trophozoites** and **banana/crescentic gametocytes** (no schizonts in PBF; cytoadherent) |
| Early ring trophozoite | Large (2.5 µm), prominent chromatin | Small (1.5 µm), accolé forms (applied to RBC margin) |
| Late trophozoite | Irregular, vacuolated, actively amoeboid | Compact |
| Schizont | 9–10 µm, fills enlarged RBC; merozoites 12–24, grape-like cluster | 4.5–5 µm (fills ⅔ of RBC); merozoites 18–24 |
| Gametocyte | Spherical, larger than RBC | **Crescentic/banana-shaped**, larger than RBC |

### ❓ Cross Questions (from additional)

**Q: P. malariae-তে কি বিশেষ feature আছে?**
→ Mature RBC infect করে, normal size, Ziemann's dots, band-form trophozoite, rosette schizont, hypnozoite নেই।

**Q: Falciparum schizont peripheral blood-এ কেন নেই?**
...
## P86: Give the peripheral blood film findings of P. falciparum. *****

> **📌 Hint:** only ring trophozoite and banana shaped gametocytes; RBCs size unaltered
...
## P87: What are the antigens of Plasmodium?

> **📌 Hint:** HRP-2 (P. falciparum only), Plasmodium aldolase and LDH (pan-malarial); PfEMP-1 in cytoadherence

### ✅ Answer

**Antigens of Plasmodium used for diagnosis (detected by ICT):**
...
Pathogenesis-related surface antigen: **PfEMP-1** (P. falciparum erythrocyte membrane protein 1) — responsible for knob formation and cytoadherence in cerebral malaria.
...
## P88: Why there is anaemia in malaria? *****

> **📌 Hint:** mechanical lysis, autoimmune lysis, splenic removal of infected and uninfected RBCs
...
**Q: Malaria-তে anaemia কি টাইপের?**
...
## P89: State the pathogenesis of cerebral malaria. ****

> **📌 Hint:** PfEMP-1 of P. falciparum enhances knob formation, cytoadherence, resetting, clumping in microvasculature such as brain capillaries

### ✅ Answer

**Pathogenesis of cerebral malaria (P. falciparum):**
1. P. falciparum expresses a specialized antigen PfEMP-1 (P. falciparum erythrocyte membrane protein 1).
2. Knob formation: infected RBCs with high surface PfEMP-1 develop knob protuberances on the cell membrane.
3. Cytoadherence: parasitized RBCs with sticky knobs adhere to the endothelial surface; PfEMP-1 binds endothelial receptors (CD36, ICAM-1).
4. Rosetting: infected RBCs bind to uninfected RBCs (via CR1 receptors).
5. Clumping: parasitized RBCs aggregate in the microvasculature (e.g., brain capillaries).
6. Plugging & occlusion: microvessels are plugged → occlusion of cerebral microcirculation → cerebral anoxia → coma, paralysis.
Clinical features: hyperpyrexia, headache, coma, paralysis; death occurs in 15–20% of cerebral malaria cases (md).

### ❓ Cross Questions (from additional)

**Q: Cerebral malaria-তে diagnosis কি?**
...
## P90: What is black water fever? ***

> **📌 Hint:** intravascular hemolysis in previously experienced repeated P. falciparum

### ✅ Answer

**Blackwater fever:** a serious complication of **P. falciparum** malaria characterized by **sudden intravascular haemolysis** (massive) followed by fever and **dark red/blackish or port-wine coloured urine** (haemoglobinuria). It occurs in patients who have **previously experienced repeated P. falciparum infections** and have been treated inadequately with quinine.
**Mechanism (autoimmune):** antibodies develop against parasitized and quininized RBCs; with subsequent infection and quinine treatment ⇒ immune-complex formation → complement-mediated massive lysis of both parasitized and non-parasitized RBCs. No haptoglobin is left to bind excess Hb → free Hb passes in urine.
G6PD-deficient patients may develop it after oxidant drugs even without malaria.

### ❓ Cross Questions (from additional)

**Q: Blackwater fever কাদের হয়?**
...
## P91: Mention some complications of malaria. ******

> **📌 Hint:** complications of P. falciparum (pernicious malaria, blackwater fever, anaemia, renal failure, hypoglycaemia, pulmonary oedema, etc.)
...
**Q: Tropical splenomegaly syndrome কি?**
...
## P92: State some complications of Plasmodium falciparum. *****

> **📌 Hint:** pernicious malaria: cerebral & septicemic malaria, blackwater fever, hypoglycemia, hypo and hyperthermia, anaemia, renal failure, hepatic dysfunction, pulmonary oedema, metabolic acidosis, shock, heart problem, rupture spleen
...
## P93: Which malarial species is more dangerous & why? ******

> **📌 Hint:** P. falciparum: complications more; high rate drug resistance due to mutation; anaemia more due to infect both mature & immature RBCs

### ✅ Answer

**P. falciparum** is the most dangerous malarial species. Reasons:
1. Complications more: causes pernicious malaria (cerebral malaria, algid, septicemic) and blackwater fever — life-threatening.
2. High rate of drug resistance: shows resistance to common antimalarials due to high rate of mutation of genes.
3. Anaemia more: P. vivax, P. malariae, P. ovale infect either young or old RBCs, but P. falciparum invades both young (immature) and mature RBCs → more RBC destruction → more anaemia.
...
**Q: Vivax/ovale কি ধরনের RBC infect করে?**
→ Reticulocytes (immature RBC) infect করে।

**Q: Malariae কি ধরনের RBC infect করে?**
→ Mature RBCs only infect করে।

**Q: Falciparum immune clearance কে resist করে?**
...
## P94: Enlist some malaria protective conditions. ***

> **📌 Hint:** sickle cell anaemia, thalassemia, HbE, HbC, glucose 6 phosphate dehydrogenase deficiency, lack of Duffy blood group
...
## P95: Mention the staining methods used for Cryptosporidium hominis. ***

> **📌 Hint:** modified acid fast stain (Kinyoun), auramine-rhodamine stain (immunofluorescence)
...
Specimen: stool. These stains demonstrate the **oocyst** (the diagnostic form) of Cryptosporidium hominis.

### ❓ Cross Questions (from additional)

**Q: Crypto oocyst কিভাবে acid-fast হয়?**
...
## P96: Mention diagnostic approach of Cryptosporidium hominis. **

> **📌 Hint:** stool examination to see oocyst by modified acid fast stain or auramine-rhodamine stain

### ✅ Answer

1. Specimen collection: stool; (biopsy in refractory cases).
2. Microscopic examination of stool: demonstrate oocyst by (a) modified acid-fast (Kinyoun) staining or (b) auramine–rhodamine immunofluorescence staining.
3. Immunological test: antigen detection in stool by ELISA; antibody detection by ELISA.
4. Molecular test: PCR (confirmatory).
5. Culture: not done.

### ❓ Cross Questions (from additional)

**Q: Crypto oocyst-এর size কি?**
→ Round, ৪-৬ μm। Acid-fast। ৪টি sporozoite থাকে।

**Q: AIDS patient-এ crypto কেন severe?**
...
## P97: State the name of host & mode of transmission of T. gondii. ****

> **📌 Hint:** cat-like animal: definitive host; from the definitive host and congenital transmission

### ✅ Answer

| Point | Details |
|---|---|
| **Definitive host** | **Cat family animals (felines)** — sexual cycle/gametogony occurs in cat intestine → oocyst with 8 sporozoites in cat feces |
| **Intermediate host** | **Man** (and other mammals/birds) — asexual cycle (tachyzoites, bradyzoites) |
| **Infective forms** | **Oocyst** (with 8 sporozoites), **bradyzoites** (in tissue cysts), **tachyzoites** (acute form) |
| **Mode of transmission** | 1. Ingestion of mature **oocyst** with contaminated food/water/cat feces (common); 2. **Congenital (transplacental)** transmission of tachyzoites — mother to fetus; 3. Ingestion of **tissue cyst** (bradyzoites) in undercooked meat (lamb, pork); 4. Accidental inoculation of cat feces through skin |
| **Disease** | Toxoplasmosis |

### ❓ Cross Questions (from additional)

**Q: T. gondii-র morphological forms কি কি?**
→ Tachyzoites (acute infection-এ), bradyzoites (chronic — tissue cyst, brain-এ most common), oocyst (sexual cycle, cat feces-এ)।

**Q: Congenital toxoplasmosis-এ 1st trimester-এ কেন severe?**
...
## P98: Mention two (02) important properties of B. coli. *

> **📌 Hint:** only ciliated protozoa, largest cyst, two nuclei

### ✅ Answer

**Balantidium coli** — important properties:
...
Also: **largest protozoan** and has the **largest cyst** among protozoa; two contractile vacuoles; two forms (cyst & trophozoite).
...
## P99: Write down the differences between cestodes, trematodes and nematodes.******

> **📌 Hint:** read from the differences table in parasitology
...
| Point | Cestodes | Trematodes | Nematodes |
|---|---|---|---|
| Common name | Tapeworm | Flukes | Roundworm / worm |
| Shape | Tape-like, flat | Leaf-like, flat | Elongated, cylindrical (filiform) |
| Segmentation | Segmented (proglottids) | Unsegmented | Unsegmented |
| Sexes | Not separated (monoecious / hermaphrodite) | Not separated (monoecious) except Schistosoma (diecious) | Separated (diecious) |
| Head | Suckers, often with hooks | Sucker but no hooks (oral + ventral sucker) | No sucker, no hooks; some have buccal capsule with teeth or cutting plate |
| Alimentary canal | Absent | Present but incomplete (no anus) | Present and complete (with anus) |
| Body cavity | Absent | Absent | Present |
| Body covering | Cuticle / tegument | Tegument | Cuticle |

### ❓ Cross Questions (from additional)

**Q: মেটাজোয়া (Metazoa) কী?**
...
**Q: প্রত্যেক শ্রেণির একটি করে উদাহরণ দাও।**
...
সবচেয়ে গুরুত্বপূর্ণ মনে রাখার পয়েন্ট — **Cestode = no gut, Trematode = gut but no anus, Nematode = full gut with anus**। টেবিলটা ক্রমানুসারে বললেই ভাইভাতে ফুল মার্কস পাবে।

---

## P100: Write down the characteristics of cestodes, trematodes and nematodes. *********

> **📌 Hint:** read the characteristics of trematodes, cestodes, nematodes from the differences

### ✅ Answer

**Characteristics of cestodes (tapeworms):**
...
## P101: Classify helminthes (metazoa) on the basis of reproduction. **

> **📌 Hint:** based on reproduction (laying eggs or larva)
...
এই সিম্পল কনসেপ্টটা মনে থাকলে ভাইভাতে বলতে পারবে। মনে রাখার কৌশল — **রক্তে লার্ভা পেলে = ভিভিপেরাস, মলে লার্ভা পেলে (SS) = ওভোভিভিপেরাস, মলে ডিম্ব পেলে = ওভিপেরাস**।

---

## P102: Name the viviparous, oviparaous and ovoviviparous nematodes. ***

> **📌 Hint:** viviparous — give birth to larvae; ovoviviparous — lay eggs containing larvae that hatch out
...
**Q: ভিভিপেরাস ফাইলারিয়াল কৃমি কী ধরনের লার্ভা ছেড়ে দেয়?**
→ মোটাইল মাইক্রোফাইলারিয়া (L1 লার্ভা), যা রক্তে বা টিস্যু তরলে পাওয়া যায়।

**Q: S. stercoralis-এর মলে কী পাওয়া যায় এবং কেন?**
...
**ভিভিপেরাস:** W. bancrofti, Brugia, D. medinensis, Trichinella — এরা সবাই সরাসরি লার্ভা জন্ম দেয়।
**ওভোভিভিপেরাস:** শুধু Strongyloides stercoralis — এটি ডিম্ব দেয় কিন্তু ডিম্বের ভিতরেই লার্ভা থাকে।
**ওভিপেরাস:** AL, TT, AD, NA, EV — এরা সাধারণ ডিম্ব দেয়। AL ও TT-র ডিম্ব unsegmented, AD ও NA-র ডিম্ব segmented, EV-র ডিম্বে লার্ভা থাকে।
মনে রাখার কৌশল: **রক্তে লার্ভা = ভিভিপেরাস, মলে লার্ভা (SS) = ওভোভিভিপেরাস, মলে ডিম্ব = ওভিপেরাস**। এটুকুই যথেষ্ট।

---

## P103: Write down the important character of cestodes/ tapeworm. ********

> **📌 Hint:** tapeworm — segmented, no gut, hermaphrodite
...
**Q: Cyclophyllidea ও Pseudophyllidea — scolex দিয়ে কীভাবে আলাদা করবে?**
...
**Q: ইনটেস্টাইনাল বনাম সোমাটিক সেস্টোডের উদাহরণ দাও।**
...
**Q: সবচেয়ে ছোট ও সবচেয়ে বড় সেস্টোড কোনটি?**
...
## P104: List the medically important cestodes with their host, infective form, mode of transmission, diseases. *******

> **📌 Hint:** T. saginata, T. solium, E. granulosus, D. latum, H. nana with host/infective form/transmission/diseases

### ✅ Answer

| Cestode | Definitive host | Intermediate host | Infective form | Mode of transmission | Disease |
|---|---|---|---|---|---|
| T. saginata | Man | Cattle | Larva (cysticercus bovis) | Ingestion of larvae in undercooked beef | Intestinal taeniasis |
| T. solium | Man | Pigs, occasionally man | Larva (cysticercus cellulosae) for taeniasis; egg for cysticercosis | Undercooked pork (taeniasis); ingestion of eggs in food/water or autoinfection (cysticercosis) | Intestinal taeniasis & cysticercosis |
| E. granulosus | Dog, fox, wolf | Sheep (optimum), man (dead-end / accidental) | Eggs in dog's faeces | Ingestion of eggs from dog faeces | Hydatid disease / hydatid cyst |
| D. latum | Man, cat, dog | Copepods (1st) & fish (2nd) | Larva (plerocercoid) | Ingestion of undercooked freshwater fish | Diphyllobothriasis (macrocytic anaemia) |
| H. nana | Man (only) | None | Egg | Ingestion of eggs in contaminated food/water or autoinfection | Hymenolepiasis (dwarf tapeworm) |

### ❓ Cross Questions (from additional)

**Q: প্রত্যেকটি সেস্টোডের সাধারণ নাম কী কী?**
...
## P105: Mention two (02) dangerous cestodes and explain the reason. *** (T. solium due to cysticercosis and E. granulosus after rapture hydatid cyst)

> **📌 Hint:** T. solium due to cysticercosis and E. granulosus after rupture hydatid cyst

### ✅ Answer

The two most dangerous cestodes are:
1. Taenia solium (pork tapeworm): Dangerous because it causes cysticercosis. When man ingests the eggs (contaminated food/water or autoinfection), the oncosphere hatches, penetrates the intestine and reaches the brain, muscles and eyes as cysticercus cellulosae. Neurocysticercosis (brain) is the most serious form causing epilepsy and is a fatal space-occupying lesion.
2. Echinococcus granulosus (dog tapeworm): Dangerous because its larval stage forms a hydatid cyst, mainly in the liver. If the cyst ruptures, it leads to severe anaphylactic reaction and shock (due to escape of hydatid fluid antigens) and can cause secondary cysts in other organs.

### ❓ Cross Questions (from additional)

**Q: cysticercosis কখন হয় — অপরিপাকৃত শূকরের মাংস খেলে নাকি egg খেলে?**
→ cysticercosis হয় শুধুমাত্র T. solium-এর egg খেলে। অপরিপাকৃত শূকরের মাংস খেলে অন্ত্রে taeniasis হয়, cysticercosis হয় না।

**Q: Neurocysticercosis কেন গুরুতর?**
→ এটি endemic এলাকায় intracranial space-occupying lesion (ICSOL)-এর সবচেয়ে সাধারণ কারণ, যা epilepsy ও মৃত্যু ঘটাতে পারে।

**Q: Hydatid cyst ফাটলে কী হয়?**
...
1. T. solium (pork tapeworm): কেন বিপজ্জনক? কারণ এটি cysticercosis করে। মানুষ যখন T. solium-এর egg খায় (দূষিত খাবার/পানি বা autoinfection থেকে), তখন oncosphere অন্ত্রে ফুটে বের হয়, অন্ত্রের দেয়াল ছিদ্র করে brain, muscle, eye-তে পৌঁছায় এবং সেখানে cysticercus cellulosae হিসাবে আবদ্ধ হয়। Neurocysticercosis সবচেয়ে গুরুতর — brain-এ epilepsy ও fatal space-occupying lesion তৈরি করে।
2. E. granulosus (dog tapeworm): কেন বিপজ্জনক? এর লার্ভা stage hydatid cyst তৈরি করে, মূলত লিভারে। যদি cyst ফেটে যায়, তাহলে hydatid fluid-এর antigen রক্তে প্রবেশ করে তীব্র anaphylactic reaction ও shock হয় — এটা medical emergency। এছাড়া অন্যান্য অঙ্গে secondary cyst তৈরি হতে পারে।
...
## P106: Mention six (06) differentiating point between T. saginata and T. solium (including transmission and host) ****

> **📌 Hint:** transmission and host must be included; beef vs pork, unarmed vs armed

### ✅ Answer

| Point | T. saginata (beef tapeworm) | T. solium (pork tapeworm) |
|---|---|---|
| Common name | Beef tapeworm / unarmed tapeworm | Pork tapeworm / armed tapeworm |
| Host (intermediate) | Cattle | Pig, occasionally man (accidental) |
| Infective form | Larva (cysticercus bovis) in beef | Larva (cysticercus cellulosae) in pork for taeniasis; egg for cysticercosis |
| Mode of transmission | Ingestion of undercooked/raw beef | Ingestion of undercooked pork (taeniasis); ingestion of eggs/autoinfection (cysticercosis) |
| Scolex (rostellum & hooks) | No rostellum, no hooks (unarmed) | Rostellum present with two rows of hooks (armed) |
| Disease in man | Intestinal taeniasis only (not cysticercosis) | Intestinal taeniasis + cysticercosis |

### ❓ Cross Questions (from additional)

**Q: দুই কৃমির আয়তন ও proglottid সংখ্যায় পার্থক্য কী?**
→ T. saginata বড় (৫–১০ মিটার, proglottid ১০০০–২০০০); T. solium ছোট (২–৩ মিটার, proglottid <১০০০)।

**Q: T. saginata-র egg মানুষকে সংক্রমিত করতে পারে কি?**
→ না, T. saginata-র egg শুধু গরুকে সংক্রমিত করে। T. solium-এর egg মানুষ ও শূকর — দুজনকেই সংক্রমিত করতে পারে।

**Q: proglottid কীভাবে মলে আসে?**
→ T. saginata-র proglottid সক্রিয়ভাবে নিজে নিজে বেরিয়ে আসে; T. solium-এর proglottid নিষ্ক্রিয়ভাবে ৫–৬টির সিরিজে আসে।

**Q: Uterus-এর শাখা সংখ্যা কত?**
...
1. সাধারণ নাম: T. saginata = beef/unarmed tapeworm; T. solium = pork/armed tapeworm।
2. Intermediate host: T. saginata = গরু; T. solium = শূকর, মাঝে মাঝে মানুষ (accidental)।
3. Scolex: T. saginata-তে rostellum ও hooks নেই (unarmed); T. solium-এ rostellum ও দুই সারি hooks আছে (armed)।
4. সংক্রমণের পথ: T. saginata = অপরিপাকৃত গরুর মাংস; T. solium = অপরিপাকৃত শূকরের মাংস (taeniasis) বা egg গ্রহণ (cysticercosis)।
5. Infective form: T. saginata = larva (cysticercus bovis); T. solium = taeniasis-এর জন্য larva (cysticercus cellulosae), cysticercosis-এর জন্য egg।
6. রোগ: T. saginata = শুধু অন্ত্রে taeniasis (cysticercosis হয় না); T. solium = অন্ত্রে taeniasis + cysticercosis।
মনে রাখার কৌশল: **\"Saginata = Safe (cysticercosis হয় না), Solium = Serious (cysticercosis হয়)\"**।

---

## P107: Which one is more dangerous between T. solium & T. saginata and why? ***** (T. solium due to cysticercosis)

> **📌 Hint:** T. solium due to cysticercosis

### ✅ Answer

**T. solium (pork tapeworm)** is more dangerous than T. saginata because:
...
উত্তরটা সংক্ষেপে: **\"T. solium, কারণ cysticercosis / neurocysticercosis।\"**

---

## P108: How cysticercosis occurs in man? *** (when ingest contaminated egg or autoinfection not by taking undercooked pork)

> **📌 Hint:** when ingest contaminated egg or autoinfection — not by taking undercooked pork

### ✅ Answer

Cysticercosis occurs when man ingests the **eggs** of T. solium (NOT by eating undercooked pork — that causes intestinal taeniasis). The sequence is:
1. Man ingests eggs of T. solium in contaminated food or water, or by autoinfection (internal autoinfection by reverse peristalsis releasing eggs from gravid proglottids in intestine, or external autoinfection by faecal–oral self-contamination).
2. In the small intestine, the egg wall is digested and the oncosphere is liberated.
3. With the help of hooklets, the oncosphere penetrates the intestinal wall and enters the portal circulation and mesenteric lymphatics.
4. It is carried to various organs — brain, subcutaneous tissue, muscle and eyes.
5. The oncosphere develops into cysticercus cellulosae (encysted larva) within 7–9 weeks, producing cysticercosis.

### ❓ Cross Questions (from additional)

**Q: গুরুত্বপূর্ণ পার্থক্য কী — অপরিপাকৃত শূকরের মাংস খেলে কী হয় আর egg খেলে কী হয়?**
→ অপরিপাকৃত শূকরের মাংস খেলে অন্ত্রে taeniasis হয়; egg খেলে cysticercosis হয়।

**Q: Neurocysticercosis ছাড়া cysticercus আর কোথায় কোথায় যেতে পারে?**
→ Subcutaneous tissue-এ গাঁঠ (nodule) হিসাবে, পেশিতে (acute myositis) এবং চোখে (ocular cysticercosis)।

**Q: cysticercus-এর কমন সাইটগুলো কী?**
→ Central nervous system, subcutaneous tissue এবং চোখ।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

মানুষ যখন T. solium-এর **egg** খায় — দূষিত খাবার/পানি থেকে বা autoinfection থেকে — তখন cysticercosis হয়। প্রক্রিয়াটা ধাপে ধাপে বলো:
1. ছোট অন্ত্রে egg-এর প্রাচীর গলে oncosphere মুক্ত হয়।
2. Hooklets সাহায্যে oncosphere অন্ত্রের দেয়াল ছিদ্র করে portal circulation ও mesenteric lymphatics-এ প্রবেশ করে।
3. Blood stream ধরে বিভিন্ন অঙ্গে পৌঁছায় — brain, subcutaneous tissue, muscle, চোখ।
4. ৭–৯ সপ্তাহের মধ্যে oncosphere cysticercus cellulosae-তে পরিণত হয় (encysted larva), ফলে cysticercosis হয়।
গুরুত্বপূর্ণ: **অপরিপাকৃত শূকরের মাংস খেলে taeniasis হয়, cysticercosis হয় না** — এই পার্থক্যটা জোর দিয়ে বলো।

---

## P109: Enumerate the infective form, host, and mode of transmission of E. granulosus. *** (man: dead end intermediate host, optimum intermediate host: sheep; dog: definitive host)

> **📌 Hint:** man: dead end intermediate host; optimum intermediate host: sheep; dog: definitive host
...
**Q: Egg খাওয়ার পর oncosphere কোন পথে যায়?**
...
**Q: মানুষকে dead-end host বলা হয় কেন?**
...
## P110: Write in short note on hydatid cyst. ********

> **📌 Hint:** larval stage of E. granulosus; structure: pericyst, ectocyst, endocyst; hydatid fluid & sand

### ✅ Answer

The **hydatid cyst** is the larval stage of E. granulosus. When the oncosphere (liberated from the ingested egg) settles in an organ and gets encysted by host tissue, it develops into a large fluid-filled bladder-like cyst. Greek 'hydatis' means 'a drop of water'.
...
**Hydatid fluid ও sand:** পরিষ্কার রংহীন তরল, low specific gravity (১.০০৫–১.০১০), সামান্য acidic pH (~৬.৭), antigenic ও toxic। **Hydatid sand** = brood capsule ও protoscolex-এর দানাদার পলি যা ভেঙে তলায় জমা হয়।
**সাইট:** লিভার সবচেয়ে বেশি (৭০%), তারপর ফুসফুস (২০–৩০%), তারপর spleen, kidney, brain, চোখ, হাড়।
মনে রাখার কৌশল: **\"P-E-E = Pericyst-Ectocyst-Endocyst\"**।

---

## P111: Mention the site of hydatid cyst (also common site). ****** (commest site: liver as first filter)

> **📌 Hint:** commonest site: liver as first filter
...
- Other sites: spleen, kidney, brain, eyes, bones, heart, muscle and pelvic organs (urinary bladder, uterus, fallopian tube, ovary).

### ❓ Cross Questions (from additional)

**Q: oncosphere পোর্টাল সার্কুলেশনে প্রবেশ করে কোন ফিল্টারে আটকায়?**
→ প্রথম ফিল্টার লিভার — অধিকাংশ oncosphere এখানে আটকে যায় (৭০%), কারণ লিভার portal vein-এর প্রথম ফিল্টার।

**Q: লিভার পার করে যাওয়া oncosphere কোথায় যায়?**
...
সবচেয়ে সাধারণ সাইট = **লিভার**, কারণ লিভার প্রথম ফিল্টার — portal vein দিয়ে আসা oncosphere-এর বেশিরভাগই লিভারেই আটকে যায় (৭০%)।
তারপর **ফুসফুস** — দ্বিতীয় ফিল্টার, ২০–৩০%।
...
## P112: Mention the consequences of raptured hydatid cyst. ***** (anaphylactic reaction and shock)

> **📌 Hint:** anaphylactic reaction and shock

### ✅ Answer

The consequences of a **ruptured hydatid cyst** are:
1. Anaphylactic reaction (type I hypersensitivity): escape of hydatid fluid antigens into the circulation causes a severe anaphylactic reaction, which can lead to anaphylactic shock — a medical emergency.
2. Formation of secondary cysts: rupture releases protoscolices/brood capsules into the circulation, which are carried to other organs and develop into secondary cysts.
3. Secondary bacterial infection of the ruptured cyst can cause pyogenic complications.

### ❓ Cross Questions (from additional)

**Q: তাই কেন exploratory puncture করা হয়?**
→ না, করা হয় না — কারণ puncture করলে cyst ফেটে hydatid fluid বের হয়ে anaphylaxis হতে পারে।

**Q: Hydatid fluid কেন বিপজ্জনক?**
→ কারণ এটি antigenic ও toxic — সেই জন্যই type-I hypersensitivity reaction হয়।

**Q: একটি বড়, ফাটা ছাড়া cyst কী প্রভাব ফেলে?**
...
1. Anaphylactic reaction (type-I hypersensitivity) — hydatid fluid-এর antigen রক্তে প্রবেশ করে তীব্র প্রতিক্রিয়া ও anaphylactic shock — এটি medical emergency।
2. Secondary cyst তৈরি — ফেটে গেলে protoscolex ও brood capsule রক্তে ছড়িয়ে পড়ে, অন্যান্য অঙ্গে গিয়ে নতুন cyst তৈরি করে।
3. দ্বিতীয়ত, cyst-এ bacterial infection হলে pyogenic জটিলতা হতে পারে।
তাই exploratory puncture করা হয় না — puncture করলেই fluid বের হয়ে anaphylaxis হতে পারে। এই পয়েন্টগুলো বললেই যথেষ্ট।

---

## P113: How is hydatid cyst diagnosed? ** (mainly accidental songraphical diagnosis, non invasive test: casoni's reaction)

> **📌 Hint:** mainly accidental sonographical diagnosis; non-invasive test: Casoni's reaction

### ✅ Answer

Hydatid cyst is often diagnosed **accidentally** by **ultrasonography (USG)** during investigation of other problems — this is the main non-invasive imaging method. Other diagnostic measures are:
...
**Q: Casoni's test কীভাবে করা হয়?**
...
Non-invasive test = **Casoni's reaction** — একটি immediate (type-I) hypersensitivity skin test; sterile hydatid fluid antigen দিয়ে করা হয়; ৩০ মিনিটে ৫ সেমি বা তার বেশি wheal positive। (আধুনিক যুগে low sensitivity ৬০–৮০% ও cross-reactivity-র কারণে অনেকটা বাতিল।)
অন্যান্য নির্ণয়:
...
## P114: 'Human is dead end intermediate host for E. granulosus'- Explain. *** (no access to eat human flesh by the definitive host)

> **📌 Hint:** no access to eat human flesh by the definitive host

### ✅ Answer

Man is called a **dead-end intermediate host** for E. granulosus because:
...
**Q: প্রাকৃতিক cycle কীভাবে টিকে থাকে?**
→ কুকুর → ভেড়া → কুকুর — এই cycle-ই স্বাভাবিক। মানুষ শুধু accidental intermediate host।

**Q: মানুষ E. granulosus-এর সংক্রমণ ছড়াতে পারে কি?**
...
সংক্ষেপে: **\"no access to eat human flesh\"** — এই logic-টাই বলবে।

---

## P115: Mention the disease name of D. latum. (macrocytic Anaemia)

> **📌 Hint:** macrocytic Anaemia

### ✅ Answer

The disease caused by **Diphyllobothrium latum** (fish tapeworm) is **Diphyllobothriasis**, which manifests as **macrocytic (megaloblastic/pernicious) anaemia** and sometimes intestinal obstruction.

### ❓ Cross Questions (from additional)

**Q: D. latum মানুষের সবচেয়ে লম্বা tapeworm কি?**
...
D. latum-এর রোগ = **Diphyllobothriasis**, যা **macrocytic (megaloblastic/pernicious) anaemia** হিসেবে প্রকাশ পায়, কখনো কখনো intestinal obstruction-ও করে।
...
## P116: How does D. latum produce anaemia? ****** (release unsaturated fatty acid which interfere with intrinsic factor of castle, so B12 absorption hamper & also take B12 as food and)

> **📌 Hint:** releases unsaturated fatty acid which interferes with intrinsic factor of Castle, so B12 absorption is hampered; also takes B12 as food

### ✅ Answer

D. latum, residing in the upper small intestine (ileum), produces **megaloblastic (macrocytic) anaemia** by two mechanisms:
1. It liberates unsaturated fatty acids which interfere with the functioning of the intrinsic factor of Castle, thereby impairing vitamin B12 absorption → megaloblastic/pernicious anaemia.
2. D. latum also takes up vitamin B12 as its own food, competing with the host, leading to B12 deficiency and megaloblastic anaemia.

### ❓ Cross Questions (from additional)

**Q: পরজীবীদের anaemia টেবিলে D. latum-এর ধরন কী?**
→ macrocytic (megaloblastic/pernicious) anaemia।

**Q: নির্ণয়ে কী কী পাওয়া যায়?**
...
D. latum ছোট অন্ত্রের উপরের অংশে (ileum) থাকে এবং **megaloblastic (macrocytic) anaemia** তৈরি করে দুইটি mechanism-এ:
1. Unsaturated fatty acid নিঃসরণ করে → intrinsic factor of Castle-এর কার্যকারিতা নষ্ট করে → vitamin B12 শোষণ ব্যাহত হয় → megaloblastic/pernicious anaemia।
2. D. latum নিজে vitamin B12 খাদ্য হিসাবে গ্রহণ করে — হোস্টের সাথে প্রতিযোগিতা করে → B12 deficiency → megaloblastic anaemia।
দুটো mechanism ধাপে ধাপে বললেই ভাইভাতে সুন্দর উত্তর হবে।

---

## P117: Write down the characteristics of trematodes/ flukes. *********

> **📌 Hint:** flukes — leaf-like, unsegmented, two suckers, hermaphrodite except Schistosoma
...
**Q: ট্রিমাটোডকে habitat অনুযায়ী কী কী ভাগে ভাগ করা হয়?**
...
**Q: Schistosome-এর egg কীভাবে আলাদা করা হয়?**
...
**Q: বেশিরভাগ fluke-এর intermediate host কী?**
...
- শরীর গহ্বর নেই।
ভাইভাতে একটা লাইন বলো: **\"Trematode = Two suckers, no anus, Schisto is diecious\"**।

---

## P118: List the medically important trematodes. ******* (blood flukes: Schistosoma hematobium, S. japonicum, S. mansoni; lungs flukes: P. westermani, intestinal flukes: F. buski, G. hominis, liver flukes: F. hepatica and C. sinensis)

> **📌 Hint:** blood flukes: Schistosoma haematobium, S. japonicum, S. mansoni; lung flukes: P. westermani; intestinal: F. buski, G. hominis; liver: F. hepatica, C. sinensis
...
## P119: Enumerate the blood flukes, intestinal flukes, liver flukes and lungs flukes. ****

> **📌 Hint:** enumerate all flukes by their site
...
## P120: Write in short about schistosomiasis/ Bilharziasis. **

> **📌 Hint:** blood fluke disease; cercariae penetrate skin; acute & chronic forms

### ✅ Answer

**Schistosomiasis (Bilharziasis)** is the disease caused by blood flukes of the genus Schistosoma (S. haematobium, S. mansoni, S. japonicum).
...
## P121: Mention three (03) cancer causing parasites. *** (mainly trematodes: S. hematobium: bladder cancer. F. hepatica and C. sinensis: liver cancer)

> **📌 Hint:** mainly trematodes: S. haematobium → bladder cancer; F. hepatica and C. sinensis → liver cancer
...
**Q: S. mansoni কোন ধরনের ক্যান্সার করে?**
→ S. mansoni → colorectal carcinoma এবং কখনো কখনো liver carcinoma।

**Q: আর কোন পরজীবী cholangiocarcinoma করে?**
→ Opisthorchis viverrini, O. felineus, Schistosoma japonicum।

**Q: Plasmodium কী ধরনের ক্যান্সারের সাথে যুক্ত?**
...
1. Schistosoma haematobium → Bladder carcinoma — মূত্রাশয়ে egg জমে granuloma → fibrosis → পরবর্তীতে carcinoma।
2. Fasciola hepatica → Hepatocellular carcinoma (লিভার ক্যান্সার)।
3. Clonorchis sinensis → Cholangiocarcinoma (পিত্তনালী/লিভার ক্যান্সার)।
মনে রাখো: **\"Bladder = haematobium, Liver/bile = hepatica & sinensis\"**।
সম্পর্কিত: S. mansoni → colorectal/liver carcinoma; Opisthorchis → cholangiocarcinoma; Plasmodium → Burkitt's lymphoma।

---

## P122: Mention the general characteristics of nematodes. *******

> **📌 Hint:** cylindrical, diecious, complete gut, body cavity present, cuticle
...
মনে রাখো: **\"Nematode = full gut + diecious + body cavity\"**।

---

## P123: Classify nematodes. ****** (intestinal: AL, AD, NA, TT, EV, SS and tissue: W. bancrofti, Loa loa, Oncocerca volvulus)

> **📌 Hint:** intestinal: AL, AD, NA, TT, EV, SS; tissue: W. bancrofti, Loa loa, Onchocerca volvulus
...
## P124: Name five (05) intestinal and some tissue (somatic) nematodes. *********

> **📌 Hint:** intestinal: AL, AD, NA, TT, EV, SS; tissue: W. bancrofti, Loa loa, O. volvulus

### ✅ Answer

**Five intestinal nematodes:**
...
## P125: Name the common nematodes found in Bangladesh. **** (EV, AL, TT, W. bancrofti, AD, SS)

> **📌 Hint:** EV, AL, TT, W. bancrofti, AD, SS
...
**Q: বাংলাদেশে ব্যাংক্রফটিয়ান ফাইলারিয়াসিস কোথায় এন্ডেমিক?**
→ উত্তরবঙ্গের জেলাগুলোতে — Nilphamari, Dinajpur, Rangpur, Panchagar, Kurigram, Gaibandha, Lalmonirhat।

**Q: স্কুল-বয়সী শিশুদের সবচেয়ে বেশি কোন অন্ত্রের পরজীবী হয়?**
→ AL, EV এবং TT।
...
## P126: Why are helminthic diseases not commonly seen in our country now? ** [deworming programme (because most people take antihelminthic drugs for prophylactic measure), sanitation improvement]

> **📌 Hint:** deworming programme because most people take antihelminthic drugs prophylactically, and sanitation improvement

### ✅ Answer

Helminthic diseases have become uncommon in Bangladesh because of:
1. Deworming programmes: most people, especially school children, take antihelminthic drugs (e.g. albendazole) regularly as a prophylactic measure through mass deworming campaigns conducted by the Ministry of Health.
2. Sanitation improvement: safe drinking water (WA), proper disposal of human waste and reduction of open defecation (S), and improved personal hygiene (H) — the WASH approach.

### ❓ Cross Questions (from additional)

**Q: WASH পদ্ধতি কী বোঝায়?**
→ Water (নিরাপদ পানি), Sanitation (সঠিক স্যানিটেশন), Hygiene (ব্যক্তিগত পরিচ্ছন্নতা)।

**Q: আর কী কী কারণে সংক্রমণ কমেছে?**
...
1. Deworming programme: স্কুলের শিশু থেকে শুরু করে অধিকাংশ মানুষ, স্বাস্থ্য মন্ত্রণালয়ের mass deworming কর্মসূচির মাধ্যমে নিয়মিত antihelminthic ওষুধ (যেমন albendazole) সেবন করছে — এটি prophylactic measure হিসাবে কাজ করে।
2. স্যানিটেশন উন্নতি: নিরাপদ পানীয় জল (Water), মানব বর্জ্যের সঠিক নিষ্পত্তি ও খোলা মলত্যাগ হ্রাস (Sanitation), এবং ব্যক্তিগত পরিচ্ছন্নতার উন্নতি (Hygiene) — একসাথে WASH দৃষ্টিভঙ্গি।
উন্নত আবাসন, পয়ঃনিষ্কাশন, নগরায়ন, দারিদ্র্য হ্রাস ও শিক্ষাও সংক্রমণ কমাতে ভূমিকা রাখে।

---

## P127: Name six (06) common nematodes with their infective form? *** (SS & AD: filariform larva; rest of the intestinal nematodes: Egg)

> **📌 Hint:** SS & AD: filariform larva; rest of the intestinal nematodes: Egg

### ✅ Answer

| Nematode | Infective form |
|---|---|
| S. stercoralis (SS) | Filariform larva (skin penetration) |
| A. duodenale (AD) — hookworm | Filariform larva (skin penetration) |
| Ascaris lumbricoides (AL) | Embryonated egg |
| Enterobius vermicularis (EV) | Embryonated egg |
| Trichuris trichiura (TT) | Embryonated egg |
| Necator americanus (NA) | Filariform larva (skin penetration) |

### ❓ Cross Questions (from additional)

**Q: কোন নেমাটোড চামড়া দিয়ে ঢোকে?**
→ Hookworm (AD, NA) এবং S. stercoralis — ফাইলারিফর্ম লার্ভা skin penetration করে।

**Q: কোনগুলো egg খেয়ে সংক্রমণ ছড়ায়?**
...
## P128: Which nematode's ovum are commonly found in stool? *** (AL, AD, TT)
...
**Q: বাইল-দাগা (bile-stained) egg মলে কোন কোন কৃমির?**
→ AL ও TT — bile-stained egg; AD ও NA — non-bile-stained egg; SS — larva।

**Q: EV-এর egg কোথায় পাওয়া যায়?**
...
## P129: Which nematode's larva is found in stool? *** (SS)

> **📌 Hint:** SS

### ✅ Answer

**Strongyloides stercoralis (SS)** is the nematode whose **larva (rhabditiform larva)** is found in stool, not the egg. Because SS is ovoviviparous — the female lays eggs containing larvae which hatch immediately, and the rhabditiform larvae are passed in the faeces.

### ❓ Cross Questions (from additional)

**Q: রেবডিটিফর্ম লার্ভার বৈশিষ্ট্য কী?**
→ এটি SS-এর মলে ডায়াগনস্টিক ফর্ম — ছোট, double-bulb esophagus বিশিষ্ট।

**Q: SS-এর infective form কোনটি?**
→ Filariform larva (L3)।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Strongyloides stercoralis (SS)**-ই সেই নেমাটোড যার **larva (rhabditiform larva)** মলে পাওয়া যায়, egg নয়। কারণ SS ovoviviparous — স্ত্রী কৃমি egg দেয় যার ভিতরে larva থাকে এবং সাথে সাথে ডিম্বগুলো ফুটে যায়, ফলে rhabditiform larva মলের সাথে বের হয়।
এটা বলার সময় জোর দাও — **SS-এর ক্ষেত্রে মলে larva, অন্য সব worm-এর ক্ষেত্রে মলে egg**।

---

## P130: Mention the pathogenecities caused by A. lumbricoides. *** (mechanical, surgical)

> **📌 Hint:** mechanical, surgical

### ✅ Answer

**Pathogenic lesions caused by the larva:**
...
**Pathogenic lesions caused by the adult worm (mechanical/surgical):**
...
**প্রাপ্তবয়স্ক কৃমি জনিত (mechanical/surgical):**
...
মনে রাখো: **\"Big worm = big trouble (obstruction)\"**।

---

## P131: Mention the important characteristics of ova of AL, AD, TT, EV? ** (AL: fertilized and heaviest unfertilized egg; AD: segmented egg with four blastomere, TT: barrel shaped with mucous plug, EV: planoconvex with tadpole like larva)

> **📌 Hint:** AL: fertilized & heaviest unfertilized egg; AD: segmented egg with four blastomeres; TT: barrel-shaped with mucous plug; EV: planoconvex with tadpole-like larva

### ✅ Answer

| Ovum | Shape | Size | Colour / covering | Content |
|---|---|---|---|---|
| A. lumbricoides (AL) | Fertilized: round/oval; Unfertilized: narrower, longer | Fertilized 60–75 × 40–50 µm; unfertilized 80 × 55 µm | Bile-stained, golden brown; thick mammillated albuminous shell (outer coat lost in unfertilized) | Fertilized: large unsegmented ovum with crescentic poles; unfertilized: mass of refractile granules. **Eggs are the heaviest.** |
| A. duodenale (AD) | Oval / elliptical | 65 × 40 µm | Not bile-stained; thin transparent hyaline shell | Segmented ovum with **4 (sometimes 8) blastomeres** |
| T. trichiura (TT) | **Barrel-shaped (lemon-shaped)** with **mucous plugs** at both poles | 50 × 25 µm | Bile-stained, brownish; double-layered shell | Un-segmented ovum |
| E. vermicularis (EV) | **Plano-convex** (one side flat, other convex), asymmetrical | 50–60 × 20–30 µm | Not bile-stained, colourless; transparent double-layered shell | Coiled **tadpole-shaped larva** |

### ❓ Cross Questions (from additional)

**Q: AL-এর fertilized egg যেমন স্যাচুরেটেড সল্ট দ্রবণে কী করে?**
→ Fertilized egg float করে; unfertilized egg-টি ভাসে না।

**Q: ইনটেস্টাইনাল নেমাটোডের \"key\" কী?**
...
| Ovum | আকৃতি ও বৈশিষ্ট্য |
|---|---|
| A. lumbricoides (AL) | Fertilized — গোল/ডিম্বাকার, bile-stained, mammillated shell; unfertilized — সরু-লম্বা, refractile granules; **সবচেয়ে ভারী egg**। |
| A. duodenale (AD) | Oval/elliptical, thin hyaline shell, **৪টি blastomere** (কখনো ৮টি), non-bile-stained। |
| T. trichiura (TT) | **Barrel/lemon আকৃতি**, দুটি মাথায় **mucous plug**, bile-stained, double-layered shell, unsegmented। |
| E. vermicularis (EV) | **Plano-convex** (এক পাশ সমতল), colourless, transparent shell, ভেতরে **tadpole-like larva**। |
মনে রাখো: **\"AL — heaviest, AD — 4 blastomeres, TT — barrel + mucous plug, EV — plano-convex + tadpole\"**।

---

## P132: What do you mean by old world and new world hook worm? **** (old: outside America- AD, new world: within ameria- N. americanus)

> **📌 Hint:** old world: outside America — A. duodenale; new world: within America — N. americanus
...
মনে রাখো: **\"Old = outside America (AD), New = within America (NA)\"**। A. duodenale বেশি anaemia করে কারণ এর ৬টি teeth ও বেশি blood loss।

---

## P133: Mention the pathogenecities caused by A. duodenale. (Anaemia main)

> **📌 Hint:** Anaemia is the main pathogenicity

### ✅ Answer

**Anaemia is the main pathogenicity** of A. duodenale (hookworm), specifically **microcytic hypochromic (iron-deficiency) anaemia**, rarely dimorphic anaemia.
**Pathogenic lesions caused by the larva:**
...
**Pathogenic lesions caused by the adult worm:**
...
**Q: কোন hookworm বেশি anaemia করে?**
...
A. duodenale-এর প্রধান pathogenicity = **anaemia** — বিশেষত microcytic hypochromic (iron-deficiency) anaemia, কদাচিৎ dimorphic।
**লার্ভা জনিত:**
...
## P134: State the pathogenesis of anaemia caused by Hook worm. ******* (release anticoagulant, continuous oozing main)

> **📌 Hint:** release anticoagulant, continuous oozing is main; chronic blood loss

### ✅ Answer

Hookworm anaemia is a **microcytic hypochromic (iron-deficiency) anaemia** (rarely dimorphic) caused by **chronic blood loss** from the small intestine. Mechanism:
1. Sucking of blood: the adult hookworm attaches to the intestinal mucosa and sucks blood as its food.
2. Release of anticoagulant: the worm's oesophageal glands release an anticoagulant (and anti-allergic inhibitor) which prevents clotting of blood at the attachment site, producing continuous oozing of blood (the main mechanism).
3. Migration: the worm changes its attachment site, leaving multiple bleeding points.
4. Nutritional loss: the worm also consumes iron and vitamin B12/folic acid from the host's diet.
...
**Q: A. duodenale-র blood loss প্রায় কত?**
...
**Q: কতগুলো worm-এ ~১% রক্ত ক্ষয় হয়?**
→ A. duodenale-এর প্রায় ১২টি worm।

**Q: non-specific পরীক্ষায় কী পাবে?**
→ Occult blood (OBT) প্রায়ই positive, eosinophilia।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

Hookworm anaemia-এর রহস্য = **continuous oozing**। Mechanism ধাপে ধাপে বলো:
1. প্রাপ্তবয়স্ক hookworm অন্ত্রের mucosa-তে লেগে রক্ত শোষণ করে খাদ্য হিসাবে।
2. worm-এর oesophageal gland anticoagulant নিঃসরণ করে → রক্ত ঠেকে না → continuous oozing — এটি মূল mechanism।
3. কৃমি জায়গা বদলায় — একাধিক bleeding point থেকে যায়।
4. কৃমি হোস্টের খাদ্যের iron ও vitamin B12/folic acid ও খেয়ে নেয়।
...
## P135: S/N: larva migran. *** (visceral and cutaneous larva migran)

> **📌 Hint:** visceral and cutaneous larva migrans

### ✅ Answer

**Larva migrans** occurs when certain nematode larvae accidentally infect man (humans are the unusual/aberrant host). The larvae cannot complete their normal development, their lifecycle is arrested, and they wander aimlessly in the body. Types:
...
**2. Cutaneous larva migrans (CLM) — 'creeping eruption':**
- Occurs in skin and subcutaneous tissue caused by larvae of animal hookworms that cannot penetrate below the stratum germinativum of human skin.
...
**Q: ভিএলএম ও সিএলএম-এর চিকিৎসা কী?**
→ VLM — diethylcarbamazine (DEC) + prednisolone; CLM — thiabendazole।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Larva migrans** — যখন কিছু নেমাটোড লার্ভা ঘটনাক্রমে মানুষকে সংক্রমণ করে (মানুষ aberrant/unusual host), তখন লার্ভা স্বাভাবিক বিকাশ সম্পূর্ণ করতে পারে না এবং শরীরে ছোটাছুটি করে।
**১. Visceral larva migrans (VLM):**
...
- Eosinophilia: massive।
**২. Cutaneous larva migrans (CLM) — \"creeping eruption\":**
...
- Eosinophilia: mild।
মনে রাখো — **Toxocara = visceral (VLM), animal hookworm = cutaneous (CLM)**।

---

## P136: Give the mode of transmission and pathogenesis of enterobiasis. ** (egg contaminated food and autoinfection)

> **📌 Hint:** egg-contaminated food and autoinfection
...
## P137: Give the laboratory diagnosis of enterobiasis. ********* (sample: perianal swab by scotch tape or NIH swab)

> **📌 Hint:** sample: perianal swab by scotch tape or NIH swab
...
**Q: Enterobiasis-এ চিকিৎসা কাকে দেওয়া হয়?**
...
## P138: Which sample is better for diagnosis of enterobiasis & how is it collected? **** (sample: perianal swab by scotch tape or NIH swab)

> **📌 Hint:** sample: perianal swab by scotch tape or NIH swab

### ✅ Answer

The **better sample** for diagnosis of enterobiasis is the **perianal swab**, because the gravid female worm lays eggs on the perianal skin at night (in the presence of oxygen).
**How it is collected:**
...
**Q: এই egg-এর বৈশিষ্ট্য কী?**
→ Plano-convex, ভেতরে কুণ্ডলিত tadpole-like larva।

**Q: মল কেন ভালো নমুনা নয়?**
→ কারণ egg perianal ত্বকে পড়ে, মলে নয়।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Enterobiasis-এর সেরা নমুনা = perianal swab**, কারণ gravid female নাইটে perianal ত্বকে egg দেয় (oxygen-এর উপস্থিতিতে)।
সংগ্রহ পদ্ধতি:
...
## P139: Mention the peculiarities in life cycle of E. vermicularis. *** (external autoinfection, retrograde or internal autoinfection, lay egg in perianal region, no intermediate host, no migration to lungs, complete its development in the presence of oxygen)

> **📌 Hint:** external autoinfection, retrograde/internal autoinfection, lays eggs in perianal region, no intermediate host, no migration to lungs, completes development in presence of oxygen
...
**Q: পুরুষ কৃমির কী হয়?**
→ Fertilization-এর পরই মারা যায়।

**Q: কোন নেমাটোডদের lung migration নেই?**
→ EV ও TT — lung migration-বিহীন নেমাটোড।

**Q: প্রাপ্তবয়স্ক কৃমিকে কি host মেরে ফেলে?**
...
মনে রাখো — lung migration-হীন নেমাটোড: **EV ও TT**।

---

## P140: Why eggs are not found in stool of enterobiasis? *** (lay egg in perianal region in presence of oxygen)

> **📌 Hint:** lay egg in perianal region in the presence of oxygen

### ✅ Answer

Eggs are not found in the stool of enterobiasis because the **gravid female worm migrates down to the perianal region and lays its eggs there**, in the **presence of oxygen** (at night when the host is in bed). The eggs complete their development on the perianal skin — not in the intestine — so they are not passed in the stool. This is why stool examination is not useful; instead, a perianal swab (NIH/scotch-tape) is used.

### ❓ Cross Questions (from additional)

**Q: মলে কখনো প্রাপ্তবয়স্ক কৃমি দেখা যায় কি?**
→ কদাচিৎ প্রাপ্তবয়স্ক কৃমি মলে দেখা যেতে পারে, কিন্তু egg নয়।

**Q: egg কতক্ষণে infective হয়?**
→ Perianal ত্বকে কয়েক ঘণ্টার মধ্যে egg infective হয়ে যায়।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

Enterobiasis-এর মলে egg পাওয়া যায় না — কারণ **gravid female worm অন্ত্র থেকে নিচে নেমে perianal অঞ্চলে egg দেয়** — **oxygen-এর উপস্থিতিতে** (রাতে, যখন রোগী বিছানায়)। Egg তাদের বিকাশ perianal ত্বকেই সম্পূর্ণ করে — অন্ত্রে নয় — তাই এগুলো মলে বের হয় না।
এই কারণেই মল পরীক্ষা কাজে লাগে না — বদলে perianal swab (NIH/scotch-tape) ব্যবহার হয়।
ভাইভাতে এই যুক্তিটো স্পষ্ট করে বলো।

---

## P141: How autoinfection occurs in enterobiasis? *** (external autoinfection by hand to mouth after scracthing around anus and internal autoinfection due to retrograde movement against peristalsis)

> **📌 Hint:** external autoinfection by hand-to-mouth after scratching around anus; internal autoinfection due to retrograde movement against peristalsis

### ✅ Answer

Autoinfection in enterobiasis occurs by two ways:
1. External autoinfection: The female lays eggs on the perianal skin; intense itching leads the person to scratch the area, getting embryonated eggs under the nails. These eggs are transferred to the mouth (anus-to-mouth) by contaminated fingers/food, causing re-infection.
2. Internal (retrograde) autoinfection: Eggs laid on the perianal skin hatch into infective larvae which migrate back through the anus into the colon (retrograde movement, against peristalsis), developing into adults without leaving the body.

### ❓ Cross Questions (from additional)

**Q: External = কী, internal = কী?**
→ External autoinfection = anus-to-mouth; internal autoinfection = anus-to-colon।

**Q: আর কাদের মধ্যে autoinfection দেখা যায়?**
...
1. External autoinfection: স্ত্রী কৃমি perianal ত্বকে egg দেয়; তীব্র চুলকানিতে আক্রান্ত ব্যক্তি ওই এলাকা চুলকায়, ফলে নখের নিচে embryonated egg চলে আসে। সেই egg দূষিত আঙুল/খাবারের মাধ্যমে মুখে যায় (anus-to-mouth) — রি-ইনফেকশন ঘটে।
2. Internal (retrograde) autoinfection: perianal ত্বকে জমা egg হ্যাচ করে infective larva, যা anus দিয়ে colon-এ পেছনের দিকে (peristalsis-এর উল্টো দিকে) ঢুকে যায় — শরীর ছাড়াই আবার প্রাপ্তবয়স্ক হয়।
মনে রাখো — external = anus-to-mouth; internal = anus-to-colon।

---

## P142: Mention the peculiarities in life cycle of S. stercoralis. *** (two distinct life cycle: in human and in soil, ovoviviparous, parthenogenesis, hyperinfection: reinfection and autoinfection)

> **📌 Hint:** two distinct life cycle (in human and in soil), ovoviviparous, parthenogenesis, hyperinfection: reinfection and autoinfection

### ✅ Answer

The life cycle of *S. stercoralis* is unique because of the following peculiarities:
1. Two distinct life cycles:
  - Direct (parasitic) cycle — inside the human body.
  - Indirect / free-living cycle — in the soil.
2. Ovoviviparous: The female produces eggs that hatch inside the body, so larvae (not eggs) are passed in the stool.
3. Parthenogenesis: Reproduction without fertilization by a male (adult males are not found in the human intestine).
4. Hyperinfection — of two types:
  - Reinfection — in immunocompromised patients.
  - Autoinfection — larvae reinvade within the same host.
Unlike other nematodes, a change of host is **not essential**; the larva can develop into the infective form without an intermediate host.

### ❓ Cross Questions (from additional)

**Q: SS-এর infective form ও diagnostic form কোনটি?**
...
**Q: Hyperinfection syndrome কখন মারাত্মক?**
...
1. দুটি পৃথক জীবনচক্র:
  - Direct (parasitic) cycle — মানবদেহের ভিতরে।
  - Indirect / free-living cycle — মাটিতে।
2. Ovoviviparous: স্ত্রী এমন egg দেয় যা শরীরের ভিতরেই ফুটে যায় — তাই মলে larva (egg নয়) বের হয়।
3. Parthenogenesis: পুরুষের ফার্টিলাইজেশন ছাড়াই প্রজনন; (মানুষের অন্ত্রে প্রাপ্তবয়স্ক পুরুষ পাওয়া যায় না)।
4. Hyperinfection: দুই ধরনের —
...
## P143: Mention the name of nematodes which commonly migrate through lungs. *** (AL, AD, NA, SS)

> **📌 Hint:** AL, AD, NA, SS

### ✅ Answer

The nematodes that **commonly migrate through the lungs** (systemic / lung migration) during their life cycle are:
1. AL — Ascaris lumbricoides
2. AD — Ancylostoma duodenale (hookworm)
3. NA — Necator americanus (hookworm)
4. SS — Strongyloides stercoralis
...
**Q: ফুসফুসে বেশি লার্ভা হলে কী হয়?**
→ **Loeffler's syndrome** (Ascaris pneumonia) — একটি transient eosinophilic pneumonia হতে পারে।

**Q: এদের জন্য lung migration কি? — স্বাভাবিক না অস্বাভাবিক?**
...
মনে রাখোর কৌশল: **\"AL, AD, NA, SS — lung migrants\"**।

---

## P144: Mention the nematodes which usually not migrate through lungs. *** (EV, TT)

> **📌 Hint:** EV, TT

### ✅ Answer

The nematodes that **do NOT show systemic (lung) migration** in man are:
1. EV — Enterobius vermicularis (pinworm)
2. TT — Trichuris trichiura (whipworm)
Their larvae develop entirely within the intestine without passing through the lungs.

### ❓ Cross Questions (from additional)

**Q: Enterobius-এর লার্ভা কোথায় বিকশিত হয়?**
→ ছোট অন্ত্রে লার্ভা বিকশিত হয়ে caecum-এ পূর্ণতা পায়; egg perianal ত্বকে দেওয়া হয়।

**Q: Trichuris-এর লার্ভা কীভাবে পূর্ণতা পায়?**
...
মনে রাখো: **\"যারা lung যায় না — pinworm আর whipworm\"**।

---

## P145: Mention the mode of transmission and infective form of S. stercoralis. *** (infective form: filariform larva, skin penetration)

> **📌 Hint:** infective form: filariform larva, skin penetration
...
**Q: কোনো intermediate host প্রয়োজন হয় কি?**
→ না — মানুষই definitive host।

**Q: চামড়ার পরে লার্ভার পথ কী?**
...
## P146: What is parthenogenesis? * [female worm directly lay egg without fertilization (adult male worm of SS not found in intestine)]

> **📌 Hint:** female worm directly lays eggs without fertilization; adult male worm of SS not found in intestine

### ✅ Answer

**Parthenogenesis** is a form of reproduction in which the **female produces offspring without fertilization by a male**.
In *S. stercoralis*: adult male worms are **not found in the human intestine** (only parthenogenetic females are present). The female worm lays eggs directly without fertilization, releasing rhabditiform larvae.

### ❓ Cross Questions (from additional)

**Q: পুরুষ কৃমি কি ছোট ও চওড়া?**
→ পুরুষ SS-এর পুরুষ সংক্ষিপ্ত ও চওড়া হয় কিন্তু intestinal wall-এ penetrate করে না — infective নয়।

**Q: ইনটেস্টাইনাল নেমাটোডের মধ্যে parthenogenesis কার?**
→ S. stercoralis-এর — documented।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Parthenogenesis:** এমন প্রজনন পদ্ধতি যেখানে **স্ত্রী পুরুষের ফার্টিলাইজেশন ছাড়াই সন্তান উৎপাদন করে**।
S. stercoralis-এ: প্রাপ্তবয়স্ক পুরুষ কৃমি **মানুষের অন্ত্রে পাওয়া যায় না** — শুধু parthenogenetic স্ত্রী থাকে। স্ত্রী কৃমি সরাসরি egg দেয় (ফার্টিলাইজেশন ছাড়াই), যা থেকে রেবডিটিফর্ম লার্ভা বেরিয়ে আসে।
ভাইভাতে সংজ্ঞা বলো: \"asexual development of female gamete without male fertilization\"।

---

## P147: Write down the differences between occult and classical filariasis. ******* (morphological form of parasites, type of granuloma, Rx and CFT test importance)

> **📌 Hint:** morphological form of parasites, type of granuloma, Rx and CFT test importance

### ✅ Answer

| Point | Classical filariasis | Occult filariasis |
|---|---|---|
| **Cause** | Due to **adult and developing worms** causing lymphatic obstruction | Due to **microfilariae** (hypersensitivity reaction to microfilarial antigens) |
| **Morphological form of parasite** | Adult worms in lymphatics | Microfilariae destroyed in tissues |
| **Basic lesion** | Lymphangitis, lymphadenitis & lymphatic obstruction | **Eosinophilic granuloma** |
| **Organs involved** | Lymphatic vessels & lymph nodes | Lungs, liver, spleen (eosinophilic granuloma) |
| **Microfilaria in blood** | Present in blood (10 pm to 4 am) | Absent in blood; present in tissues |
| **CFT test** | Not so sensitive | **Highly sensitive** |
| **Therapeutic response by DEC** | No / little response (acts on microfilariae, little on adult worm) | **Prompt response** to diethylcarbamazine (DEC) |
| **Serum IgE** | Not so raised | Markedly raised |

### ❓ Cross Questions (from additional)

**Q: Classical filariasis-এর আরেক নাম কী?**
→ Lymphatic filariasis — প্রাপ্তবয়স্ক কৃমি লিম্ফ্যাটিক বাধা দেয়।

**Q: Occult filariasis-কে কোন syndrome বলা হয়?**
→ Meyers-Kouwenaar syndrome — hypersensitivity-এ microfilaria রক্তে ধ্বংস হয়, তাই রক্তে পাওয়া যায় না।

**Q: Occult-এ রক্তবা কেমন থাকে?**
...
| Point | Classical filariasis | Occult filariasis |
|---|---|---|
| কারণ | প্রাপ্তবয়স্ক ও বিকাশমান কৃমি — lymphatic obstruction | Microfilariae-অ্যান্টিজেনে hypersensitivity reaction |
| পরজীবীর রূপ | Adult worm in lymphatics | Tissue-এ microfilariae ধ্বংস হয় |
| মৌলিক ক্ষত | Lymphangitis, lymphadenitis, lymphatic obstruction | **Eosinophilic granuloma** |
| অঙ্গ | লিম্ফ্যাটিক নালি ও নোড | ফুসফুস, লিভার, প্লীহা |
| রক্তে microfilaria | রাতে থাকে (১০ pm–4 am) | রক্তে নাই — টিস্যুতে |
| CFT test | তেমন সংবেদনশীল নয় | **অত্যন্ত সংবেদনশীল** |
| DEC-এর প্রতিক্রিয়া | না/খুব কম | **দ্রুত প্রতিক্রিয়া** |
| Serum IgE | তেমন বাড়ে না | মারাত্মকভাবে বাড়ে |
মূল পার্থক্য: classical = adult worm-এর mechanical block; occult = microfilaria-তে অ্যালার্জি।

---

## P148: Write down the characteristics of occult filariasis. ** (read from differences)

> **📌 Hint:** read from differences

### ✅ Answer

**Occult filariasis** (Meyers-Kouwenaar syndrome) is caused by **hypersensitivity reaction to microfilarial antigens**, not directly by lymphatic involvement. Its characteristics:
1. Microfilariae absent in blood — they are destroyed by the hypersensitivity reaction; present in tissues.
2. Marked eosinophilia — mass eosinophilia (30–80%).
3. Hepatosplenomegaly.
4. Tropical pulmonary eosinophilia / Weingarten's syndrome — low-grade fever, weight loss, dry nocturnal cough, dyspnoea, wheezing.
5. Basic lesion = eosinophilic granuloma (lungs, liver, spleen).
6. CFT highly positive (complement fixation test).
7. Prompt response to DEC.
8. Others: arthritis, glomerulonephritis, thrombophlebitis, tenosynovitis.
Male children and young adults are more commonly affected.

### ❓ Cross Questions (from additional)

**Q: রক্তের CBC-তে কেমন ফল দেখাবে?**
→ Eosinophil count >৩০০০/µL, ৫০,০০০ বা তারও বেশি হতে পারে; ESR উচ্চ।

**Q: বুকের X-ray কী দেখায়?**
→ Diffuse mottled shadows — miliary tuberculosis-এর মতো।

**Q: Serology কী দেখায়?**
→ উচ্চ IgE এবং ফাইলারিয়াল antibody; tissue biopsy-তে granuloma দেখা যেতে পারে।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Occult filariasis** (Meyers-Kouwenaar syndrome) — microfilarial antigen-এ hypersensitivity-জনিত রোগ, lymphatic involvement নয়। বৈশিষ্ট্যগুলো:
1. রক্তে microfilaria নাই — hypersensitivity-এ ধ্বংস হয়ে যায়; টিস্যুতে থাকে।
2. Marocd eosinophilia (৩০–৮০%)।
3. Hepatosplenomegaly।
4. Tropical pulmonary eosinophilia (Weingarten's syndrome) — নিম্ন-গ্রেড জ্বর, ওজন হ্রাস, শুকনা রাতের কাশি, dyspnoea, wheezing।
5. মৌলিক ক্ষত = eosinophilic granuloma (ফুসফুস, লিভার, প্লীহা)।
6. CFT অত্যন্ত positive (complement fixation test)।
7. DEC-এ দ্রুত প্রতিক্রিয়া।
8. অন্যান্য: arthritis, glomerulonephritis, thrombophlebitis, tenosynovitis।
পুরুষ শিশু ও তরুণদের বেশি আক্রান্ত হয়।

---

## P149: State the pathogenesis of filariasis. **

> **📌 Hint:** (none)

### ✅ Answer

**Filariasis** occurs in two forms based on pathogenesis:
**1. Classical (lymphatic) filariasis** — due to blockage of lymph vessels and lymph nodes by **adult worms**:
...
**2. Occult filariasis** — due to **hypersensitivity reaction to microfilarial antigens**, not lymphatic involvement; microfilariae are destroyed in tissues producing eosinophilic granuloma.

### ❓ Cross Questions (from additional)

**Q: Classical filariasis-এ acute ও chronic অবস্থার কী কী হয়?**
...
**Q: Elephantiasis-এর বিশেষত্ব কী?**
...
**১. Classical (lymphatic) filariasis** — প্রাপ্তবয়স্ক কৃমি লিম্ফ নালি/নোড ব্লক করে:
...
**২. Occult filariasis** — microfilarial antigen-এ hypersensitivity; microfilaria টিস্যুতে ধ্বংস হয়ে eosinophilic granuloma।
মূল পয়েন্ট: classical = mechanical block; occult = allergic reaction।

---

## P150: State the laboratory diagnosis of filariasis. ****
...
1. Specimen collection: peripheral blood (first choice), chylous urine, exudate of lymph varix, hydrocele fluid.
2. Microscopical examination — search for microfilariae (sheathed, nuclei not extending up to tail tip):
...
3. Isolation & identification: not done.
4. Immunological tests:
  - Antigen detection: ELISA, ICT.
  - Antibody detection: ELISA, CFT.
5. Molecular test: PCR.
6. Others: CBC (eosinophilia), serum IgE, intradermal test, lymph node biopsy, X-ray (calcified adult worm), USG of scrotum, xenodiagnosis (mosquitoes feed on patient, dissected after 4–6 days to demonstrate microfilariae).

### ❓ Cross Questions (from additional)

**Q: Classical filariasis-এ রক্ত কখন নিতে হয়?**
→ রাতে (১০ pm–4 am) — nocturnal periodicity-এর কারণে।

**Q: CFT কখন বিশেষভাবে সংবেদনশীল?**
...
1. নমুনা: peripheral blood (প্রথম পছন্দ), chylous urine, lymph varix-এর exudate, hydrocele fluid।
2. Microscopy — microfilaria খোঁজা (sheathed, nuclei tail tip পর্যন্ত যায় না):
...
3. Isolation & identification: করা হয় না।
4. Immunological test:
  - Antigen detection: ELISA, ICT।
  - Antibody detection: ELISA, CFT।
5. Molecular test: PCR।
6. অন্যান্য: CBC (eosinophilia), serum IgE, intradermal test, lymph node biopsy, X-ray (calcified adult worm), USG of scrotum, xenodiagnosis (mosquito রোগীকে কামড়ায়, ৪–৬ দিন পর dissect করে microfilaria দেখানো)।
মূল কথা — nocturnal periodicity, তাই রাতেই sample নিতে হবে।

---

## P151: Mention some conditions when microfilariae are not found in blood. ***** (occult filariasis, classical filariasis with some condition such as elephantiasis and wrong time of blood collection due to nocturnal periodicity)

> **📌 Hint:** occult filariasis, classical filariasis with some condition such as elephantiasis and wrong time of blood collection due to nocturnal periodicity

### ✅ Answer

Microfilariae are **not found in blood** in the following conditions:
1. Occult filariasis — microfilariae are destroyed in tissues due to hypersensitivity reaction, so they are absent from blood.
2. Classical filariasis in advanced chronic stage (e.g. elephantiasis) — microfilariaemia may be absent as lymphatic obstruction prevents microfilariae from reaching the peripheral circulation.
3. Wrong time of blood collection — due to nocturnal periodicity, microfilariae are only found at night (10 pm–4 am); collecting blood during daytime gives a negative result.
4. After treatment / in early prepatent period before microfilariae appear.

### ❓ Cross Questions (from additional)

**Q: রক্তে না থাকলে microfilaria কোথায় থাকে?**
→ ফুসফুসের capillaries (সবচেয়ে বেশি), কিডনি, হৃৎপিণ্ড ও বড় রক্তনালির capillaries-এ।

**Q: দিনে microfilaria-কে রক্তে দেখার উপায় কী?**
...
1. Occult filariasis — hypersensitivity-তে microfilaria টিস্যুতে ধ্বংস হয়ে যায়, তাই রক্তে নাই।
2. Classical filariasis-এর অগ্রবর্তী chronic পর্যায় (যেমন elephantiasis) — lymphatic obstruction-এর কারণে microfilaria peripheral circulation-এ পৌঁছায় না।
3. ভুল সময়ে রক্ত সংগ্রহ — nocturnal periodicity-র কারণে ১০ pm–4 am ছাড়া microfilaria রক্তে আসে না; দিনে নিলে result negative।
4. চিকিৎসার পরে / prepatent period-এ microfilaria এখনো বের হয়নি।
মনে রাখো — ফুসফুসের capillary হলো microfilaria-র প্রধান \"hiding place\"।

---

## P152: Mention the mode of transmission and infective form of W. bancrofti. ****
...
## P153: What is periodicity or nocturnal periodicity? *** (microfilariae found at 10pm to 4 am)

> **📌 Hint:** microfilariae found at 10pm to 4 am

### ✅ Answer

**Periodicity** is the time when most of the microfilariae are found in the **peripheral blood**.
**Nocturnal periodicity** = microfilariae appear in the peripheral blood in large numbers **only at night, between 10 pm and 4 am**, and disappear during the day (they hide in deep capillaries of lungs, kidneys, heart, great vessels).
...
**Q: Periodicity-র কারণ কী?**
→ Vector-এর কামড়ানোর অভ্যাস (Culex রাতে কামড়ায়), হোস্টের ঘুমের প্যাটার্ন, পরিবেশ/তাপমাত্রা।

**Q: Peripheral blood-এ না থাকলে তারা কোথায় থাকে?**
→ ফুসফুসের capillaries (সবচেয়ে বেশি), কিডনি, হৃৎপিণ্ড, বড় রক্তনালি।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Periodicity** = peripheral blood-এ microfilaria কখন সবচেয়ে বেশি পাওয়া যায়, সেই সময়।
**Nocturnal periodicity** = microfilaria **রাত ১০টা–সকাল ৪টা** পর্যন্ত peripheral blood-এ বড় সংখ্যায় থাকে, দিনে অদৃশ্য (তারা ফুসফুস, কিডনি, হৃৎপিণ্ড, বড় রক্তনালির গভীর capillaries-এ লুকিয়ে থাকে)।
...
## P154: What do you mean by provocation test? ****** (DEC is given, that induces microfilariae to appear in peripheral blood even during day time)

> **📌 Hint:** DEC is given, that induces microfilariae to appear in peripheral blood even during day time

### ✅ Answer

**Provocation test (DEC provocation test):** a dose of **diethylcarbamazine (DEC)** is given to the patient, which **induces the microfilariae to appear in the peripheral blood even during the daytime**. Blood is then collected and examined for microfilariae.
...
**Q: কেন এই পরীক্ষা দরকার?**
→ Nocturnal periodicity-র সীমাবদ্ধতা কাটাতে — দিনে নেওয়া রক্তেও microfilaria দেখা যায়।

**Q: DEC কি শুধু পরীক্ষার জন্যই?**
→ না — DEC চিকিৎসাও (বিশেষত occult filariasis-এ কার্যকর)।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Provocation test (DEC provocation test):** রোগীকে এক ডোজ **diethylcarbamazine (DEC)** দেওয়া হয়, যা microfilaria-কে **দিনের বেলায়ও peripheral blood-এ আসতে বাধ্য করে**। এরপর রক্ত নিয়ে microfilaria খোঁজা হয়।
...
## P155: What is chyluria? ** [chyle (milky lymph+ fat) in urine].

> **📌 Hint:** chyle (milky lymph + fat) in urine

### ✅ Answer

**Chyluria** is the presence of **chyle (milky lymph mixed with fat)** in the **urine**, giving it a milky white appearance.
It occurs due to **lymphorrhagia** — rupture/leakage of lymph vessels (in chronic classical filariasis) allowing chyle to drain into the urinary tract.
...
**Q: Chylous urine কোন নির্ণয়ে নমুনা?**
→ Filariasis-এর নমুনা হিসাবে — chylous urine পরীক্ষা করা হয়।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

**Chyluria** = মূত্রে **chyle (milky lymph + fat)** থাকা — ফলে মূত্র দুধের মতো সাদা দেখায়।
এটি **lymphorrhagia**-র কারণে হয় — chronic classical filariasis-এ lymph vessel ফেটে/ঝরে chyle মূত্রনালীতে গড়িয়ে পড়ে।
সংজ্ঞা সহজ রাখো — \"milky urine containing chyle\"।

---

## P156: Write down the mode of transmission & diseases produced by Loa loa, O. volvulus, D. medinensis? ***(O. volvulus by black flies: river blindness; Loa loa by deer or mango flies: lesion in eye; D. medinensis by intermediate host cyclops: pruritus in dracunculiasis)

> **📌 Hint:** O. volvulus by black flies: river blindness; Loa loa by deer or mango flies: lesion in eye; D. medinensis by intermediate host cyclops: pruritus in dracunculiasis

### ✅ Answer

| Parasite | Mode of transmission | Disease produced |
|---|---|---|
| ***Loa loa*** (African eye worm) | Bite of **deer fly / mango fly** (Chrysops) | **Loiasis** — lesion in eye (and subcutaneous tissue), Calabar swelling |
| ***Onchocerca volvulus*** | Bite of **black fly** (Simulium) | **Onchocerciasis / river blindness** |
| ***Dracunculus medinensis*** | Ingestion of infected intermediate host **Cyclops** (copepod) in drinking water | **Dracunculiasis** — pruritus/intense itching, skin ulcer |
Notes: Loa loa microfilariae show **diurnal periodicity** (day time). Onchocerca causes blindness — it is the **second major cause of blindness worldwide**; black flies breed in fast-flowing rivers, hence "river blindness". D. medinensis is the "Guinea worm" — Dracunculiasis (guinea worm disease).

### ❓ Cross Questions (from additional)

**Q: Loa loa-এর microfilaria কোন periodicity দেখায়?**
→ Diurnal periodicity — দিনের বেলা রক্তে পাওয়া যায়।

**Q: O. volvulus-এর microfilaria কোথায় পাওয়া যায়?**
→ চামড়া ও চোখে (unsheathed, non-periodic) — নির্ণয় skin snip দিয়ে।

**Q: D. medinensis-এর infective form কী?**
→ Cyclops-এর মধ্যে third-stage larva; প্রাপ্তবয়স্ক স্ত্রী ও larvae ত্বকের আলসারে। X-ray-তে মৃত কৃমি দেখা যায়।

**Q: Onchocerca-র চোখের ক্ষত কী কী?**
→ Conjunctivitis, punctate/sclerosing keratitis, iridocyclitis, optic atrophy।


### 🗣️ ভাইভায় যেভাবে বুঝাব (বাংলা লিপি)

মনে রাখার মnemonic: **\"Loa = eye/mango fly, Onchocerca = river/black fly, Dracunculus = Cyclops water\"**।
**Loa loa** (African eye worm) — deer/mango fly (**Chrysops**) এর কামড়ে → Loiasis — চোখে lesion ও subcutaneous tissue-এ Calabar swelling। Microfilaria diurnal (দিনে)।
**O. volvulus** — black fly (**Simulium**) এর কামড়ে → Onchocerciasis / **river blindness**। বিশ্বে অন্ধত্বের দ্বিতীয় প্রধান কারণ। Black fly দ্রুত প্রবাহিত নদীতে জন্মায় — তাই \"river blindness\"।
**D. medinensis** — Guinea worm — দূষিত পানিতে থাকা **Cyclops** (copepod) খেয়ে → Dracunculiasis — pruritus/প্রচণ্ড চুলকানিসহ ত্বকের আলসার।
এই টেবিলটা ভাইভায় লেখো — প্রতিটি parasite-এর vector আর disease।

---

## P157: You should know the common or another name of important parasites (especially metazoa): Beef tapeworm (T. saginata), pork tapeworm (T. solium), armed tapeworm (T. solium), 7 tapeworm (T. saginata), dog tapeworm (E. granulosus), fish tapeworm (D. latum), old world (AD) and new world hook worm (N. americanus), round worm or giant round worm (AL), small round worm or military worm (SS), pinworm or seat worm or thread worm (EV), whipworm (TT), lungs flukes (P. westermani), liver flukes (F. hepatica, C. sinensis), intestinal flukes (F. buski, G. hominis), blood flukes (S. haematobium, S. mansoni, S. japonicum).

> **📌 Hint:** common / other names of important parasites (especially metazoa)

### ✅ Answer

| Parasite | Common / other name |
|---|---|
| *Taenia saginata* | Beef tapeworm / Unarmed tapeworm |
| *Taenia solium* | Pork tapeworm / Armed tapeworm |
| *Echinococcus granulosus* | Dog tapeworm |
| *Diphyllobothrium latum* | Fish tapeworm |
| *Ancylostoma duodenale* | Old World hookworm |
| *Necator americanus* | New World hookworm |
| *Ascaris lumbricoides* | Round worm / Giant round worm |
| *Strongyloides stercoralis* | Small round worm / Military worm |
| *Enterobius vermicularis* | Pinworm / Seat worm / Thread worm |
| *Trichuris trichiura* | Whipworm |
| *Paragonimus westermani* | Lung fluke |
| *Fasciola hepatica, Clonorchis sinensis* | Liver flukes |
| *Fasciolopsis buski, Gastrodiscoides hominis* | Intestinal flukes |
| *Schistosoma haematobium, S. mansoni, S. japonicum* | Blood flukes |

### ❓ Cross Questions (from additional)

**Q: T. saginata কেন \"unarmed\"?**
→ এর scolex-এ hooklet নেই; T. solium-এ hooklet আছে তাই \"armed\"।

**Q: SS-কে কেন \"military worm\" বলা হয়?**
→ ফরাসি সৈন্যদের মলে প্রথম পাওয়া গিয়েছিল বলে।

**Q: Loa loa, D. medinensis, W. bancrofti-র অন্য নাম কী?**
...
| A. lumbricoides | Round worm / Giant round worm |
| S. stercoralis | Small round worm / Military worm |
| E. vermicularis | Pinworm / Seat worm / Thread worm |
| T. trichiura | Whipworm |
| P. westermani | Lung fluke |
| F. hepatica, C. sinensis | Liver flukes |
| F. buski, G. hominis | Intestinal flukes |
| S. haematobium, S. mansoni, S. japonicum | Blood flukes |
অতিরিক্ত: Loa loa = African eye worm; D. medinensis = Guinea worm; W. bancrofti = filarial worm।

---

## P158: Why freshly passed stool of worm infected patient cannot infect another host? ** (for molting of worm, soil is needed).

> **📌 Hint:** for molting of worm, soil is needed

### ✅ Answer

Freshly passed stool of a worm-infected patient **cannot infect another host** because the eggs/larvae passed are **not infective at the time of passage**.
...
**Q: উদাহরণ দাও — কার infective filariform larva মাটিতে বিকশিত হয়?**
...
সদ্য পাস করা মল অন্য কাউকে সংক্রমিত করতে পারে না — কারণ সেই সময়ে ডিম্ব/লার্ভা **infective নয়**।
...
## P159: Why parasitic (helmintihic diseases) are uncommon in Bangladesh now? *** (cause: safe drinking water, safe sanitation: open space defecation reduced, deworming programed in school)

> **📌 Hint:** safe drinking water, safe sanitation: open space defecation reduced, deworming programed in school

### ✅ Answer

Helminthic (parasitic) diseases have become **uncommon in Bangladesh** nowadays due to:
1. Safe drinking water — reduced water-borne transmission.
2. Safe sanitation — open-space defecation reduced, breaking the faecal-oral / soil-transmitted cycle.
3. Deworming programmes in schools — mass deworming reduces worm burden and reservoir.
4. Improved health awareness, hygiene and public health measures.

### ❓ Cross Questions (from additional)

**Q: কীভাবে soil-transmitted helminth-এর cycle ভাঙে?**
→ Infective form মাটিতে বিকশিত হওয়ায় — open defecation বন্ধ ও safe sanitation-এ cycle ভেঙে যায়।

**Q: আর কী কারণ পরোক্ষভাবে ভূমিকা রাখে?**
...
1. নিরাপদ পানীয় জল — পানিবাহিত সংক্রমণ কমেছে।
2. নিরাপদ স্যানিটেশন — খোলা মলত্যাগ হ্রাস পেয়েছে, ফলে faecal-oral / soil-transmitted cycle ভেঙে গেছে।
3. স্কুলে deworming programme — mass deworming-এ worm burden ও reservoir কমেছে।
4. স্বাস্থ্য সচেতনতা, স্বাস্থ্যবিধি ও public health ব্যবস্থার উন্নতি।
