...
> Full conversion of `Chapter-24_Research.md`.
...
knowledge undertaken to establish facts of principle.
Or, Research can be defined as the search for knowledge or as any systematic investigation to establish facts,
Types of research:
a) Main types: .
1) Basic research: Which is necessary to generate new knowledge and technology to deal with many
unsolved health problems.
2) Applied research: Which is necessa
programmes that will deliver greater health benefit, making optima’
- Action research/ operational research
- Simple applied research
b) May also be grouped according to approaches:
I. Biomedical research
Il. Social research
c. Research may also be:
...
studies.
2. Specific objectives: Every research work involves several task. It is statements that tell about each task
...
2) - Gathering information and knowledge about the problem and finding the gaps in knowledge.
3) Formulation of research hypothesis.
4) Statement of objectives of research:
  - General objective — ultimate goal
  - Specific objective which have to be done for ultimate goal.
5) Planning of research: Sample size, population, sample, sampling unit, sample frame.
6) Selection of research design and methodology.
7) Data collection:
  - Observation
  - » Asking question
  - Measurement or counting
  - Any combination of above 3.
8) Data analysis, interpretation of finding and drawing of inference.
9) Writing research report
10) Publication or presentation in seminar.
Problem identification
Information gathering Further hypothesis
Hypothesis formulation
ae Confirmation or resection of hypothesis
Data collection
Data processing
...
YA form with no question or ‘Pro forma’
Check -list (only observation)
Questionnaire
Pre testing
Descriptions: ; /
1) A form with no question: We fill in different types of forms in our every life . Here only few
points for recording particular information are printed. Example — Admission form.
2)
3)
4)
</details>
...
sought. It is the most type of research instrument.
Pre-testing: After developing a questionnaire before finalizing it, the questionnaire should be tried
out in a small number of people similar to the work where the study will be taken.
Steps of protocol writing:
1)
2)
3)
4)
