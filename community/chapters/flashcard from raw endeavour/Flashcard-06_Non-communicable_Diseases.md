# 06 Non-communicable Diseases

> 🎴 **Flashcard version** — click / tap any question below to reveal its answer.
> Full conversion of `Chapter-06_Non-communicable_Diseases.md`.
...
health coverage and better education has resulted in demographic shift with an increasing proportion of adults
and elderly persons. This is in tern contributes to the increase in the relative burden of non-communicable q
diseases. The main factors are — |
1) Rapid change of food habit, life-style and behavioural pattern of the people.
2) Increasing proportion of adults and elderly persons.
[Ref- Rashid, Khabir, Hyder / 4" /274]
e risk factors [SUST-15Ju/J,11J] / common risk factors [DU-11Ju, SUST-16M] of
portant non-communicable diseases (NCDs).
Mention about the modifiable risk factors for NCDs. [CU-11J]
Risk factors of non-communicable diseases:
1) Cigarette use and other forms of smoking.
2) Alcohol abuse.
3) Failure or inability to obtain preventive health services (e.g. hypertension control, cancer detection,
management of diabetes).
4) Life style changes (e.g. dietary patterns, physical activity).
5) Environmental risk factors (e.g. occupational hazards, air & water pollution, and procession of
destructive weapons).
6) Stress factors. of
[Ref- Park /24" / 381] ;
1) Absence of a known agent:
  - Whereas in some chronic diseases the cause is known (e.g., silica in silicosis, asbestos in
mesothelioma).
  - For many chronic diseases the causative agent is not known.
  - The absence of a known agent makes both diagnosis and specific prevention difficult. |
2) Multifactorial causation:
  - Most chronic diseases are the result of multiple causes.
  - Chronic diseases appear to result from the cumulative effects of multiple risk factors.
  - These factors may be both environmental and behavioral or constitutional.
3) Long latent period:
  - Natural history of chronic disease is the long latent (or incubation) period between the first
exposure to "suspected cause" and the eventual development of disease (e.g., cervical
cancer).
  - This makes it difficult to link suspected causes (antecedent events) with outcomes, ¢.g., the
possible relation between oval contraceptives and the occurrence of cervical cancer.
  - Examples include hypertension, diabetes, stroke, etc.
4) Indefinite onset:
  - Most chronic diseases are slow in onset and development, and the distinction between
...
ge that they are
/ The preventive attack of chronic non-communicable diseases is based on the knowled hat they are
ultifactorial in causation, so their prevention demands a complex mix of interventions. With the identification
of risk factors, health promotion activities aimed at primary prevention are being inc'easingly applied in the
control of chronic dieseases (e.g. elimination or reduction of risk factors, modification of lifestyle patterns).
Present knowledge indicates that non communicable disease can be prevented through —
1) Screening and health examination technique.
2) Application of improved method of diagnosis.
3) Treatment and rehabilitation.
4) Control of food, water and air pollution.
5) Reducing accidents.
6) Influencing patterns of human behaviour and life sty
7) Upgrading standard of institutional care.
8) Developing and applying better methods of compre
care. Political approaches are also needed as in the case o
drug abuse.
...
les through intensive education.
hensive medical care including primary health
f smoking control, control of alcohol &
efine coronary heart disease (CHD).
nsWer
Coronary heart disease (CHD):
Coronary heart disease (ischemic heart disease) has been defined as “impairment of heart function due
to inadequate blood flow to the heart compared to its needs, caused by obstructive changes in the coronary
circulation to the heart”.
It is the commonest cause of cardiovascular disability & death. It i i
‘ hits : . It is th -309 ths in
most industrialized countries of which 30% dies within 30 aes err
[Ref- Park / 24" / 385]
GaMenii the pathophysiology of coronary heart disease (CHD).
Pathophysiology of CHD:
  - Abnormal lipid metabolism.
» Excessive intake of cholesterol and saturated fat.
» Atherosclerotic process initially fatty streaks.
Subendothelial accumulation of lipid.
LDLs undergo in situ oxidation making them more difficult to mobilize & locally cytotoxic.
...
2) Loss of life expectancy: It is the average gain in life expectation that would follow a complete
elimination of all cardiovascutar deaths if another mortality rates remain unchanged.
3) CHD incidence rate: This is the some of fatal and non-fatal attack rates.
4) Age specific death rates: It suggests a true increase in incidence.
5) Prevalence rate: the prevalence of CHD can be estimated from cross-sectional surveys using ECG
for evidence of infarction and history of prolonged chest pain.
6) Case fatality rate: This is defined as the proportion of attacks that are fatal within 28 days of
onset.
7) Measurement of risk factor levels: This includes measurement of levels of cigarette smoking,
blood pressure, alcohol consumption and serum cholesterol in the community.
Medicalares Measurement of levels of medical care in the community are also pertinent.
[Ref- Park / 24" / 385]
B) Modifiable factors . iv \
Cigarette smoking
High blood pressure (Hypertension)
Elevated serum cholesterol (Hyperlipidaemia)
...
swer
Preventive measures of CHD: For the prevention of CHD, an expert committee of WHO recommended the
following strategies —
> Primary prevention: It involves application of measures to modify the risk factors in the absence of
clinical manifestation of the disease. Primary prevention includes —
A) Population strategy:
1) Prevention in whole populations: This strategy should be based on mass approach
focusing mainly on the control underlying cause / risk factors in whole population. This
Strategy centers round the following key areas:
a) Dietary changes:
  - Reduction of fat intake
  - Limitation of saturated fat intake
  - Reduction of cholesterol below 100 mg per 1000 K cal per day.
  - Complex CHO intake
  - Avoidance of Alcohol.
b) Prevention of smoking: by -
en
  - Encouraging
  - Effective information to the whole population.
  - Health education
  - Fiscal measures
  - Legislation.
c) Maintenance blood pressure within normal values in respect of age of sex.
d) Regular physical activity.
2) Primordial prevention in whole population: It involves preventing the emergence &
ve not yet appeared or become endemic.
spread of CHD risk factors & life styles that ha’
B) High risk strategy:
1) Identify the risk by estimation of serum cholesterol.
2) Specific advice e.g. treatment of HTN, avoidance of smoking.
Secondary prevention: It involves measures put into practice after the disease has been apparent so as
to prevent recurrence, delay progress & effectively hinder complications. It involves —
...
(type-1 personality) are acquired life style, which are import risk factor for development of CHD.
  - Prevention of development of this risk factor can be easily done from early child hood. Because this
is the time when life style are formed.
...
Stage 3 (Severe) > 180
[Ref- Park /24" /391]
ac Ssify hypertension. :
Q« ion the causes of hypertension.
Classification of hypertension:
1) Primary/ idiopathic/ essential hypertension: No specific underlying cause is known and comprises
more than 90% of all hypertensive patients.
ae aeRRMERNE 7777777707777 ae
2) Secondary hypertension: underlying cause can be detected and comprises less than 10% of all j
hypertensive patients. Important causes of secondary hypertension are- |
a) Renal diseases:
...
d) Pregnancy.
e) Drugs:
  - Oestrogen containing oral pill.
  - Anabolic steroids.
  - NSAIDs,
...
uss briefly the non-modifiable risk factors for hypertension. [DU-10Ju]
h
A) Non-modifiable / fixed factors:
1) Age: blood pressure rises with age in both sexes.
2) Genetic factors: The evidence of genetic factors is based on twin & family studies the BP
value of monozygotic are usually more than those of zygotic twins.
3) Family history: Family studies confirmed that the children of normotensive parents have
3% possibility of developing HTN whereas this possibility is 45% in children of two
...
_ 7) Other factors: OCP, noise, vibration, temperature, humidity.
Is “ wed halves”?
nsion is an iceberg disease’- explain it by describing rule of halves, [RU-14Ju]
[Ref- Park / 24" /393]
Rule of halves:
Hypertension is an ‘iceberg’ disease. Only about half of the people in the general population of most
developed countries are hypertensive. Half of them are aware of the condition, half of them are being treated,
and only about half of those treated were considered adequately treated. It is known as “Rules of halves”.
[Ref- Park / 24" / 392]
The number-wise representation in
the areas of the circle shown in the
...
over a period of years from early childhood into adult life, then
those individuals whose pressures were initially high in the
distribution, would probably continue in the same “track” as
adults.
Blood pressure
In other words, low blood pressure levels tend to remain
ecome higher as individuals grow
low and high levels tend to b
older. This phenomenon of persistence of rank order of blood ——
pressure has been described as “tracking”.
This knowledge can be applied as identifying children and FT
adolescents “at risk" of developing hypertension as a future date.
Time
...
**Prevéntion of HTN:**
4 1. Prima revention:
a. Population strategy: This involves a multifactorial approach, based on the following
...
3) Hypertensive renal disease:
  - Renal failure
  - Nephrosclerosis
4) Atherosclerotic complication:
...
ee is stroke? What are the common syndromes of stroke?
wi 4
er
troke:
WHO defined stroke as “rapidly developed clinical signs of focal (or global) disturbance of cerebral
function; lasting more than 24 hours or leading to death, with no apparent cause other than vascular origin”.
Syndromes of stroke;
1) Ischaemic stroke:
  - Lacunar infarct
...
1) Hypertension.
2) Other factors-
  - Cardiac abnormalities e.g. atrial fibrillation, valvular heart disease, left ventricular
hypertrophy, cardiac dilatation.
_ Diabetes mellitus.
...
,
a [Ref- Park / 24" /,396] j
the control measures for stroke. |
trol of arterial hypertension.
ay Early detection and treatment of transient ischaemio-attack (TIA).
A) _Control of diabetes.
; 4) Elimination of smoking.
/) Prevention and management of other risk factors.
6)_Treatment of acute stroke to control complications.
_7) Facilities for the long-term follow up of patients are essential.
...
c) Host and environmental factors of rheumatic fever: -15 years).
1) Age: RF is typically a disease of childhood and adolescence (5-15 years)
2) Sex: The disease affects both sexes equally. . socuccal
3) Immunity: According to the immunological hypothesis- group bias lige
have certain toxic products and components of the ra cece yesh na attack of an
antigenic cross-relationship, leading to immunological proce: overcrowding, poor
4) Socioeconomic status: RF is a social disease linked to poverty, ”
...
7) Inadequate expertise of health care-care providers, 14
8) A low level of awareness of the disease. ‘ 1}
[Ref- Park / 24" / 398 + Rashid, Khabir, Hyder / 5/301] i
ou prevent Rheumatic fever / rheumatic heart disease? [RU-12Ju]
Prevention of rheumatic heart disease (RHD): |
~ Primary prevention: (|
1) Improvement of environment, housing & nutritional status. 1
2) Prophylactic antibiotic in sore throat: Phenoxymethyl penicillin 250mg 6 hourly (10 days).
Secondary prevention: Prophylactic antibiotic to prevent further attack:
Benzathine penicillin 1.2 million units (6 lakh in < 30 kg) IM once monthly
Or,
Oral phenoxymethyl penicillin 250 mg 12 hourly
- Itshould be continued for at least 5 years after last attack or upto the age of 18 years which one
is longer.
- If carditis (mild mitral regurgitation or healed carditis) is present prophylaxis is continued at
least 10 years after the last attack or upto 25 years of age, whichever is longer.
- More severe valvular disease or post-valve surgery cases need lifelong treatment. i
...
3) Improving socio-economic conditions. |
  - Evaluation: In the evaluation of the programme, the prevalence of RHD in school children from
periodic surveys of random samples is probably the best indicator.
[Ref- Park / 24" / 398]
Essential to know
» Concept of prophylaxis of rheumatic fever varies between Park & text books of medicine: |
According to different text books of medicine, prophylaxis of rheumatic fever should be —
- It should be continued for at least 5 years after last attack or upto the age of 21 years, which one
is longer.
- If carditis is present, prophylaxis should be given for at least 10 years from the last attack or |
upto 40 years of age, whichever is longer. (an opinion)
...
**Cancer:** Cancer may be regarded as a group of diseases characterized by-
  ...
  - The eventual death of the affected patient if the tumor has progressed beyond that stage when it can
...
mouth, esophagus, intestines, uterus) and from the skin epithelium.
2) Sarcomas: Arising from mesodermal cells constituting the various connective tissues (e.g. fibrous
tissue, fat, and bone).
...
1) Tobacco: Cancer of the lung, larynx, mouth, pharynx, esophagus, bladder, pancreas, and
probably kidney.
2) Alcohol: Esophageal, liver and rectal cancers.
3) Dietary factors: Smoked fish is related to stomach cancer, dietary fiber to intestinal cancer,
beef consumption to bowel cancer and a high fat diet to breast cancer.
4) Occupational exposures: Exposure to benzene, arsenic, cadmium, chromium, vinyl chloride,
...
8) Others: Sunlight, radiation, air and water pollution, medications (e.g. estrogen) and pesticides ]
D |
...
M, CU-14J, 13Ju] :
swel i
Most comnion cancers (in order of frequency) in both males and females in Bangladesh: i!
...
[Ref- Rashid, Khabir, Hyder f4™ /289]
...
life style as a determinant of cancer. [DU-17M, 15Ju,12Ju]
Life style as a determinant of cancer: |
  - Tobacco: Cancer of the lung, larynx, mouth, pharynx, esophagus, bladder, pancreas, and probably |
kidney.
...
b) Mechanical irritation: e.g. chronic irritation and trauma to the cervix-uteri from multiple child birth |
and chronic cervicitis may lead to cancer of the cervix.
c) Chemical agents: e.g. dye workers — bladder cancer, asbestos workers — lung cancer.
d) Viral and parasitic agents: |
- Viruses: |
- Hepatitis B & C: Hepatocellular carcinoma.
- HV infection: Kaposi’s sarcoma, non-Hodgkin’s lymphoma. ;
- Epstein-Barr virus (EBV): Burkitt's lymphoma and nasopharyngeal carcinoma.
i el ee NEES
- Cytomegalovirus (CMV): Kaposi’s sarcoma.
Human papilloma virus (HPV): Cancer of cervix.
...
competent physician, with a view to detect early cancers, Laboratory tests may also be carried out as indicated.
While a complete medical history may provide symptoms of a localized or generalized cancer, a thorough
pee _ is likely to reveal cancers of the skin, mouth, thyroid, breast, uterus, vagina, rectum, penis
and testicle.
Investigations for cancer screening:
1) A chest or other X-ray, as indicated, could provide evidence of lesions in the chest, pleura, lungs, and
bone.
2) A blood count (CBC) not infrequently provides the initial findings of leukaemias, multiple myelomas,
or other blood dyscrasias. Blood biochemistry provides proof of liver and kidney damage.
...
win i i ‘ |
slid Y ing poration a ig elderly (due to improvement of health services and health Status) at
2) Exposure to industrial toxic agents. |
3) Lifestyle changes as-
Cigarette smoking / tobacco habit.
- Use of alcohol. i
- Consumption of larger amounts of fatty food and.
- Less intake of fiber-containing food.
4) Lack of awareness about vaccination (e.g. hepatitis B, Ca cervix) and screening of cancer (self-
...
» Secondary prevention: H
1)
1) Cancer registration.
2) Early diagnosis:
  - By observation (skin, mouth, external genitalia, cervix). Pa |
...
now possible to control these factors in the general population as well as in particular occupational groups.
Example:
1) Control of tobacco: Reduces incidence of lung cancers and other cancers related to tobacco
consumption.
2) Personal hygiene: Improved personal hygiene reduces ¢
3) Occupational exposure: If proper measures are taken to protect the person
carcinogens related to occupation, the incidence of cancers will be reduced.
...
incidence of lung cancer will be reduced.
6) Air pollution: If air pollution is controlled properly,
7) Legislation.
8) C ducation.
) Cancer education. [Ref- Park /24" / 404]
1
ertain type of cancers e.g. Ca cervix. |
s from exposure to
~\
MCQ), VIVA & OSPF
...
11. HPV infection (papilloma virus).
12. Immunocompromization.
13. Pre-malignant condition e.g. CIN.
[Ref- Park /24" / 407+ Rashid, Khabir, Hyder / 4" /290]
can you control cervical cancer in a rural setting? [DU-12J]
evention and control of cervical cancer: :
a) Primary prevention: Until the causative factors are more clearly understood, there is no prospect of
primary prevention of the disease, Improved personal hygiene and birth control play important role in
prevention of Ca cervix.
b) Secondary prevention:
© Cancer registration.
- Early detection of cases through screening.
- Early treatment by radical Surgery and radiotherapy.
[Ref- Park / 24" / 404]
Carcinoma of breast
Pe: te down the risk factors of breast cancer. [RU-18M, 16N]
t wer
Risk factors of Ca breast:
1) Age: The incidence increasing rapidly between the ages of 35 and 50,
2) Family history: The risk is high in those with a Positive family history of breast cancer.
3) Parity: Those whose first pregnancy is delayed to their late thirties are at a high risk than
multiparous women.
4) Age at menarche and menopause: Early menarche and late menopause are established risk
factors.
5) Hormonal factors: Both elevated estrogen as well as Progesterone are important factors in
increasing breast cancer risk.
6) Prior breast biopsy.
7) Diet: Cancer of the breast is linked with a high fat diet and obesity,
8) Socio-economic status: Breast cancer is common in higher socio-
economic groups.
...
2) Promotion of cancer education.
3) Reduction of childhood obesity.
4) Strenuous physical activity.
5) Reduction of fat intake in the diet.
B) Secondary prevention:
1) Early diagnosis,
2) Treatment,
3) Follow-up, ie.
  - To detect recurrence as early as possible.
  - To detect cancer in the opposite breast at an early stage.
...
1) Smoking: Responsible for 90% of lung cancer death.
2) Other factors:
- Air pollution,
- Radioactivity.
® Occupational exposure to asbestos, arsenic and its compounds, chromates etc.
Screening for lung cancer:
1) Chest radiograph.
2) Sputum cytology.
Prevention of lung cancer:
1) Primary prevention: To control the smoking epidemic by-
...
7 1) Tobacco chewing and tobacco smoking.
...
changing lifestyles supported by legislative measures like banning or restricting the sale of tobacco.
2) Secondary prevention:
  - Early diagnosis.
  - Treatment (surgery & radiotherapy).
[Ref- Park / 24" / 406]
Diabetes mellitus
insulin secretion) or relative (reduced insulin action) deficiency of insulin.
Clinical classification of diabetes mellitus (WHO classification):
...
dyslipidaemia, and hypertension, which leads to coronary artery disease and stroke, may result from a genetic
defect producing insulin resistance, with the latter being aggravated by obesity.
[Ref- Park /24"/ 411]
_-<sewn!
wr.
oY Agent: Insulin deficiency.
Host factors:
© Age
Sex
Genetic factors
...
[2yOnset___ | Abruptonset. __—————_—'| Gradual (insidious) onset. ___|
[3)Severity __—_| More severe form if not diagnosed.
4) Fate Becomes lethal if treatment is late. | Slow ketosis and long compatible | -
survival.
HLA relation yet to find.
[Ref- Rashid, Khabir, Hyder /5" /314]
Risk factors for DM:
1) Family history of DM.
2) More diet. a)
3) Less physical activity i.e. sedentary lifestyle. nw
4) Obesity. .
5) Heart disease, valvular disease.
6) Age group 40 years and above.
7) Cataract in relatively early age.
...
Environmental
diabetic insults
Healthy people Impairment of insulin
(Genetic susceptibility) secretion and/or action
...
1) Healthy eating:
  - Carbohydrate: (45-60%, sucrose up to 10%) Recent studies suggest short-term (6
months), very low carbohydrate diets (containing as little as 50g/day-13% of daily energy)
are safe and effective means of reducing weight and improving glycaemic control.
Fat: (< 35% with < 10% as saturated fat & 10 — 20% from monounsaturated fat).
Protein: (10-15%) Should not exceed 1 g/kg body weight/day.
Fruit / vegetables: 5 portions daily.
Salt: Not more than 6g daily. Further restriction of sodium intake (to less than 3 g daily) is
important in treating hypertensive diabetic patients.
2) Weight management: In addition to reducing calorie intake, overweight patients should be
strongly encouraged to take regular exercise, in the form of walking, swimming or cycling, for
approximately 30 minutes daily. (Management of obesity is discussed in ‘Chapter-04’)
3) Diabetic food and sweeteners: Low-calorie and sugar-free drinks and sorbitol containing foods.
4) Alcohol: Alcohol can be consumed in moderation unless there is a coexisting medical problem that
requires abstinence.
[Ref- Davidson /23™]
cute complications:
...
3) Peripheral neuropathy > Sensory loss, motor weakness,
...
[Ref- Davidson /23"]
S the diabetes mellitus control measures. [SUST-16M]
efly discuss the interventions to control type-2 diabetes mellitus. [SUST-17N]
iswer
Prevention and care of diabetes mellitus:
1) Primary prevention:
a. Population strategy:
  - Primordial prevention — prevention of emergence of risk factors in countries in which
they have not yet appeared.
  - Maintenance of normal body weight through adoption of healthy nutritional habits and
physical exercise.
  - The nutritional habits include an adequate protein intake, a high intake of dietary fiber
and avoidance of sweet foods.
  - Elimination of protein deficiency and food toxins.
b. High-risk strategy:
  - Avoidance of sedentary life-style, over-nutrition and obesity.
  - Avoidance of alcohol.
  - Avoidance of diabetogenic drugs such as oral contraceptives.
  - Reduction of factors that promote atherosclerosis e.g. smoking, high blood pressure,
elevated cholesterol and high triglyceride levels.
2) Secondary prevention:
- Adequate treatment of diabetes mellitus.
- Routine checkup of blood sugar, urine for protein and ketone bodies, blood pressure, visual acuity
and weight should be done periodically.
- There should be an estimation of glycosylated haemoglobin at half-yearly intervals.
- Self-care — i.e. the diabetic should take a major responsibility for his own care with medical
guidance.
- Home blood glucose monitoring.
3) Tertiary prevention:
- Organization of specialized clinics (diabetic clinics) and units for detection and management of
complications of diabetes such as blindness, kidney failure, coronary thrombosis, gangrene of
...
Bangladesh.
Role of BIRDEM for prevention and control of diabetes in Bangladesh: oo ;
1) It provides comprehensive diabetic health care, which includes management, diabetic education,
motivation and rehabilitation of patients. .
2) It produces manpower, like diabetologists, nurses, laboratory technicians, social welfare workers, etc.
3) It also provides short term training courses for health personnel of various categories with a view to
incorporate diabetic care at the primary health care level. .
4) Italso provides hospital services specially to deal with the complications of diabetes and runs research
programmes in the field of diabetology.
...
size (hypertrophic obesity) or an increase in fat cell number (hyperplastic obesity) or a combination of both.
[Ref- Park / 24" / 415]
Overweight is usually due to obesity, but can be due to abnormal muscle development or fluid
retention.
Or,
Obesity is defined as a condition where BMI of a person is above 30 (30 — 39.9).
Risk factors:
1. Behavioral:
- Sedentary worker.
...
eecee
2. Genetic factors:
- Melatonin-4 -receptor.
Types:
1. Generalized obesity
2. Abdominal obesity
Complications of obesity / health risk of obese persons:
...
Comment on obesity status:
This obese patient may be suffering from polycystic ovarian syndrome.
Prevention and control of obesity:
1) Primary prevention: Please see above.
2) Secondary prevention: Please see above.
...
1) Diet & nutrition:
  - Less carbohydrate & fat.
  - Adequate protein & water.
  - Plenty of fresh vegetables & fruits.
2) Regular exercise.
3) Reduction of weight in obese person.
4) Cessation of smoking & alcohol abuse.
5) Adequate sleep.
6) Reduction of stress & tension.
7) Social activities.
8) Strict control of comorbidities (e.g. hypertension, diabetes mellitus) & regular physical checkup.
_ naa
Chapter-'
