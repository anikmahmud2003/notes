# 02 Concept of Health and Disease

> 🎴 **Flashcard version** — click / tap any question below to reveal its answer.
> Full conversion of `Chapter-02_Concept_of_Health_and_Disease.md`.
...
Explanation of important dimensions:
% Physical dimension:
% Perfect functioning of the body.
~< Every cell & organ is functioning at optimum capacity.
...
/=- Good appetite.
74 Sound sleep.
  - Regular activity of bowel & bladder.
  - » Smooth, easy & co-ordinated movement.
~~ All the special senses are intact.
- Mental dimension:
- Mental health: “A state of balance between the individual and the surrounding world, a state
of harmony between oneself & others, a co-existence between the realities of the self and that
oe people and that of the environment.”
i
- iteria of a mentally healthy person:
\/ — » ‘Is free from internal conflicts,
Is well adjusted with family and community,
~Aawareness of one’s identity, >
Has a strong sense of self-esteem, _
Knows himself; his needs, problems & goals.
» Has good self-control,__
» Faces problems and tries to solve them intelligently.
hapter-02: Concept of health & disease _1
- Social dimension;
Harmony with other members of society.
Social functioning (social response)
- Spiritual dimension:
- Spiritual health; It refers to that part of the individual, which reaches out and strives for
Meaning & purpose in life. It is the intangible "something" that goes transcends physiology &
Psychology,
- Emotional dim : Mental health can be seen as "Knowing" or "cognition" while emotional health
relates to “feeling”, :
- Vocational dimension; New dimension. Part of human existence, When work is fully adapted to
...
. How can you evaluate physical health? [DU-10Ju]
...
SY Inquiry into use of medical service.
~6) Standardized questionnaires for cardio vascular disease.
_Ty Standardized questionnaires for respiratory disease.
8) Clinical examination.
AY Nutrition and dietary assessment.
...
Answ ,
Positive health:
The state of positive health implies the notion of “perfect functioning” of the body & mind. It
conceptualizes health biologically, psychologically and socially.
A person who enjoys health at three planes i.e. good physical, mental and social well-being is said to be
in a state of positive health.
[Ref- Park / 24" / 16]
For more curiosity:
...
iswer
ellbeing: . on
In point of fact, there is no satisfactory definition of the term well-being”.
Recently psychologists have pointed out that the ‘well-being’ of an individual or group of ieliyiduals
have objective and subjective components. The objective components relate to such concerns as are generally
known by the term “standard of living” or “level of living”. The subjective component of well-being (as
ed b h individual) i to as “quality of life”.
expressed by each individual) is referred to as “quality o [Ref- Park /24" / 16]
Concept of wellbeing:
JA) Standard of living: (objective component) :
It refers to the usual scale of our expenditure, the goods we consume and the services we
enjoy. It includes the level of education, employment status, food, dress, house, amusements and
comforts of moder living.
definition: Income and accupation, standards of housing, sanitation and nutrition, the level
of provision of health, educational, recreational and other services may all be used individually as
Measures of socioeconomic status and collectively as an index of the "standard of living".
DS Level of living: (objective component) It consists of 9 components —
t Health
Food consumption
Education
...
Recreation & leisure
Human rights
C) Quality of life: (subjective component) WHO defined as -
The condition of life resulting from the combination of the effects of the complete range of
factors such as those determining health, happiness (including comfort in the physical environment
and a satisfying occupation), education, social & intellectual attainments, freedom of action, justice _
...
12Ju)
Physical quality of life index / POLI:
" I means physical quality of life index. It is an index for measuring quality of life of a nation.
Components: It consolidates three indicators —
J A‘) Infant mortality.
12) Life expectancy at age one.
F 4) /3)~ Literacy.
f [Ref- Park / 24" /17]
wwe awn
Calculation: For each component, the performance of individual countries is placed on a scale of 0 to 100. ‘0’
represents an absolutely defined ‘worst’ performance and ‘100’ represents an absolutely defined ‘best’
performance. The composite index is calculated by averaging the 3 indicators, giving equal weight to each of
them. The resulting PQLI thus is scaled 0 to 100.
Example: In Bangladesh
a) “> Infant mortality : 57/ 1000/ year
  - Life expectancy at age one : 60 years
  - Literacy 43%
...
(life expectancy at birth), knowledge (adult literacy rate and mean years of schooling) and income (real G'
per capita in purchasing power parity in US dollars).”
...
The spectral concept of health denotes that the health of an individual is not static. It fluctuates within a
range varying from optimum wellbeing to various levels of dysfunction including the state of total dysfunction
(death).
The transition from good health to ill health is often a gradual one and where one step ends and the
other begin as matter of judgment.
The systematic representation of these different levels of health constitutes the health-sickness
spectrum.
a
Positive health. °
Better health.
...
Severe sickness,
Death.
Figure: The health-sickness spectrum.
[Ref- Park /24"/18 + Rashid, Khabir, Hyder /5"/9]
+ The lowest point on the health-disease spectrum is death and the highest point corresponds to the WHO
...
**Deter:**
inants of health:
The factors which influence health, lie both within the individual and externally in the society in which
hg“or she lives, are collectively known as determinants of health.
...
1) Biological determinants: The physical and mental traits of every human being are to some extent
determined by the nature of his genes at the time of conception. A number of diseases are now
known to be genetic origin, e.g. chromosomal anomalies, errors of metabolism, mental retardation,
...
v4 Soil pollution. > Animal. /* Occupation.
  - Heat, light, radiation sound. > Micro-organisms. > Religion.
  - Food, excreta & refuse etc. > Insects, birds. ‘¥ Education.
  - Housing.
4) Socio-economic conditions:
_~ Economic status: A community with a high per capital GNP has a better health status then
one with a low GNP.
” Education: Illiteracy > Poverty > Malnutrition —> Ill health > Tmaternal, child and
_-- infant mortality.
CY Occupation: Employment — Promote health, Unemployment = III health.
¥_ Political system: In absence of strong political commitment, allocation for health
o development is probably the lowest.
5) Health services:
Criteria:
  - Comprehensive health care.
  - Equitable distribution ‘ r
  - Health care must reach periphery
  - Accessible to all :
  - Socially acceptable and affordable.
6) Aging of the population:
- The elderly enjoy better health
- Rapid population aging increase prevalence of chronic illness and disabilities.
...
environments.”
; Human ecology is a subject of more general science of ecology.
A full understanding of health requires that humanity be seen as part of an ecosystem. The human
ecosystem includes in addition to the natural environment all the dimensions of the man-made environment -
physical, chemical, biological, psychological: in short, our culture and all its products. Disease is embedded in
...
health (or disease), while ecology embraces the interrelationship of all living things. In this regards,
epidemiology constitutes a special application of human ecology or that part of ecology relating to the state of
human health.
[Ref- Park /24"/21]
a
Right to Health
...
amily,
The concept of “right to health” has generated so many questions, e.g. right to medicat care, right to
responsibility for health, right to a healthy environment, right to food, right to procreate, right not to procreate
(family Planning, Sterilization, legal abortion), rights of the diseased persons and the right to die (suicide,
hunger Strike) etc.
[Ref- Park / 24" /21]
...
nswer
_ Health is on one hand a highly personal responsibility & on the other hand a major public concern. It
thus involves the Joint efforts of the whole social fabric, viz, the individual, the community and the state to
Protect & promote health.
1) Individual responsibility:
  - Primarily a person is responsible for his/her health,
  - Observance of simple rules of behaviors relating to diet, sleep, exercise etc.
  - Attention to personal hygiene.
2) Community responsibility:
  - Community can provide facilities manpower, logistic support and possible funds.
  - Community involvement in planning, management & evaluation of health programme.
  - Joining and using the health service.
3) State responsibility:
  - Health is constitutional right.
  - Govt. is legally bound to provide health care to every citizen,
4) International responsibility:
  - Co-ordination of different govt. e.g. Small pox eradiation.
  - WHO central co-ordinating agency.
...
\ nswer
Health indicators: Health indicators are the tools with which we measure the health status of a community.
Characteristics / criteria of health indicators: Ideal indicators —
1) Should be valid i.e. they should actually measure what they are supposed to measure.
2) Should be reliable & objective, i.e. the answers should be the same if measured by different people
in similar circumstances,
3) Should be sensitive, i.e. they should be sensitive to changes in the situation concerned.
4) Should be specific, i.e. they should reflect changes only in the situation concemed.
23
...
ZY To measure the health status of a community.
2) ‘Tocompare the health status of. one country with that of another.
3) To.assess the health-need Of the PEOpIE—
_5)- To monitor & evaluate of health services, activities & programmes.
...
Indicators of health: Indicators of health may be classified as-
...
va Y Limitation of activity.
4) Nutritional status indicators:
  - Anthropometric measurements of pre-school children e.g. weight & height, mid-arm
circumference.
...
6) Utilization rates:
  - Proportion of infants who are “fully immunized" against the 6 EPI diseases (at present 8
EPI diseases in Bangladesh).
Proportion of pregnant woman who receive antenatal care or have their deliveries
...
11) Indicators of quality of life:
  ...
  - Literacy.
12) Other indicators:
  - Social indicators- population, family formation, families ee.
...
nswer
Mortality indicators: They are —
1) Crude death rate: It is defined as the number of deaths per thousand per year in a given
community. CDR in BD = 4.8/ 1000/year.
2) Expectation of life: The average number of years that will be lived by those born alive into a
population if the current age specific mortality rate persists. In BD = 61 years.
3) Infant mortality rate: Number of infant deaths per 1000 live birth in one year. In BD IMR = 57/
1000/year.
4) Child mortality rate: Number of deaths at ages 1- 4 years in a given year 1000 children in that age
group at the midpoint of the year concerned.
5) Under 5 proportionate mortality rate.
6) Maternal mortality rate: Number of maternal death per 1000 living birth. In BD MMR =
3/1000/year.
7) Disease specific mortality: Deaths from specific diseases like cancer, cardiovascular diseases,
communicable diseases, accidents, diabetes etc.
8) Proportional mortality rate
Morbidity /aiestoes: To asses ill health of a community the following morbidity rates are useful —
1) Incidence and prevalence rates.
2) Notification rates.
3) Attendance rates at outpatient department, health centers etc.
4) Admission, readmission, and discharge rate.
...
rate provides a good tool for assessing the overall health improvement in a population.
2) An increase in the expectation of life is regarded, inferentially, as an improvement in health status. .
3) Infant mortality rate is one of the universally accepted indicators of health status not only of
infants, but also of whole population and of the socioeconomic conditions under which they live.
It is a sensitive indicator of the availability, utilization and effectiveness of health care, particularly
perinatal care.
Sl =
4) Child mortality rate correlates inadequate MCH services and related to insufficient nutrition, low
coverage by immunization and adverse environmental exposure and other exogenous agents. —
5) High rate of under-5 mortality reflects high birth rates, high child mortality rates and shorter life
expectancy, . .
6) Maternal mortality rate enormously varies according to country’s socioeconomic status.
7) The proportional mortality rate from communicable diseases indicates the magnitude of
reventable mortality.
e bd [Ref- Park / 24" /24)
S
Disability rate
</details>
...
3) Work loss days (or school loss days) with in specified period.
B) Person-type indicators:
1) Limitation of mobility:
  - Confined to bed.
  - Continued to house.
2) Limitation of activity:
  - Limitation to perform the basic activities of daily living (ADL) - eating, washing,
dressing etc.
  - Limitation in major activities ability to work at a job, ability to house work etc.
Disability free life expectancy (DFLE) / Active life expectancy / Sullivan’s index: Expectation of life free
from disability.
Sullivan’s index = life expectancy — (Duration of bed disability + duration of inability to perform major
activities)
[Ref- Park / 24" / 26]
Utilization rates
</details>
...
In order to obtain additional information on health status, the extent of use of health services is often
investigated. Utilization of services or actual coverage is expressed as the proportion of people in need of a
service who actually receive it in a given period, usually a year.
It is argued that utilization rate gives some indication of the care needed by a population, and therefore,
the health status of the population. In other words, a relationship exists between utilization of healthcare
services and health needs and status.
Healthcare utilization is also affected by factors such as availability and accessibility of health services
and attitude of an individual towards his health and healthcare system. A few examples of utilization rates are
given below in context of Bangladesh —
1) Proportion of infants who are "fully immunized” against the 6 EPI diseases (at present 8 EPI
diseases in Bangladesh).
2) Proportion of pregnant woman who receive antenatal care or have their deliveries supervised by
a trained birth attendant.
_neant
3) Proportion of pregnant women being delivered in a health service institution.
4) Proportion of pregnant women recciving two doses of TT.
5) Percentage of the eligible couples using the various methods of family planning regularly.
6) Bed-occupancy rate in hospital.
7) Average length of stay in hospital.
...
health that will enable every individual to lead a socially and economically productive life”.
134 member states and 67-organization members decided in Alma-Ata, the capital of Kazakhstan in
1978 that primary health care is the key to achieve the goal of health for all by 2000 AD.
...
4) Availability of primary health care to the entire population with at least the followings:
  - Safe water at home or within 15 minutes walking distance and adequate sanitation.
  - Immunization against EPI 6 diseases
  - Availability of at least 20 essential drugs within an hour trav
and childbirth.
5) Reduction of infant mortality rates (IMR) from the level 125 to 50.
6) Life expectancy at birth is over 60 years.
...
development goals (MDGs) adopted by 189 countries at the Millennium Summit in New York,
Millennium development goals and indicators: Governments have set a date of 2015 by which they would
meet the MDGs; i.e.
Goal no} Goal
...
Goal-4__|Reduce child mortality.
...
Prevalence & death rates associated with malaria,
Prevalence & death rates associated with tuberculosis,
Proportion of population using solid fuel.
Proportion of population with Sustainable access to an improved
water source, urban & rural.
...
adopt the United Nations Millennium Declaration. The leaders made specific commitments in following areas:
1) Peace, security & disarmament;
2) Development and poverty eradication;
3) Protecting our common environment, human rights, democracy and good governance,
4) Protecting the vulnerable;
5) Meeting the special needs of Africa;
...
aset of 17 “global goals” with 169 targets between them.
Goal no | ah é Goal
Goal-01: No pove: End poverty in all its forms everywhere.
Goal-02: Zero hunger End hunger, achieve food security and improved nutrition and promote
sustainable agriculture.
Goal-03: Good health & Ensure healthy tives and promote wellbeing for all at all ages.
wellbeing
Goal-04: Quality education | Ensure inclusive and equitable quality education and promote lifelong learning
opportunities for all.
Goal-05: Gender equit Achieve gender equality and empower all woman and girls.
Goal-06: Clean water and =| Ensure availability and sustainable management of water and sanitation for all.
sanitation
Goal-07: Affordable and Ensure access to affordable, reliable, sustainable and modern energy for all.
clean energ
Promote sustained, inclusive and sustainable economic growth, full and
economic growth productive employment and decent work for all.
Goal-09: Industry, Build resilient infrastructure, promote inclusive and sustainable industrialization
innovation & infrastructure _|and foster innovation.
Goal-10: Reduced Reduce income inequality within and among countries.
inequalities
...
Goal-13: Climate action Take urgent action to combat climate change and its impacts by regulating
emissions and promoting developments in renewable energy.
Goal-14: Life below water Life beyond water is to conserve and sustainably use the world’s oceans, seas
and marine resources.
a
30_—— ENDEA VOUR COMMUNITY MEDICINE FOR WRITTEN (SAQ, MCQ), VIVA & OSPF
Goal no | Goal
Goal-15: Life on land Protect, restore and promote sustainable use terrestrial ecosystems, sustainably
manage forests, combat desertification and halt and reserve land degradation
2 and halt biodiversity loss,
Shh Peace, Justice and | Promote peaceful and inclusive societies for sustainable development, provide
Ng institutions access to justice for all and build effective, accountable and inclusive
...
and combat hepatitis, water-bome diseases and other communicable diseases.
...
1) Appropriateness (relevance), i.e. whether the service is needed at all in relation to essential
human needs, priorities and policies. ;
2) Comprehensiveness, i.e. whether there is an optimum mixture of preventive, curative and
promotional services. ;
3) Adequacy, i.e. if the service is proportionate to requirement. ; 7
4) Availability, i.e. ratio between the population of an administrative unit and the health facility (e.g.
population per center, doctor-population ratio). ; _
5) Accessibility, i.e. this may be geographic accessibility, economic accessibility or cultural
accessibility. ; a
6) Affordability, i.c. the cost of health care should be within the means of the individual and the state.
7) Feasibility, i.e. operational efficiency of certain procedures, logistic support, manpower and
material resources.
[Park / 24/33]
SS
NN NN
...
1) Promotive health services; e.g.
  ...
  - Safe water supply
  - Health education ; ;
  - Improvement of personal hygiene by using specific method.
2) Preventive health services (specific method): e.g.
  - Vaccination
  - ORS
  - Vitamin A capsule.
  - lodized salt.
3) Curative health services: e.g. Pneumonia - Penicillin.
4) Rehabilitative health service: e.g.
  - Medical rehabilitation: Provision of aids for the crippled.
  - Vocational rehabilitation: Establishing schools of blind.
...
levels, each level supported by a higher level to which the patient is referred. These levels are —
R Primary health care: This is the first level of contact between the individual and the health system
where "essential" health care (primary health care) is provided. The Upazilla Health Complex and
their union sub-centers constitute this level of care in Bangladesh, OO
pecialized’ National specialized institution
Care
t
ear health Regional teaching hospital
are
t
Secondary health care District hospital
- ij
Figure: Different levels of health care system in Bangladesh.
: a
2) Secondary health care; At this level more ie CEE ee i aval aieares thie tel
i iv i istri itals usually con: 5
essentially curative services. The district hospitals usually
serves as the first referral level in the health system.
Tertiary health care: This level offers super specialist care. The level is provided by the regional
or central level institutions (e.g. medical college-hospitals-and other r specialized hospitals |. These
institutions provide referral support to primary and secondary level institutions.
i i ialized institutions; tional institute of
4) Super-specialized care: National level super specialized institutions; e.g. nat if
cardiovascular disease (NICVD), national institute of ophthalmology & hospital (NIOH), national
institute of kidney diseases & urology (NIKDU) etc.
...
must be a two-way exchange of information and returning patients to those who referred them for follow up
care. It will ensure continuity of care and inspire confidence of the consumer in the system.
A systematic referral system is given below:
1) Primary health care: At village, community clinic, union and Upazilla levels.
2) Secondary health care: District hospitals.
3) Tertiary health care: Regional teaching hospitals, e.g. medical college hospitals.
4) Super-specialized care: National specialized institution e.g. BIRDEM (Bangladesh institute of
research and rehabilitation in diabetes, endocrine and metabolic disorders), NICVD (National
institute of cardiovascular disease), NIKDU (National institute of kidney disease and urology) etc.
...
At present an auxiliary (Health assistant) and a female family planning worker (Family welfare
...
yaw
Comprehensive health care may be defined as {the provision of integrated preventive, curative,
ive and rehabilitative health care from the womb to the tomb to every individual residing in a
defined geographic area.)
Criteria of comprehensive health care: The Bhore committee defined comprehensive health care as having
the following criteria —
Oy Provide adequate preventive, curative and promotive health services.
2) Beas close to the beneficiaries as possible.
3) Has the widest co-operation between the people, the service and the profession.
4) Available to all irrespective of their ability to pay.
5) Look after specifically the vulnerable and weaker sections of the community.
6) Create and maintain a healthy environment both in homes as well as working places.
Objectives of comprehensive health care:
...
1) Maximum utilization of all available skills in order to ensure the most economic provision of health
services.
2) Co-operation and active involvement of the community with the staff of medical institutions
providing the services.
3) A change in traditional pattern of living and availability of basic sanitary amenities.
4) The available doctors should be concerned not only with the illness of the individual but also with
the factors, which govern the well-being of the whole community.
5) Awareness & acceptance of modem concepts in health and sickness.
Examples of each, components of comprehensive health care:
1) Preventive health services: Prevention of diseases by vaccines, e.g. prevention of poliomyelitis.
2) Curative health services: Treatment of diseases, e.g. anti-tubercular drugs therapy for
tuberculosis.
3) Promotional health services: e.g. health promotion by environmental and personal sanitation.
...
[Ref- Park /24" /928 + Rashid, Khabir, Hyder / 5" / 25]
tS
& OS
...
Alma-Ata (former USSR). It has been defined as —
Essential health care based on practical, scientifically sound and socially acceptable heer and
...
[Ref- Park / 24" /34]
Easy to Remember: Elements of PHC —
...
Alma-Ata (former USSR). It is accepted by the member countries of WHO as the key to achieving the goal of
health for all by the year 2000 AD.
Before Alma Ata, primary health care was regarded as synonymous with “basic health service”, “first
contact care”, “easily accessible care”, “services provided by generalists” etc. it was the Alma Ata conference
that broadened the earlier restrictive concept and provided it a political dimension and declared the strategy for
achieving the goal of HFA by 2000 AD through the key approach of primary health care.
...
3) Inter-sectoral co-ordination / Multi-sectoral approach.
4) Appropriate technology.
Explanation of the principles:
~ Equitable distribution: Health services must be shared equally by all people irrespective of their
ability to pay. Rich or poor, urban or rural must have access to health services; e.g. PHC services
should be given according to priority of needs i.e. the needy and vulnerable groups of population in
rural areas and urban slums.
- Community participation: It is defined as ‘the process by which individuals and families assume
responsibility for their own health and welfare and for those of the community and develop the capacity
to contribute to their and the community’s development’.
  - Involvement of individuals, families, communities, in promotion of their own health and
welfare is an essential ingredient of PHC.
  - Community involvement also implies that the community should participate in the planning,
implementation and maintenance of health services.
  - Example: To make the EPI successful in Bangladesh, community participation has a great role.
  - Importance: .
1) It leads to sense of responsibility for the project.
2) More will be accomplished.
3) Participation guarantees that a felt need is involved.
4) Services can be provided at a lower rate.
5) Participation has an intrinsic value for the participants.
6) Itisa catalyst for further development effort.
Multisectoral approach / intersectoral coordination: The component of PHC cannot be provided by
the health sector alone. PHC involves in addition to health sector all health related sector, i.e.
- Agriculture.
Animal husbandry.
Food.
Industry.
...
unnecessary duplication of activities.
  - Example: To provide adequate supply of safe water and basic sanitation of a
community, the coordinated approach of Health department, Public health engineering
department and information department are needed,
= Appropriate technology:
  - Itis scientifically sound.
...
2) Lack of adequately trained and motivated manpower.
3) Absence of appropriately managed referral system.
...
Primary health care institutions: Following structures provide the essential elements of PHC-
  - Upazilla health complexes (UHC),
  - Union health & family welfare centers (H&FWC), &
  - Union health sub-centers.
Obstacles to the successful implementation of primary health care (PHC) in Bangladesh:
1) Persistent bias towards curative aspect shown by the people as well as health personnel.
2) Lack of adequately trained and motivated manpower.
3) Absence of appropriately managed referral system.
4) Difficulty in involving the people.
...
1943 under the chairmanship of Sir Joseph Bhore. The members of the committee met regularly for 2
years and submitted in 1946 its famous report which runs into 4 volumes.
+ The committee observed, "If the health of the nation is to be built, the health program should be
developed on a foundation of preventive health work and such activities should proceed side by side
with those concerned with treatment of patients."
...
2) Development of primary health centres in two stages:
  - Asa short-term measure: each primary health centre in the rural areas cater to a
population of 40,0000 with secondary health center to serve as a supervisory, co-
ordinating and referral institution.
  - Long term programme: Setting up primary health units with 75 bedded hospitals for
each 10,000-20,000 population and secondary units with 650 bedded hospitals, again
regionalized around district hospitals with 2500 beds.
3) Three months training in preventive and social medicine for medical students to prepare ‘social
physicians’.
[Ref- Park / 24/910]
...
well as high growth rate. The problems arising due to over population in Bangladesh are-
  - Unemployment problem.
  - Poverty problem.
  - High dependency.
VA&
2) Communicable disease problems: Communicable diseases are still ne sail sete i
Bangladesh. Mortality & morbidity due to these diseases are very higl . : S eilemine
cholera, typhoid, TB, tetanus, diphtheria, venereal diseases and parasitic i i
filariasis & worm infestations are responsible for major, morbidity.
3) Nutritional problems: Major nutritional problems in Bangladesh are —
  - Protein energy malnutrition (PEM).
  - Vitamin A deficiency disorders.
  - Tron & lodine deficiency disorders,
  - Neurolathyrism (Khesari dhal intoxication).
4) Medical care problems: Quality and coverage of PHC are not expectation. Health care facilities
have so far concemed only 40-50% of the population. Besides due to lack of proper linkage and
referral system, PHC services could not be provided to the desired extent.
5) Environmental sanitation problems: Two types.
...
behavior in response to the disease, as well as the impact of that disease on the psychosocial environment.
According to Susser: Illness is a Subjective state of the person who feels aware of not being well.
Sickness: Refers to a state of social dysfunction,
According to Susser: Sickness is a state of social dysfunction i.e. a role that the individual assumes when
ill (‘sickness role’),
[Ref- Park / 24" / 37]
For more curiosity
%,
- Disease: Literally means without ease (uneasiness) disease, the opposite of ease when something is
wrong with body function.
According to Susser: Disease is a physiological / psychological dysfunction.
[Ref- Park / 24" /37]
- **International classification of disease:**
] Certain infectious and parasitic diseases,
2) Neoplasms.
3) Diseases of the blood and blood-for
mechanism.
4) — Endocrine, nutritional and metabolic diseases,
ming organs and certain disorders involving the immune
+ + ee:
5) Mental and behavioral disorders.
6) _ Diseases of the nervous system.
7) _ Diseases of the eye and adnexa.
...
15) Pregnancy, child birth and puerperium.
...
The concept of disease in which the ancient man believed is know!
...
- **Germ theory of disease:** This concept is generally referred to as a one to one relationship between
causal agents and disease. The disease model accordingly is: Disease agent > Man —> Disease.
- Epidemiological triad: Please see below.
- Multifactorial causation: This concept states that multiple factors are responsible for a disease process
to before and de - emphasize the concept of disease agent causation i.e. Germ theory. As for example
lung cancer, coronary heart disease, chronic bronchitis etc, Tuberculosis is not merely due to tubercle
bacilli; factor such as Poverty, over-crowding and malnutrition contribute to its occurrence.
- Web of causation: This is ideally suited in the study of chronic disease. Where the disease agent is
often not known but is the outcome of interaction of multiple factors. E.g. myocardial infraction is web
causation disease. The web of causation does not imply that the disease cannot be controlled unless all
the multiple cause or chairs of causation or at least a number of them are appropriately controlled or
removed,
- The epidemiological wheel Concept: This is another approach to depict man-environment. The host is
...
Personal health and promote human development.
In terms of health maintenance, self-care is any activity of an individual, family or community, with the
...
This concept states that in order for a disease Process to occur,
there must be a unique combination of events that is, a harmful agent that
comes into contact with a Susceptible host in the proper Bad apa Gsent) Cte)
These three epidemiological factors (agent, host and environment) are Figure: Epidemiological triad.
commonly referred as the ecological or epidemiological triad.
The occurrence of a disease can be blocked
...
presence or relative lack of which may initiate or perpetuate a disease process,
Characteristics of agent:
1)
2)
3)
It can be both living and non-living.
Biological agent exhibit certain properties- infectivity, pathogenecity, virulence.
Absence or insufficiency or excess of a factor (e.g. chemical factors, nutrient factors etc.) necessary
to health. ‘
Route of entry.
Incubation period.
Generation time.
...
1) Biological agents: They are the living agents of disease. Examples: Viruses, rickettsiae, fungi,
2)
3)
4)
5)
...
Nutrient Agents:
  - Examples: Proteins, fats, carbohydrate, vitamins, minerals and water.
  - Excess of deficiency of intake of nutritive elements may result in nutritional disorders.
Physical agents:
  - Examples: Heat, cold, radiation, electricity, sound, pressure etc.
  - Exposure to above agents may result in illness.
Chemical agents: As a result of derangement of functions, some of the chemicals is produced in
the body may cause illness.
Example:
+ Endogenous:
  - Urea > ureamia
  - Uric acid > gout.
  ...
  - Ketones > ketosis.
  - Exogenous: Allergens, metals, fumes, dusts, gases and insecticides.
Mechanical agents: Exposure to chronic friction and other mechanical force may cause crushing,
tearing and even death.
Absence or insufficiency or excess of factor necessary to health:
Chemical factors > hormones, enzymes.
Nutrient factor —> protein, fat etc.
Lack of part of structure —> cardiac defects
Chromosomal factors > Turner’s syndrome.
Immunological factors > Agammaglobulinaemia.
Social agents: Examples:
Poverty — deficiency disorder
  - 
  - Smoking — lung cancer,
  - Abuse of drugs & alcohol — cirrhosis of liver
...
1) Obligate host: means the only host, e.g. man in measles and typhoid fever. .
2) Primary or definitive host: Host-in which the parasite attains maturity or passes its sexual stage.
3) Secondary or intermediate host: Host in which the parasite is in a larval or sexual state.
4) Transport host: It is a carrier in which the organism remains alive but does not undergo
development.
[Ref- Park / 24" /38, 98]
Characteristics of host:
  - Demographic characteristics: Age, Sex, Ethnicity.
  - Biological characteristics: Genetic factors, biochemical levels of blood (cholesterol), blood
groups, enzymes, blood pressure.
  - Social and economic characteristics: socio-economic status, education, occupation, marital status,
housing etc,
...
physical factors (e.g., air, water, soil etc.) with which man is in constant interaction.
Example:
  - Air Air pollution > Health problems,
  - Radiation > Radiation hazards —> Health problems,
2) Biological environment: The biological environment is the universe of living things which
surrounds man, including man himself,
Example: Viruses, bacteria, insects, rodents, animals, plants.
3) Psychological environment: It includes a complex of psychological factors which are defined as
those factors affecting personal health, health care and community well-being that stem from the
psychological make-up of individuals and the structure and functions of social groups’,
Example: Cultural value, customs, habits, beliefs, attitudes, religion, education, life-style.
[Ref- Park / 24" / 41, 42]
4
...
Natural history of disease: , ; ;
atural history signifies the way in which a disease evolves over time from the earliest stage of its pre-
pathogenesis phase to its termination) as recovery, disability or deatl), in the absence of intervention.
Phase: Two phases — .
1) Pre-pathogenesis phase: This is the period preliminary to the onset of disease in man) Agent, host
and environment these three factors interact during this phase and disease occur.
2) Pathogenesis phasey f begins with the entry of the disease agent in the human host) Usually there
may be incubation petiod between the entry of disease agent and
nical signs and
[Ref- Park / 24" /39, 40]
...
**Risk / Risk factor:** The term ‘risk factor’ is used by different authors with at least 2 meanings-
  ...
  - A determinant that can be modified by intervention, thereby reducing the possibility of occurrence
of disease or other specific outcomes.
Many diseases, e.g. coronary heart disease, cancers peptic ulcer etc. agent is still unidentified. In these
cases, aetiology is discussed in terms of risk factor.
Classification of risk factors: 2 types-
1) Modifiable risk factors: e.g.
Smoking.
Hypertension.
Elevated serum cholesterol level.
Physical activity.
Obesity.
2) Non-modifiable risk factors: e.g.
Age P
Sex
Race
Family history
...
**i:** Risk factors
Smoking, lack of exercise, type-A personality, ‘as
high blood pressure, elevated serum. cholesier on
g lev uD ee
Smoking, alcohol, radiation, work-site hazai a
some medications, some infectious agents, dieta e
...
groups” (e.g. at-risk mothers, at-risk infants etc.) in the population by certain defined criteria and direct
appropriate action to them first. This is known as the “risk approach”.
Guidelines for defining “at-risk” groups:
1) Biological situation:
  - Age groups: e.g. infants (low birth weight), toddlers, elderly.
  - Sex: e.g. females in the reproductive age periods.
  - Physiological state: e.g. pregnancy, high blood pressure, cholesterol level.
  - Genetic factors: e.g. family history of genetic disorders.
  - Other health conditions: e.g. disease, physical functioning, unhealthy behaviour.
...
constitute the gi ycle.
: There are 6 stages of disease cycle:
a
Stage 1: Incubation period; It is the time interval between the entry of the disease agent in the
Cs body & manifestation of clinical sings & symptoms, This period varies from disease to disease; ¢.g.
AIDS: Prolong incubation period.
x Tetanus- short incubation period.
2) Atage 2: Prodromal period: It is a short period ranging from _1- 4 days and is characterized by
ah ae hear — rr IE |. paaqmcepege|
vague signs and symptoms such as headache, fever, body ache and restlessness, Clinical diagnosis
~s not possible during this stage because of the vagueness of the S/S. The pt. is nevertheless
possible cunts ——-—=
jnfectious to others.
_3) Stage 3: Fastigium: In this stage the patient is ill and taken to bed, the 2 signs & symptoms are clear-_
cut. Usually there is no difficulty in diagnosing the condition clinically.
AY Stage 4: Defervescence: In this stage body’ defensive mechanism begins to take an upper hand
over pathogens, and the patient begins to feel better:
Stage 5: Convalescence: During this stage, the pt. recovers from disease but may ; still harbour the
disease agent.
6)” Stage 6: Defection: During this stage the individual recovers from the illness.
eS
See
3) fastigium
4) defervescence
...
2) Prodromal period
1) Incubation
Point of invasion 6) defection
By Dr-Jahir 7 -
19.02.2012 Figure: Disease cycle.
Uses of disease cycle:
1) It is important to learn that from the last stage of incubation period to the first few days of
convalescent period a patient is infective to others.
2) By knowing the incubation period we can trace the source of infection and preventive way of a
disease.
...
receptivity.
- Leprosy is an excellent example of the spectral concept of disease. For almost every disease, there
exists a spectrum, with few exceptions such as rabies.
- Ininfectious diseases, the spectrum of disease is also referred to as the gradient of infection.
- The spectrum of disease can be interrupted by early diagnosis and treatment or by preventive
measure.
| 7%
VIVA & OSP|
Positive health
...
Severe infections
Fatal illness
Figure: Disease spectrum. |
Importance: The concept of spectrum of disease provides for inclusion of all cases both sub clinical and
...
in similar manner of an iceberg.
See ee
Parts of iceberg: —
1) Floating tip: The floating tip of the iceberg represents what the physician sees in the community,
iethecasss. $$ . ©) —ecermunity,
\2)y- Water line: The water line represents the demarcation between apparent and in-apparent disease.
3) Submerged portion: The vast submerged portion of the iceberg represents the hidden mass of
es
disease, i.e.
Latent case
  - Presymptomatic case.
...
What the physician
does not see
Figure: Iceberg of disease,
idemiolo ical importance of iceberg of disease:
Ie The unknown morbidity in some diseases like TB, alimentary infections, malnutrition, cancer, diabetes,
hypertension represent the submerged portion of the iceberg. It exceeds the known morbidity or
exposed portion. ij
NNN NNN Ratt
2. The submerged or hidden part of the iceberg thus constitutes an important undiagnosed reservoir of
infection or disease in the community and its detection and control is a challenge to modem techniques
...
community in similar manner of an iceberg.
1) The unknown morbidity in pulmonary tuberculosis represent the submerged portion of the iceberg.
It exceeds the known morbidity or exposed portion.
2) The submerged or hidden part of the iceberg thus constitutes an important undiagnosed reservoir of
pulmonary tuberculosis in the community and its detection and control is a challenge to modem
...
- The duration and the risk of transmission of disease.
- The effects of infection, including both the physical and psychosocial complications.
- The financial burden to the community.
Example: Malaria control.
Elimination of disease: It is defined as interruption of transmission of disease.
Example: Elimination of measles, polio and diphtheria from large geographic regions or areas.
Disease eradication:
Eradication literally means to “tear out by roots". Eradication of disease implies termination of all
transmission of infection by extermination of the infectious agent through surveillance and containment.
...
[Traits Disease control
transmission of infection by
1) Definition It is the reducing the incidence of
disease; the duration & risk of issio rt >
transmission; the effects of infection; and extermination of the —- agent’
the financial burden of the community. through surveillance & containment,
2) Area of operation Only where transmission is intense. All areas where transmission occurs.
3) Step The first step in the conquest of disease. | The final step in the conquest of
4) Aim
disease.
To tear out of disease by roots.
To reduce the incidence, prevalence and
outcome of disease.
[Good id Perfect
Permitted to persist. Absolutely eradicated.
Not so. Yes.
...
2) No animal reservoir or insect vector; transmitted person to person.
3) Characteristic clinical illness; usually serious, easily diagnosed.
4) Few or no subclinical cases,
5) No long term carrier,
6) Only one causative agent or serotype persists.
7) Short period of infectivity.
8) Immunity is of long duration.
9) Inhibits reinfection, reactivation, reduces or eliminates excretion of organism.
...
“ Evaluation: It is the process by which results are compared with the intended objectives, or more
...
Objectives:
1) To provide information about new and changing trends in the health status of a population, e.g.
morbidity, mortality, nutritional status or other indicators and environmental hazards, health
practices and other factors that may affect health.
2) To provide feed-back which may be expected to modify the policy and the system itself and lead to
...
i +a]. primarys
prevention (primordial, p'
secondary & tertiary),
isk factors in county)
fir k Intries Or
Levels of prevention: There are 4 levels of
: erg ' SE
Dy Primordial prevention: Prevention a erappeared: - ertension) have their early Orsini
ae rey in which They Tae ems (eB: ObeSHYs MT eg (e.g. smoking, eating habi,
- Exsmnier ay hee ee when lifestyles a are directed towards discouraging
childhood, because an primordial prevention, effo
physical exercise etc.). In
or deve
rough individual and education,
i i ifestyles. ,
children from adopting harmful lif ation is th
  - The main intervention in primordial preve ae" phase 0 fa disease or heat
Primary prevention: It signifies intervention ate naan the primary level of disease preven
rima rev. :
s of intervention !
problem (¢.g. LBW). There are two mode
/AY Health promotionr e.g.
ye _* Health education ,
s _> Environmental modifications.
ye Nutritional intervention
) 7 Lifestyle and behavioural changes.
YS Specific protection: e.g.
  - . munization
AS aust nit
7 “> Protection against accidents.
Oo Protection against occupational hazards. ;
which halts the progress of a disease at its P
incipient stage and prevents complications." . .
a) The specific interventions are early diagnosis and ad
a The methods employed for early diagnosis are —
Case finding measures, individual & mass.
as > Sereening surveys.
lequate trea t.
BOs Surveillance techniques.
oa Periodic examination. .
PP Selective examination of people at high risk.
AY Tertia revention: It may be defined as "all measures available to reduce or limit impairments and
disabilities, minimize suffering caused by existing departures from good health and to promote the
patient's adjustment to irremediable conditions". There are two modes of intervention in tertiary level-
AY Disability limitation. |
Sd) Rehabilitation.
=i 7 Medical rehabilitation.
...
SSMAOMON wa “s
Cl
ter-02: Concept of health & disease ———
51
Gf diseas ncn, pt the usual sequence in the development
Intervention: It can be defined as any attempt to intervene or interru;
Modes of interventions:
1) Health promotion: It is the process of enabli i ;
health, The well-known ied we denn a ie to increase control over, and to improve
  - Health education.
  - Environmental modifications,
  - Nutritional interventions.
  - Lifestyle and behavioral changes.
2) Specific protection: To avoid disease all together e.g.
  - Immunization.
...
Control of specific hazards in the general environment e.g. air pollution, noise control etc.
Control of consumer product quality and safety of foods, drugs, cosmetics etc.
3) Early diagnosis and treatment: The earlier a disease is diagnosed and treated the better the
prognosis and preventing the occurrence of further cases (secondary cases) or any long term
disability.
...
+ Disability: As a result of impairment, if affected person is unable to perform any activity or to carry out
any activity. Example: Inability of work.
...
disease, cuts short the duration of illness and prevents development of secondary cases in the
community. In some diseases like tuberculosis, syphilis, leprosy treatment is of primary importance
in interruption of transmission.
2) In some diseases, early treatment is essential to prevent secondary complications; e.g. syphilis.
3) Rarely treatment is an important part of prevention in respect of certain diseases and conditions,
e.g. carcinoma, cardiovascular diseases.
4) Treatment relieves pain, arrest or cure disease and thus prevent disability and heath.
From above positive supports it is proved that "early diagnosis and treatment is a part of
prevention.
[Ref- Park / 24" / 48]
;
...
Examples of rehabilitation:
  ...
  - Re-constructive surgery in leprosy etc.
...
[Ref- Park / 24" /53]
Or,
Community diagnosis generally refers to the identification and quantification of health problems ina
community in terms of mortality and morbidity rates and ratios and identification of their correlates for the
purpose of defining those individuals or groups at risk or those in need of health care.
[Ref- Park / 24" /96]
Data for community diagnosis:
1) Age and sex distribution of the population; the distribution of population by social groups.
2) Vital statistical rates such as the birth rates, death rates.
3) Incidence and prevalence of important diseases in the community.
[Ref- Park / 24/54]
Importance of community diagnosis in the prevention of diseases:
1) By quantification of health problems, we lay down priorities in disease control and prevention.
2) Quantification of morbidity and mortality can serve as a benchmark for the evaluation of health services
at a later date.
3) Quantification of health problems can be a source of new knowledge about disease distribution,
...
meet the health needs of the community taking into account the resources available and the wishes of the
people, as revealed by community diagnosis.
tively utilize all the available resources.
1) It must effec ces.
2) It must coordinate with the efforts of other agencies in the community; i.e. inter-sectoral
coordination.
3) It must encourage the full participation of the community in the programme.
Example:
...
Health legislation.
Levels of action in community treatment: There are 3 levels of action —
1) Atthe level of individual.
...
c) Adult literacy rate c) Nurses.
d) Unemployment rate d) Engineers.
e) Teachers.
e) Dependency ratio
...
b) Mental dimension. c) Appropriate technology.
c) Spiritual dimension. d) Provision of essential drugs.
...
b) Rehabilitation. c) Per capita GNP.
c) Treatment. d) Life expectancy at birth.
...
a) Feasible.
b) Effective. c) Nutritional disorders.
d) Speech therapy.
c) Adequate.
...
b) MMR.
b) Multidimensional
c) Integral part of development
d) Central of the concept of quality of life
e) One that can be measured directly
...
b) absence from school b) Isolation
...
Measurement of Morbidity.... sassyosssenndsnied
Incidence and Prevalence...
Epidemiologic Methods
...
Randomized controlled trial ie
