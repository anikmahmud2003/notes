...
> Full conversion of `Chapter-11_Maternal_and_Child_Health.md`.
...
aternal & child health (MCH): . . ive & rehabilitati
The term “maternal and chitd health” refers to the promotive, preventive, curative & rehabilitative
health cate for mothers & children (up to pre-school age))
[Ref- Park / 24" / 558)
hat are the objectives of MCH?
ee are the objectives of MCH package care? [CU-10J]
Objectives of MCH service: (The ultimate objective of MCH services is life-long health)
cy eduction of maternal, perinatal, infant & childhood mortality and morbidity.
Promotion of reproductive health. oe .
...
group (15 — 44/49 years) & children under the age 5 years in the population, which is especially vulnerable to
disease, disability or death. ;
The MCH package services encompass the curative, preventive and social aspects of obstetrics, family
welfare, nutrition, child development and health education.
[Ref- Park /24"/590]
Beis the components of MCH services.
. “Q. What are the components of MCH package care? [CU-10J]
Components/ sub-areas of MCH:
© Maternal health.
\ fo Family planning.
A. Child health
/4& School health
...
1) Integration of care: The integration is based on the fact that it is inconvenient for the mother to go
to one place to receive care for herself, to another for care for her children, and yet another for her
family planning services. An integrated approach implies that all those involved in maternity care
from the obstetrician down to the local dai, must work as a team.
Risk approach: It is based on the early detection of mothers and children with high risk factors and
are given additional and more skilled care including hospitalization.
3) Manpower changes: A wide range of works are now considered necessary for maternal and child
health work. They include —
  - Professionals: Specialists.
2
LYS
  - a workers, health guides, dais (traditional birth attendants),
  - Voluntary ganw = i workers, ASHA etc, _
dy Prins heat ry workers: Members of women’s organizations.
...
MCH based family planning:
  - Itis the family planning service when its delivery is made to the consumer through the units which
usually deliver maternity and child health care. In short, it is the integration of mother and child
health and family planning services.
  - Family planning will be highly effective if it is based at MCH centres. Because on these centres are
attended by mothers before, during and after delivery. During these stages mothers and women can
be better motivated in the MCH centres women are accompanied by their husband, so both of them
can be motivated together.
  - It is inconvenient for the mother to go to one place to receive care for herself to another place for
care of her children and yet to another place for family planning.
  - Family Planning services were being given from existing hospitals, clinics and specially established
family planning clinics. This was a sort of duplication of service, separate establishment, separate
staff, different places.
  - Mothers are directly exposed to the risks of child birth, so family planning motivation are more
important for them child care is indirectly related with family planning. With these ideas in the
background came o. the concept of MCH based family planning.
...
total population.
2) They are more vulnerable or high- risk group.
3) The infants, under 5 children and maternal mortality rate are very high in developing Countries.
...
2) Mortality in infancy & child hood:
...
The term Matemal and child health refers to the promotive, Preventive
or mother and children. The criteria are
1) Improvement of maternal health.
2) Improvement of child health,
3) Family planning.
4) School health maintenance.
$) Reduction of maternal, per
O) gPromotion of reproductive
Promotion of physical and
inatal, infant and childhood mortality.
health,
psychological development.
- Vhy mother and child are considered as one unit?
. “Mother and child is one unit” — justify this statement. [DU-14Ju, RU-16M]
Mother and child are considered as one unit: They are considered as one unit for the following reasons -
) During the antenatal period the fetus is the part of the mother.
: Child health is closely relat
Z 3) Certain diseases and condit
ed to maternal health. 7
ions of the mother during pregnancy (e.g. syphilis. German measles,
drug intake) are likely to have their effects upon the fetus.
4) After birth, the child is dependent upon the mother.
5) The mother is also the first
efine maternity cycle.
Maternity cycle:
Fertilization.
Intranatal period.
teacher of the child.
[Ref- Park /24* / 533}
. What are the stages of maternity cycle? [DU-18M,17M]
2). Antenatal or prenatal period.
Ay
Postnatal period.
Inter-conceptional period.
ention the periods of growth.
nswer
Periods of growth:
Ay Prenatal period:
[Ref- Park / 24 / 5336]
- Ovum - 0 to 14 days
\
/ 7” Embryo - 14 days to 9 weeks
  - Fetus — 9" week to birth
) Premature infant: From 28 weeks to 37 weeks.
...
2) Intra-natal care (INC), safe & ase
3) Post-natal care (PNC).
4) Immunization.
5) Screening of high risk mother.
6) Health education, breast feeding,
ptic delivery.
nutrition of newborn & pregnant women & family planning practices.
7) ie obstetric care (EOC) services.
8) Vitamin-A and iron supplementation to und i
9) ORS distibution p under S children & pregnant women.
10) Medical treatment for under 5 children and pregna
int women,
...
“ Malnutrition:
Effects / complications of malnutrition:
1) Maternal depletion
2) Anaemia of mother
3) Toxemias of pregnancy
4) Post-partum haemorrhage
5) Low birth weight of child
Measures to prevent:
a) Direct intervention:
1) Food supplementation
2) Food fortification
3) Food enrichment
4) Distribution of iron and folic acid.
...
6) PHC
+ Infection:
Effects / complications of infection:
1) Respiratory tract infection (ARI)
2) EPI 6 diseases
3) Diarrhoea
4) Abortion
5) Puerperal sepsis
6) Foetal growth retardation
7) Low birth weight
8) Embryopathy.
  - Main infection controlled by vaccine.
  - Personal hygiene.
  - Health education.
- » Uncontrolled reproduction: ;
Effect / complications of uncontrolled reproduction:
1) Increased prevalence of severe anemia.
oy
2) Abortion.
...
[Ref- Park /24"/ 557]
ommon child health problems in Bangladesh:
/ Low birth weight (LBW).
/ Malnutrition.
afections & parasitosis.
)
Accidents & poisoning.
& Betavioural eoblams;
Antenatal care (ANG), |
...
4
[Ref- Park / 24" / 558]
ist the objectives of antenatal care. [DU-17M, CU-12Ju, RU-18N,16N,13J, SUST-11J]
swer
Objectives of antenatal care:
1) To promote, protect and maintain the health of the mother during pregnancy.
2) To detect “high-risk” cases & give them special attention.
...
6) To teach the mother elements of child care, nutrition, personal hygienic and environmental
sanitation.
7) To sensitize the mother to the need for famil
...
> For fetus:
1) Health promotion to bring on positive health.
2) Prevention of high-risk pregnancy on health promotion,
3) Early screening of high -risk pregnancy and its referral to specialist centre.
4) Immunization against maternal tetanus.
5) Maternal safety in childbirth is ensured and maternal mortality & morbidity can be minimized.
6) Maternal health education comes most beneficial on:
Primary health care.
Home resource, food education, clean drinking water & sanitation.
Self-care on health & awareness of high- risk pregnancy, labour & neonate.
Events of labour.
Care of newborn on breast feeding, infant feeding, infant immunization, and oral
rehydration therapy for mild diarrhoea.
Contraception for 1-2 child family.
1) Fetal health promotion by mother's health promotion. Birth of pre-term and growth retarded
baby are prevented.
2) Fetal well-being is assessed.
3) Fetal malformation is minimized.
4) Birth asphyxia is minimized.
5) Protects newborn against tetanus of 3 months. Neonatal infections are minimized.
...
. tacts between the patient &
1)
2)
3)
4)
5)
Antenatal visits: Antenatal visits means antenatal contacts i.e. - con’
doctor when the first report of the mother is sent to the clinic her name should be registered ideally
the mother should attend the antenatal clinic once a month during the first 7 months twice a month,
during the next month, and thereafter, once a week, if every thin- is normally.
Prenatal advice: A major component of antenatal care is antenatal or prenatal advice. The mother
is more receptive to advice to concerning herself and her baby at this time than at other times. At
this time the mother is advised about her diet, personal hygiene, radiation, warming signs and
childcare.
Specific health protection: The mother should be protected against the following diseases or
disorders: anemia, other nutritional deficiencies. Toxemias of pregnancy, Tetanus, Syphilis,
German measles HIV infection. She should consider her Rh status, Prenatal genetic screening.
Mental preparation: It is as important as physical or material preparation. Sufficient time and
opportunity must be given to the expectant mothers to have a free and frank talk on all aspects of
pregnancy and delivery.
Family planning: The mother psychologically more respective of advice on family planning than
at other times. Educational and motivational efforts must be initiated during the antenatal period.
...
n swe”
Antenatal visits:
  - Antenatal visits mean antenatal contacts; i.e. between the patient & doctor. ;
  - When the first report of the mother is sent to the clinic, her name should be registered.
Antenatal visits may be categorized in the following ways:
Minimum
% 1" visit: 4-12 weeks
  - 2" visit: 24-26 weeks
  - 3% visit: 36-38 weeks
Standard (ideal) rad Intermediate (moderate)
/4 » Every 4 weeks up to 32 week§ 4 > I visit: Before 12 weeks.
(/’| ® Every 2 weeks from 32 to 36 > 2™ visit: 20 - 22 weeks.
weeks (1) > 3" visit: 28 - 32 weeks.
  - Once a week from 36 to 40 > 4" visit: 34 - 36 weeks.
...
**Schedule of tetanus prophylaxis during antenatal period:**
  ...
  - Itshould not be administered in Ist trimester of pregnancy because rarely there is possibility of
...
home. The mother is generally relaxed at home. The home visit will win her confidence. The home visit will
provide an opportunity to observe the environmental and social conditions at home and also an opportunity to
...
History taking.
: Physical examination: ‘Pallor, ‘pulse, ‘respiratory rate, ‘ocdema, ‘blood pressure, ‘weight, and
breast examination.
3) Abdominal examination: "Measurement of the fundal height, “fetal heart sound (FHS &
FHR), “fetal movements, ‘fetal parts, ‘multiple pregnancy, ‘fetal lie & presentation, and
...
1) Physical examination (e.g. weight gain, blood pressure)
2) Laboratory tests should include
3) Urine examination
4) Hemoglobin estimate.
  - Intervention & counseling:
Iron & folic and supplementation and medication as needed.
...
fr Anaemia: Iron and folic acid supplementation.
bod Other nutritional deficiencies: The mother should be protected against other nutritional
deficiencies that may occur, particularly protein, vitamin and mineral especially vitamin-A and
iodine deficiency.
  - Toxaemia of pregnancy: Early detection and management is necessary.
  - Tetanus: Mother is to be immunized against tetanus.
(¥ Syphilis: Syphilis: Blood of a pregnant mother should be tested for syphilis. If diagnosed, daily injection of
procaine penicillin (6 lac unit) for 10 days to be administered.
f German measles: Mother should be vaccinated against German measles before pregnancy and
effective contraceptions be maintained for 8 weeks after vaccination because of the possible risk to
the fetus from the virus.
P- Rh status: If woman is Rh-negative and her husband is Rh-positive, she is kept under surveillance
for determination of Rh-antibody levels during antenatal care. The blood should be further
examined at 28 weeks and 34 — 36 weeks of gestation for antibodies. Rh anti-D immunoglobulin
j should be given at 28 weeks of gestation so that sensitization during the first pregnancy can be
al
prevented.
HIV infection: Voluntary prenatal testing for HIV infection should be done in early pregnancy.
356 —— 4
  - tee . . . . . H HT
Hepatitis-B infection: Vertical transmission can be blocked by immediate post-delivery
administration of b immunoglobulin and hepatitis-B vaccine.
  - Prenatal genetic screening: Screening for chromosomal abnormalities.
[Ref- Park / 24" / 562, 564]
urthe components of first antenatal checkup. [DU-15Ju]
...
- Advice.
s to be taken during 1“ antenatal care:
1) Registration of the pregnant woman.
2) History taking:
a) Obstetric history:
“ History of current pregnancy:
Ist day of last menstrual period (LMP)
i Any bleeding or pain.
2% _ Menstrual cycle - normal/ irregular
Use of oral pills.
History of past pregnanc
/v Previous pregnancy & labour.
Abortion.
y¥~ Premature labour.
...
Epilepsy
- Blood transfusion.
STDs & sexual behaviour.
  - Previous surgical or gynecological operation.
c) Family history:
Genetic diseases such as haemoglobinopathy.
in case of multipara):
O DM, HTN
- Infectious diseases e.g. T.B. hepatitis etc.
  - Twin births.
3) Examinations:
amination: Height, weight, anemia, jaundice, oedema, BP, pulse etc.
  - General ex
aa
  - Obstetrical examination:
- Breast & nipple.
- Abdominal examination- size and shape of uterus, position of the uterus, size of the
fetus, lie, presentation & attitude of fetus, auscultation of fetal heart sound, any other
abnormalities.
  - Vaginal examination: Examination of external genitalia.
4) Investigation:
...
5) Prenatal advice:
Diet.
Personal hygiene: Should maintain personal cleanliness, rest & sleep, dental care.
Should avoid: Constipation, manual physical labour, smoking, alcohol, sexual intercourse
(especially in last trimester).
Avoidance of drugs: e.g. Thalidomide, LSD, Streptomycin, Sex hormones, Tetracycline etc.
Radiation: X-ray examination of abdomen should be avoided during the 1* 4 months of
pregnancy.
Warning signs: The mother is advised to report immediately if following warning signs
develops:
...
ow the risk of mother regarded as high risk can be combated? [RU-15J]
nswer
Warning signs of pregnancy: The mother is advised to report immediately in case of warning signs:
1) Swelling of the feet.
2) Fits.
3) Headache.
4) Blurring of the vision.
5) Bleeding or discharge per vagina and any other unusual symptoms.
alleviate / prevent warning signs:
Avoiding excessive physical exertion & stress,
2) Adequate rest & sedation,
3) Regular ANC; At least 4 visit in the antenatal period as per guideline of WHO with special
attention to detect:
Altered sleep pattern.
Headache.
Blurring of vision.
Any per-vaginal discharge or bleeding.
Swelling of the feet.
For rapid weight gain.
High BP.
Serum uric acid level (in selective cases).
4) Balanced diet:
  - High protein & low salt diet.
  - Fish oil.
  - Ca’ (2 g/day), Mg & Zn supplement.
5) Anti-oxidant: Vitamin A, C & E supplement from 20 weeks of pregnancy.
0 are‘considered as high risk mothers? [DU-16M, 1 5Ju, | IJu, CU-18N,15J,12J,10Ju/J, RU-
» 15J,12Ju,11J, SUST-13Ju/J, 10Ju/J]
...
3) Malpresentation (e.g. breech presentation, transverse lie etc.).
...
12) Pregnancy associated with general diseases, e.g. cardiovascular disease, kidney disease, diabetes,
tuberculosis, liver disease etc.
13) Treatment for infertility.
14) Thrge or more spontaneous consecutive abortions.
Role of AN,
in high risk mothers: Please write from above.
[Ref- Park /24" /561]
hat do you mean by risk approach? [DU-10J]
Risk approach: The risk approach is a managerial tool for improved MCH care,(Its purpose is to provide better
services for all, but with special-attention-to those who need them most... ) ——<——
__<
Inherent in thi : a Pits
anne aieetond ma Is ppl utilization of all resources, including some human resources that
ed in such care — traditional birth atte: i ,
ndants, n’s
group, for example. , community health workers, wome:
[Ref- Park / 24" / 561]
a Mention the basic criteria [RU-13J,10J] /3 criteria [DU-14Ju] of identifying ‘at risk babies’.
nswer
...
5) Weight below 70% of the expected weight (i.e. 2"! & 3" degrees of malnutrition).
6) Failure of gain weight during three successive months.
...
safe delivery.
She is a ‘high-risk mother’, so regular antenatal checkup and institutional delivery is suggested.
...
3) Readiness to deal with complications such as prolonged labour, antepartum haemorrhage,
...
2) Prevention of dehydration and ketosis of the mother.
3) Relief of pain.
...
In such cases, the delivery may be conducted by the Health Worker Female or trained dai. This is
known as “domiciliary midwifery service”.
Advantages of domiciliary midwifery service:
1) The mother deliver in the familiar surroundings of her home and this may tend to remove the fear
associated with delivery in a hospital.
2) The chances for cross infection are generally fewer at home than in the hospital.
3) The mother is able to keep an eye upon her children and domestic affairs; this may tend to ease her
mental tension.
Disadvantages of domiciliary midwifery service:
...
1) Misconception about hospital (and operative) delivery.
2) Poverty.
3) Lack of knowledge about warning & dander signs of pregnancy.
...
+ Clinical features:
A) History: H/O of other obstetric comorbidity; e.g. multiple pregnancy, polyhydramnios, pre-existing
HTN & GDM etc.
B) Symptoms:
a) Mild symptoms:
  - Slight swelling over the ankles.
  - Gradually the swelling may extend to the face, abdominal wall, vulva or even the
whole body.
b) Alarming symptoms:
Headache (frontal or occipital).
Disturbed sleep.
Diminished urine output (< 400 ml/24 hours is very ominous).
Eye symptoms (blurring or dimness of vision or even blindness).
Epigastric pain.
Pre- eclampsia is principally a
syndrome of signs & when
symptoms appear, it is usually late.
C) Signs:
1) “Abnormal weight gain.
2) ‘Rise of blood pressure.
3) “Oedema.
4) Signs of chronic placental insufficiency; e.g. scanty liquor or IUGR may be present. |
...
A) Urine examination:
1) Heat coagulation test to detect proteinuria: Proteinuria is the last feature of pre-
eclampsia to appear. It may be trace or at times copious so that urine becomes solid on
boiling (10-15 g/L). /t is done at the bed side for rapid detection.
2) Urine R/M/E (There may be few hyaline casts, epithelial cells or even ew RBCs).
3) 24 hours urine collection for protein measurement.
B) Blood examination;
1) Serum uric acid level: A serum uric acid level is the biochemical marker of the pre
scrum uric acid level: -
eclampsia, Raised serum uric acid level (>4.5 mg/dl) indicates pre-eclampsia,
2) S. creatinine: May be > 1 me/dl.
3) Thrombocytopenia or abnormal coagulation profile of varying degree may be present
4) Hepatic enzymes: May be raised.
5) Blood urea may be normal or slightly raised,
C) Ultrasonography,
Postnatal care
Answe
- Postnatal period / puerperal period: It is the period after expulsion of the product of placenta upto 6*
week or 42 days.
- Postnatal care: Care of the mother and the newborn after delivery is known as postnatal or Post-partal
care.
...
By To check adequacy of breast feeding.
To provide family planning services. .
4 To provide basic health education to mother / family.
[Ref- Park / 24" / 565]
hat complications may arise during postnatal period? [DU-15J,| 2Ju]
. Name the complications of postnatal period. [RU-18M,16J]
Complications of the postnatal period:
Puerperal sepsis: This is infection of the genital tract within 3 weeks after delivery, This is
-accompanied by rise in temperature and pulse rate, foul smelling lochia, pain and tenderness in
owe c.
Thrombo-phlebitis: This is an infection of the veins of the legs associated with varicose veins; the
leg may become tender, pale and swollen.
pr Secondary haemorrhage: Bleeding trom vagina any time from 6 hour after delivery to the end of
...
- These check-ups should include examination of breast, lower abdomen & legs.
Lochia should be examined for colour, smell & quantity.
For a hospitalized woman, twice a day examination during first 3 days is a routine practice.
For home deliveries, a daily visit by the birth attendant till the baby’s cord is dry & dropped off, isa
more practical routine.
It can help in early diagnosis & timely treatment of abnormalities,
A ae Postnatal check-up on similar lines as an antenatal check-up is done at the end of 6
weeks.
  - i i <= ; + . . +
ee iat up a bimanual vaginal examination is done on all mothers to judge the stage of
: e . uterus & adnexa. This examination provides an opportunity to see the condition of
...
1. Rapid restoration of mother to optimum health:
  ...
  - Psychological.
  - Social.
2. Adequate and appropriate breast feeding of baby.
Family planning service
4. Basic health education: hygiene, feeding for mother & infants, pregnancy spacing, importance of
...
- Soon after delivery, the health check-ups must be frequent, ie., twice a day during the
first 3 days, and subsequently once a day till the umbilical cord drops off.
- Checks temperature, pulse and respiration, examines the breasts, checks progress of
normal involution of uterus.
- Examines lochia for any abnormality, checks urine and bowels and advises on perineal
toilet including care of the stitches, if any.
2) Anaemia: Routine haemoglobin examination should be done during postnatal visits, and when
anaemia is discovered, it should be treated & continue treatment for a year.
3) Nutrition: '
- The nutritional needs of the mother must be adequately met.
- Often the family budget is limited; the mother should be shown the means how she can
cat better with less money.
4) Postnatal exercises:
- Postnatal exercises are necessary to bring the stretched abdominal and pelvic muscles
back to normal as quickly as possible.
- Gradual resumption of normal house-hold duties may be enough to restore one's figure.
9
“ Psychological:
1) Fear which is generally borne of ignorance.
2) Other problems are timidity and insecurity regarding the baby.
3) She requires the support and companionship of her husband.
4) Fear and insecurity may be eliminated by proper prenatal instruction.
ai nN
ANARAAN REALL LAA. 00 DBR RRRRRDAS AA ee.
eee ee
a
Social:
...
Please write from above.
: Care of Newborn
71) Infancy: Upto | year of age.
  - Neonatal period — First 28 days of life.
  - Post-neonatal period - 28"" day to I year.
...
1) Anti-D injection to mother: Within 18 hours of child birth.
2) Exchange transfusion: Replacement of the newborn infant’s blood with Rh (-ve) blood.
...
Pe Llearing the air way / resuscitation.
(27 Evaluation of the baby by APGAR scoring.
~ 3y_ Care of the cord — cut aseptically.
z 4¥ Care of the eyes — wash a drop of 1% AgNO;
py Care of the skin — Bath is given with soap and warm water to remove vernix, meconium and
blood clot after few hour of birth,
Maintenance of body temperature.
Breast feeding (as soon as possible).
8) Thorough examination of baby for any congenital abnormalities.
9) Identification of the baby by mother name and sex of the baby.
3) Rooming in (keeping the baby with his mother).
“ Late / subsequent care (Within 24 hours):
Daily bath of the baby.
2) Inspection of the eyes, mouth and nose for any abnormalities. 3. Maintenance of temperature.
Vz) Regular monitoring of the weight.
...
2) Congenital syphilis: Treatment with 2.4 to 4.8 million U of Benzathine Penicillin.
3) Hepatitis B: An intramuscular injection of 2 ml of specific anti-HBsAb, along with initial anti-
hepatitis B immunization using 0.5 ml of hevac B or genevac B (given intramascular within 12
hours of birth). This vaccination must be repeated at | & 2 months and then at 1 year of age.
4) AIDS: There is no available prevention for newborns.
[Ref- Park / 24" / 569]
For more curiosity:
Blue / pale Body - pink Completely pink
Extremities- blue |
Pulse (HR) Absent Slow (below 100) _|Over 100
Grimace (reflex . NO response Grimace Cry
response to catheter in
Activities & muscle tone Flaccid Some flexion of Active movements
= | [extremities
...
hospital?
APGAR score: ; ;
  - The APGAR score is taken at | minute and again at 5 minutes after birth.
It requires immediate and careful observation of the heart rate, respiration, muscle tone, reflex
response and colour of the infant.
- Each sign is given a score of 0, | or 2.
  - Itprovide an immediate estimate of the physical condition of the baby.
  - A perfect score should be 9 or 10.
» 0-3 indicates that the baby is severely depressed and 4-6 moderately depressed. vii. A score below 5
needs prompt action.
...
1) Toxoplasmosis,
2) Rubella. ; Remember: TORCH
3) Cytomegalovirus.
4) Human (alpha) herpes virus 1 or 2.
5) Human (beta) herpes virus, and
) Syphilis.
...
The measurement being taken preferably within the Ist hour of life, before significant postnatal weight
~  loss‘has occurred.
fas of LBW: It may be of two types —
1) Pre-term babies: When the baby born before completed 37 weeks (259 days) of gestation. Their
intrauterine growth may be normal.
2) Small-for-date babies (SFD): Birth weight less than 10th percentile for the gestational age.
Public health importance / Importance of LBW:
...
LBW is an important guide to the level of care needed by individual babies.
LBW reflects inadequate nutrition & ill health of the mother,
A high percentage of LBW points to deficient health status of pregnant woman inadequate, prenatal
...
2) Term babies: Babies born from 37 completed weeks to less than 42 completed weeks (259-
293 days) of gestation.
3) Post-term babies: Babies at 42 completed weeks any time thereafter (294 days & over) of
gestation.
Babies weighing less than 1501 gm are designated as very low birth weight babies (VLBW).
[Ref- Park /24"/571|
hat are causes of low birth weight (LBW) baby? [DU-1 Ju]
- Enumerate the important causes of LBW babies. [SUST-12J]
...
Chronic diseases: Cardiac, renal, pulmonary diseases, OM, HTN,
Tumour: Ovarian.
...
_Yremature rupture of membrane.
...
Increasing food intake by -
- Supplementary feeding
- Distribution of iron & folic acid tablets.
- Fortification & enrichment of foods etc.
Controlling infection: Many maternal injections such as malaria, infections due to urinary
tract infection cytomegalovirus toxoplasmosis, rubella & syphilitic infection should be
diagnosed & treated or otherwise prevented.
Early detection & treatment of medical disorders: These include hypertension toxemias
& diabetes.
t intervention: By -
Family planning
...
as GOBIFFF.
G = Growth monitoring (by using growth chart)
O = Oral Rehydration (to treat all mild and moderate dehydration)
B = Breast feeding to nourish and protect the young infant from infection.
I = Immunization (against 6 communicable diseases)
F = Female education.
F = Food supplementation
F = Family spacing/ planning.
Previously the campaign was limited within the Ist 4 strategies and it was known as 4
key elements of child survival.
- Baby friendly hospital initiative (BFHI): :
nurses, health
In 1993 UNICEF & WHO launched the baby friendly initiative annalist doctor,
worker & parent's in hospital & maternity centers to promote, protect & support breast feedings.
Objectives: To reestablish the superiority of breast feeding in order to protect the health by becoming
friendly to the baby.
WHO & UNICEF criteria: 10 steps which the hospital must fulfill —
1) Helping the mother initiate breast feeding within the first hour of birth in normal delivery
and four hours following caesarean section.
2) Encourage breast feeding on demand.
3) Allow mothers and infants to remain together 24 hours a day, except for medical reasons.
4) Give newborn infants no food or drink, other than breast milk unless medically indicated.
5) Exclusive breast feeding should be promoted till 4 — 6 months of age.
6) No advertisement, promotional material or free products for infant feeding should be
allowed in the facility.
7) Show mother how to breast feed and how to maintain lactation even if she is separated
from her infant.
8) Give no artificial teats or pacifiers (also called dummies or soothers) to breast feeding
infants.
9) Encourage mothers to assists each other and to develop breast feeding support groups.
10) Nursing staff should be available to counsel families and mother in support of exclusive
breast feeding.
[Ref- Park /24"/ 575]
OD DUaeneweeee .
</details>
...
to increase in the physical size of the body and ‘development’ to increase in skills & function.
+ Growth & development include not only physical aspect but also intellectual, emotional &
social aspects.
«+ Normal growth and development take place only when -
...
9
se
Growth: It implies increase in the size or mass of tissue (quantity).
<
...
e
Ansyer
Determinants of growth & development / Factors affecting growth & development:
i Genetic inheritance: Genetic factors influence growth and development, especially height and weight,
- mental and social development and personality.
2 Nutrition: Nutrition influences growth and development before as well as after birth. In fact,
retardation of growth rate is an indication of malnutrition. When the diet is improved the child begins to
row in height and weight.
Age: Growth rate is maximum during foetal life, during the first year of life and then again at puberty.
At other periods, growth is slower. Se age
f° Sex: At about the age of 10 to-11-years, female children show a sudden increase in height and weight.
This growth spurt corresponds to puberty. In male children, the growth spurt occurs a little later, i-e.,
_ between 12 and 13 years.
5) Physical surroundings: Sun-shine, good housing,
- and development.
by Psychological factors: Love, tender care and proper child-
/ emotional and intellectual development of children.
P Infections and parasitosis: Certain infections of the mother during pregnancy (e.g., rubella, syphilis)
affect the intra-uterine growth of the foetus. Infections after birth (e.g., diarrhoea, measles) slow down
growth and development, especially in the malnourished child. The intestinal parasites (e.g.,
roundworms) by consuming considerable quantities of nutrients hamper growth and development.
) Economic factors: The standard of living of the family is an important factor, Children from well-to-
do families have better height and weight. The economic factor is connected with the nutrition and
living of the people.
. Other factors: These comprise the birth order of the child, birth spacing, birth weight in single and
/ multiple pregnancies, education of the parents, etc.
...
surveillance and education into a system of comprehensive health care.
Aims and objectives:
health supervision, nutritional
Growth monitoring
Figure: Symbol for under-five’s clinic.
1. Care in illness: The illness care for children will comprise —
...
from the average value on both sides.
Or,
It is visible display of the child’s physical growth & development. It is one of the components of child
health card.
A
we eee
REASONS FOR SPECIAL CARE
AGE IN MONTHS
Figure: A prototype growth chart developed by WHO.
  - It was first designed by David Morley & later modified by WHO.
  - This chart is designed primarily for the longitudinal follow up (growth monitoring) of a child, so
that changes over time can be interpreted.
Here, weight is taken into consideration for age because weight is the most sensitive measure of
growth & any deviation from normal can be detected easily by comparison with the reference
curve,
  - The WHO growth chart has 3 reference curves.
Meaning of the lines:
Upper line: 50" percentile for boys.
Middle line: 3 percentile for girls.
Lower line: 60% of 50" percentile.
nes is called “The road to health”. The weight of 95% of
The space between the upper & middle li
If the child is growing normally its growth line will be above
normal healthy children will fall within this area.
the 3" percentile & will run parallel to the road to health curve.
Importance: Flattening or falling of child’s weight curve signifies growth failure & thus needs special care.
...
**Road to health:**
  ...
  - The WHO prototype growth chart (home based) has 2 reference curves. The space between the two
growth carves (weight channel) has been called the ‘road to health’. .
...
biti ait cin 2
of growth chart / information from growth chart:
1) Helps in growth monitoring of a child.
2) Diagnostic tool: Helps in identifying high risk children.
3) Planning & policy making in relation to child health care at the local & central level.
4) Can be used as an educational tool for mother in participating actively in growth monitoring of her
child. .
...
5) Arm circumference.
The last two are independent of age and are particularly useful when age is not known.
[Ref- Park / 24" /578, 579]
hat is exclusive breast feeding? [DU-12Ju, RU-1 8N,17N, SUST-13J]
. Write short note on: Exclusive breast feeding.
Exclusive breast-feeding:
When a baby is given only breast milk, not even a drop of water, upto 5 months of age it is called an
absolute or exclusive breast feeding.
Importance: Please see below — the advantages of breast feeding.
[Ref- Park /24"/ 573]
ll DLR weneneeeneeee es ;
on injury? [SUST-16]]
. Write short note on: Milk injury.
Milk injury:
If a baby is fed only with milk over a lon period of time, j ivi
8 SAY 2 years without giving any supplementary
food, the baby becomes Habby and edematous due. deficiency of protein & anaemic due to j jency, —
a een
...
a beet — a ee
Rooming in( Keepi {Keeping the baby’s crib-by-the-side-of the mother's.bed-is-called"rooming in”)
Advantage:
J¢ It gives an opportunity for the mother to know her baby.
...
quantity of proteins and calories in addition to antibodies and lymphocytes.
...
1) Antibodies, especially secretory IgA plays an important role in protection against infection.
2) Colostrum may help to sterilize the small intestine if it becomes contaminated by infected
swallowed during the birth process.
3) Colostrum possesses laxative qualities.
For more curiosity:
- @ Comparison between colostrum and milk:
Carbohydrate (%
Milk
Colostrum [| 2.250 TIS
A
itedown the important advantages [SUST-1I8N] / advantages [RU-17N,15Ju) of breast
Breastfeeding is the best for the babies’-explain.
. Write down the role of breast feeding in reducing infant mortality. [DU-15J]
Advantages of breast feeding / benefits of exclusive breast feeding:
- Benefits to the baby:
ZA ‘omplete food, species specific.
ng: asily digested and well absorbed.
Ke otects against infection.
aS promotes emotional bonding.
OH Beter brain growth and intelligence.
ie Lower incidence of childhood cancer.
By Benefits to mother:
1) Helps in involution of uterus.
A Delays pregnancy.
Lowers risk of breast and ovarian cancer.
Decrease mother’s workload.
) Saves money.
...
3) Opsonic and chemotactic activities of C3 and C4 complement system.
_4) Lactoferrin and transferrin.
[Ref- M R Khan /3"/82]
. Write down the disadvantages of breast feeding.
Disadvantages of breast feeding:
1) Lactation may not be adequate.
2) Breast -feeding demands maternal proximity, hence mother can't be parted from her child for a long
period.
3) Social life may be upset: This is applied particularly to western civilizations.
4) _Complications: Cracked nipple & breast abscess.
ative down the contraindication of breast feeding.
A. In mother:
1. Mother with a serious psychiatric disorder.
Markedly inverted nipple, fissure & cracks of nipple.
Mother suffering from acute fever, TB, chronic nephritis, breast abscess, septicaemia,
breast tumor etc.
Mother has cancer & is being treated with anti-cancer drug.
Mother having AIDS.
wn
nb
fl
...
baby is met from sources of food except other than mother's milk.
...
urine at least six times in 24 hours. i
2) Good vigour which is manifested by movements of the limbs & cry. f
...
3) Prolonged illness of the mother or death of mother. i
4) When the infant is intolerant to lactose. ‘i
5) When th Other is getting anticancer drug.
Disadvantages of artificial feeding:
7 Jnadequate supply (inappropriate proportion)
ay isakes in proportion. iH}
ti ‘ections (gastroenteritis) - due to E. coli, shigella, salmonella etc. |
Ne onatal tetany.
...
curd of the cow's milk is thick and hard to digest for the young stomach due to large proportion of
casinogen.
2) Breast milk contains twice as much iron as in the cow's milk. This iron is essential for the new born &
meets his needs upto 3 months. Anaemia is commonly seen in babies fed on cow's milk even before 3
months.
3) Calcium of breast milk is utilized better as it present in more assimiable form.
4) Vitamin A is present in large quantities in colostrum. Mother's milk contains more vit A than in cows
milk.
Vitamin C of breast milk is related to vit C content of mother's diet, in general it is higher. Cow's mill:
...
Protein 11 gm/litre 33gm/ litre
3) Fat 35 gm/ litre 35 gm/ litre
4) Non protein 0.32 gm/ litre 0.32 gm/ litre
5)_ Minerals 2 gim/ litre
0.33 gm/ litre
7 gm / litre
650 kcal
88em/ litre
...
* Weaning foods: Cow's milk, fruit juice, soft cooked rice, cereals and pulses (smashed-khichuri), Soup
...
increased gradually followed by the second wearing food after some time (1-2 weeks).
» Wearing can be started with mashed ripe banana as it is easily accepted.
<l
  - Aeerl a week the infant is put on cooked rice and pulses (or on gruel and pulses) shortly thereafter
, hichuri (prepared from rice pulses and vegetables oil is added afterwards) can be given.
a egg, meat etc, should be introduced one after another later. In case of egg yolk will be given
...
irth and ending 28 completed days after birth.
Causes:
1) Low birth weight.
2) Diarrhoeal diseases.
3) Acute respiratory infections. /
4) Neonatal tetanus.
5) Birth injury and difficult labour.
...
378 —- ENDEA VOUR COMMUNITY MEDICINE FOR WRITTEN (SAQ, MCQ), VIVA & OSPr
...
gistered in the same year; usually expressed as a rate per 1000
given year to the total number of live births re
live births"
Calculation: We can calculate it by following formula —
Number of deaths of children less than I year of age ina year
x 1000
IMR =
Number of live births in the same year
Infant mortality rate (IMR) per 1000 live birth (2015):
  - Bangladesh : 31/1000 live birth.
...
Diarrhoea (30%).
s Prematurity & low birth weight (11%).
Whooping cough (2%).
AyD RI (18%).
Neonatal tetanus (8%).
easles (7%).
Other causes (24%): Congenital anomalies, malnutrition etc.
For more curiosity
Causes of infant mortality:
A) Causes of neonatal mortality (0-4 weeks):
...
6) Family size.
7) High fertility.
B) Economic factors: Socio-economic status.
...
7) Broken families.
8) Illegitimacy.
9) Brutal habits & customs.
10) The indigenous dai.
...
3) Malnutrition.
4) Infectious diseases (e.g. measles, whooping cough).
...
2" Prevention infection: The major causes of sickness and death of children in Bangladesh are
infectious diseases many of which are preventable by immunization as for example neonatal
fetanus. ===
r) Breast-feeding: The most effective measure for lowering infant mortality is to promote breast.
feeding.
) Growth monitoring: It is a low cost technology available for reducing infant mortality.
Family planning: Family limitation & spacing of births contribute substantially to lowering of
infant mortality rate,
Sanitation: Infant mortality rate is universally recognized not only as a most important indication
f the health status of the children but also of the level of social environment.
) Provision of primary health care:
  - All those involved in maternity care from the obstetrician down to the local dai should
collaborate and work together as a team.
  - , Prenatal care must be improved.
td, Special care baby units must be provided.
/~ Proper referral services.
- Socio-economic development: This must include
Spread of education (especially female literacy)
Improvement of nutritional standards
Provision of safe water & basic sanitation
Improvement of housing conditions
The growth of agriculture and industry
The availability of commerce d& communication.
ys Education: Education woman generally do not have early pregnancies, are able to space their
...
the result. [RU-15Ju]
Calculation of IMR:
Number of deaths of children less than | year of age in a year
IMR = ; x 1000
Number of live births in the same year
80
= x 1000 = 117.64 per 1000 live births.
Ommunity amon 50,000 i
re their first bir . ai tenia
thday. ive bi
[DU-13)] ay. Total live birth w
Calculation of IMR:
1000 Were under one year of age of which 50 died
as 1,500. Calculate IMR of that community.
Number of deaths of children less than | year of age in
IMR = a year
—— x 1000
Number of live births in the same year
50
...
live births in the same year. ' Post-neo natal mortality rate = 133/ 1000 live births.
Peri-natal mortality rate: The ratio of peri-natal deaths ina given year to the total number of live
births in the same year, usually expressed at a rate per 1000.
Late foetal deaths (28 weeks of gestation) + postnatal deaths (under 1 week) in a year
x 1000
Live births in the same year
- Live birth: It is the complete expulsion or extraction from its mother of a product of conception,
irrespective of the duration of the pregnancy, which after such separation, breaths or shows any other
evidence of life such as beating of the heart, pulsation of the umbilical cord of deflate movement of
...
risk of death is greatly enhanced if the last child was born less than two years ago, and if the mother already has
four or more children. Small number of children and longer spacing between pregnancies are associated with all
...
mortality rate. It reflects the adverse environmental health hazards (c.g. malnutrition, poor hygiene, infections
and accidents), including economic, educational and cultural characteristics of the family. Mortality in this age
group no longer depends on perinatal hazards and other endogenous factors, which often causes loss of life
...
Child Welfare and the UNICEF. In 1954, the UN General Assembly passed a formal resolution establishing
universal Children's Day and assigned to UNISEF the responsibility for promoting this annual day.
A non-governmental organization (Defense for Children International, Geneva), was set up in 1979
(during the International Year of the Child) to ensure on - going systematic international action specially
...
A) Antenatal causes:
1) Maternal diseases: Hypertension, cardiovascular disease, diabetes mellitus, tuberculosis,
anaemia, Pelvic diseases — uterine myomas, endometriosis, ovarian tumors, Anatomical
defects — uterine anomalies, incompetent cervix.
2) Endocrine imbalance and inadequate preparation.
3) Blood incompatibilities. ‘
4) Malnutrition.
5) Toxaemia of pregnancy
6) Antepartum haemorrhage
7) Congenital defects
8) Advance maternal age
B) Intranatal causes:
- Birth injuries
- Asphyxia
...
3) Respiratory & alimentary infections
4) Congenital anomalies
D) Unknown causes.
[Ref- Park / 24" /5991
Li __ _
According to WHO, a maternal death is defined as" the death of woman while pregnant or within 42
...
mortali: A
It is the number of death of mother from pregnancy,
year per thousand of childbirth.
delivery and puerperal causes during a calendar
Calculation: We can calculate MMR by following formula —
Total number of female deaths due to complications of pregnancy, child birth or
in an area during a given year
within 6 weeks of delivery from ‘puerperal causes' i
x 1000
MMR =
Total number of live births in the same area in that year.
+ It is expressed as rate per 1000 live births.
+ MMR in Bangladesh: 3 per 1000 live births per year (in 1998).
...
MMR of the community of that year. [RU-15J]
Calculation of MMR:
Total number of fema
le deaths due to complications of pregnancy, child birth or
| causes' in an area during a given year
within 6 weeks of delivery from ‘puerpera
MMR = x 1000
Total number of live births in the same area in that year
25 (from pregnancy related complications) + 10 (from PPH)
= x 1000
25
= ——_——— x 1000
= 10/1000 live births
...
Calculation of MMR:
Total number of female deaths due to complications of pregnancy, child birth or
within 6 weeks of delivery from 'puerperal causes’ in an area during a given year
MMR = x 1000
Total number of live births in the same area in that year.
5 (from APH) + 10 (from PPH)
= x 1000
200 —(5 + 10 + 5)
1S
=———— x 1000
...
b) Total women of reproductive age 5000.
c) Total live birth 800.
d) Women died due to-pregnancy complication 300.
Please calculate from above discussion.
...
2) Toxaemia of pregnancy (eclampsia).
...
|Ref- Rashid, Khabir, Hyder /5"/175]
“ Significance of MMR:
1) Itreflects inadequacy of health care services for mothers
2) Itreflects a low standard of living & socio-economic status of the community.
3) Itis the indicator of the availability utilization and effectiveness of health care.
...
Obstetric causes: Social causes / facto)
© Toxaemia of pregnancy. _®~Age at childbirth.
- Haemorrhage. ~_s~Parity.
- Infection. “9 Too close pregnancies.
- Obstructed labour. ‘ Family size.
- Septic abortion. 7 Malnutrition.
Non-obstetric causes: Col pve:
© Severe anaemia. a1 Pita
- Associated disease i.e. —cardiac, renal; ° Ignorance & prejudices.
hepatic, metabolic & infectious. _™ Lack of maternity services.
- Malignancy. hortage of health manpower.
© Accidents. “_-* Delivery by untrained dais.
...
2) Atleast 3 antenatal check-up.
...
6) Treatment of medical conditions e.g. hypertension, diabetes, tuberculosis etc.
...
not merely the absence of disease or infirmity in all matters relating to the reproductive system and its functions
and processes. .
; [Ref- Rashid, Khabir, Hyder /5* / 177)
ii
...
5) Menstrual regulation (MR) and prevention of unsafe abortion.
6) Infertility.
7) Neonatal care.
...
General of Health Service) has been implementing an UNICEF supported project on EOC in BD since July’
1994,
Elements of EOC:
1) Functions used to define first aid:
  - Administer parenteral oxitocic drugs to control haemorrhage.
  - Administer parenteral antibiotic to control infection.
» Administer parenteral sedatives to control eclamptic convulsion.
2) Functions used to define basic EOC:
  - All functions including in obstetric first aid.
  - Manual removal of placenta.
  - Perform assisted vaginal delivery (vacuum extractor/ forceps).
3) Functions used to define comprehensive EOC:
  - All of those included basic EOC.
  - Surgery (caesarian section / DE & C).
  - Blood transfusion.
Measures taken to reduce MMR through EOC:
1. By awareness about danger signs.
2, Emergency preparedness i.e. decide accurately & timely where to go and arranging transport and fund
by community participation
3. Responsiveness facilities i.e. availability of trained personnel, necessary drugs, equipments & services:
<
_<‘l
) DARA ee eee
4.
education.
Del isi ci i i
ayed decision to seek EOC services can be overcome by increasing community awareness and
...
weight.
c) Failure to gain weight during 3 successive
months.
d) Children with PEM.
