...
```mermaid
flowchart TD
    P["PATHOLOGY 🌳"] --> G["GENERAL PATHOLOGY<br/>Ch 1-9: how ALL cells/tissues react"]
    P --> S["SYSTEMIC PATHOLOGY<br/>Ch 10-29: diseases of each organ"]

    G --> G1["1. Cell as Unit of Health"]
    G --> G2["2. Cell Injury, Death, Adaptations 🔥"]
    G --> G3["3. Inflammation & Repair 🔥"]
    G --> G4["4. Hemodynamic, Thrombosis, Shock"]
    G --> G5["5. Genetic Disorders"]
    G --> G6["6. Diseases of Immune System"]
    G --> G7["7. Neoplasia (Cancer) 🔥"]
    G --> G8["8. Infectious Diseases"]
    G --> G9["9. Environmental & Nutritional"]

    S --> S1["10. Infancy & Childhood"]
    S --> S2["11. Blood Vessels 🔥"]
    S --> S3["12. The Heart 🔥"]
    S --> S4["13. WBC, Lymph Nodes, Spleen, Thymus"]
    S --> S5["14. RBC & Bleeding Disorders"]
    S --> S6["15. The Lung 🔥"]
    S --> S7["16. Head & Neck"]
    S --> S8["17. GI Tract 🔥"]
    S --> S9["18. Liver & Gallbladder 🔥"]
    S --> S10["19. The Pancreas"]
    S --> S11["20. The Kidney 🔥"]
    S --> S12["21. Lower Urinary Tract & Male Genital"]
    S --> S13["22. Female Genital Tract"]
    S --> S14["23. The Breast"]
    S --> S15["24. Endocrine System"]
    S --> S16["25. The Skin"]
    S --> S17["26. Bones, Joints, Soft Tissue Tumors"]
    S --> S18["27. Peripheral Nerves & Skeletal Muscle"]
    S --> S19["28. CNS 🔥"]
    S --> S20["29. The Eye"]
```
...
- **[Systemic Correlation (type-wise) — README](systemic%20correlation/README.md)** — same Q&A **regrouped by type, not item**: necrosis/cell death · granuloma · thrombosis/embolism/infarction · vasculitis/HTN/aneurysm · ulcer · stone/crystal/calcification · tumour + markers · cyst/obstruction · valve/vegetation/shunt/heart failure · blood tests (enzyme/LFT/RFT/lipid/glucose/TFT/PSA) · fluids (urine/CSF/sputum/pleura/semen/Pap/FNAC) · organism-wise · emergency/complication/PBQ patterns.
