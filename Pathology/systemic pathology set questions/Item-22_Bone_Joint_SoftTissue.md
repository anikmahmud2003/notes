...
* Appearance (চেহারা): টিউমারটি বেশ বড় (৫-১০ সেমি) এবং ক্ষতিকর হয়। দেখতে ধূসর-সাদা (Gray-white), শক্ত এবং কাটলে খসখসে বা বালির মতো (Gritty) লাগে, কারণ এর ভেতর ক্যালসিয়াম বা হাড়ের উপাদান থাকে।
* Degeneration (ক্ষয় বা পরিবর্তন): টিউমারের ভেতরে রক্তক্ষরণ (Hemorrhage), কোষ মরে যাওয়া (Yellow necrosis) এবং সিস্ট বা পানির মতো থলি (Cystic change) তৈরি হতে পারে।
* Local spread (স্থানীয় বিস্তার): টিউমারটি হাড়ের শক্ত বাইরের দেয়াল (Cortex) ভেঙে ফেলে এবং হাড়ের ওপরের চামড়া বা পর্দাটাকে (Periosteum) ওপরের দিকে ঠেলে দেয়। এরপর এটি হাড়ের ভেতরের মজ্জা (Medullary canal) এবং আশেপাশের নরম মাংসে ছড়িয়ে পড়ে। তবে এটি সাধারণত জয়েন্ট বা গিঁট পার হয়ে অন্য হাড়ে যায় না।
...
* Tumour cells (ক্যান্সার কোষ): কোষগুলোর আকার-আকৃতি ঠিক থাকে না (Pleomorphic)। এদের নিউক্লিয়াসগুলো খুব বড়, কালচে (Hyperchromatic) এবং অদ্ভুত আকৃতির হয়। এখানে অস্বাভাবিক কোষ বিভাজন (Abnormal mitoses) দেখা যায়।
* Giant cells (বিশাল কোষ): অনেকগুলো নিউক্লিয়াসযুক্ত বড় বড় দৈত্যাকার কোষ (Giant cells) দেখা যায়।
* Matrix patterns (ধরন): হাড়ের উপাদানের আধিক্যের ওপর ভিত্তি করে এটি কয়েক ধরনের হতে পারে। যেমন: অস্থিপ্রধান (Osteoblastic), তরুণাস্থিপ্রধান (Chondroblastic), বা রক্তনালীপ্রধান (Telangiectatic)। তবে ধরন যাই হোক, অস্টিওয়েড বা হাড়ের উপাদান থাকতেই হবে।
...
------------------------------
পরীক্ষায় এই টপিকটি আরও ভালোভাবে মনে রাখার জন্য বা লেখার সুবিধার্থে, আপনি কি এর Codman triangle বা Sunburst appearance-এর কোনো ডায়াগ্রাম/ছবি দেখতে চান, নাকি অন্য কোনো বিষয়ে সাহায্য লাগবে?
...
পরীক্ষায় প্রায়ই Rheumatoid Arthritis এবং Osteoarthritis-এর মধ্যে পার্থক্য (Differences) লিখতে দেয়। আপনি কি এই দুটির মরফোলজিক্যাল পার্থক্যের একটি কুইক সামারি চার্ট দেখতে চান?
...
* ৬ সপ্তাহের নিয়ম শুধুমাত্র প্রথম ৪টি পয়েন্টের জন্য প্রযোজ্য, নোডিউল বা ল্যাব টেস্টের জন্য নয়।
...
এই ক্রাইটেরিয়া থেকে কোনো ক্লিনিক্যাল কেস সলভ করতে চান, নাকি এর লেটেস্ট ACR/EULAR (2010) Criteria-র সাথে পার্থক্যটি দেখতে চান?
